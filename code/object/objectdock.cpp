...
void dock_evaluate_tree(object *objp, dock_function_info *infop, void (*function)(object *, dock_function_info *),
                        bool *visited_bitstring);
...
float dock_calc_max_cross_sectional_radius_perpendicular_to_axis(object *objp, axis_type axis) {
    ...
    dock_evaluate_all_docked_objects(objp, &dfi,
...
void dock_evaluate_all_docked_objects(object *objp, dock_function_info *infop,
...
void
dock_calc_max_cross_sectional_radius_squared_perpendicular_to_line_helper(object *objp, dock_function_info *infop) {
