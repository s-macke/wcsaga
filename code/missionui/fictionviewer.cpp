...
void fiction_viewer_init()
{
	...
	Fiction_viewer_text_max_lines = Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.res][3] /
		gr_get_font_height();
	...
	Fiction_viewer_buttons[Fiction_viewer_ui][gr_screen.res][FVW_BUTTON_ACCEPT].button.set_hotkey(KEY_CTRLED |
		KEY_ENTER);
	...
	// init brief text
	brief_color_text_init(Fiction_viewer_text, Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.res][2], 0,
		0);
...
void fiction_viewer_do_frame(float frametime)
{
	...
	brief_render_text(Top_fiction_viewer_text_line, Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.
		res][0], Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.res][1],
		Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.res][3], frametime);
	...
	if ((Fiction_viewer_text_max_lines + Top_fiction_viewer_text_line) < Num_brief_text_lines[0])
	{
		...
		int more_txt_x = Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.
			res][0] + (Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.res][2] / 2) - 10;
		int more_txt_y = Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.res][1] +
			Fiction_viewer_text_coordinates[Fiction_viewer_ui][gr_screen.res][3] - 2;				// located below text, centered
