...
BOOL CALLBACK
DIEnumAndDestroyCreatedEffectsProc(LPDIRECTINPUTEFFECT
pDIEffect,
LPVOID lpvRef
);
BOOL CALLBACK
DIEnumDevicesProc(LPCDIDEVICEINSTANCE
lpddi,
LPVOID lpvContext
);
...
dwSize = sizeof(DIPropAutoCenter);
DIPropAutoCenter.diph.
...
if (
GET_DIDEVICE_TYPE(lpddi
->dwDevType) == DIDEVTYPE_JOYSTICK)
{
memcpy((LPVOID)
pDIDeviceInstance, (LPVOID)lpddi, sizeof(*pDIDeviceInstance));
...
// illegal
    ...
    DIEffectStruct.dwTriggerButton = lButton == -1 ? DIEB_NOTRIGGER : FIELD_OFFSET(DIJOYSTATE, rgbButtons) +
                                                                      lButton;
    DIEffectStruct.dwTriggerRepeatInterval = 0;
    DIEffectStruct.cAxes = 2;
    DIEffectStruct.rgdwAxes = rgdwAxes;
...
// Always clear return IPtr
    *ppDIEffect = NULL;
    ...
    ptr->DIEffectStruct.dwTriggerButton = lButton == -1 ? DIEB_NOTRIGGER : FIELD_OFFSET(DIJOYSTATE, rgbButtons) +
                                                                           lButton;
...
//XSTR:OFF
    ...
    switch (hResult) {
        case S_FALSE:
            strcpy(pszCodeString, "S_FALSE");
            break;
        case DI_POLLEDDEVICE:
            strcpy(pszCodeString, "DI_POLLEDDEVICE");
            break;
...
//		case DI_EFFECTRESTARTED: strcpy(pszCodeString, "DI_EFFECTRESTARTED"); break;
        case DIERR_OLDDIRECTINPUTVERSION:
            strcpy(pszCodeString, "DIERR_OLDDIRECTINPUTVERSION");
            break;
        case DIERR_BETADIRECTINPUTVERSION:
            strcpy(pszCodeString, "DIERR_BETADIRECTINPUTVERSION");
            break;
        case DIERR_BADDRIVERVER:
            strcpy(pszCodeString, "DIERR_BADDRIVERVER");
            break;
        case DIERR_DEVICENOTREG:
            strcpy(pszCodeString, "DIERR_DEVICENOTREG");
            break;
        case DIERR_NOTFOUND:
            strcpy(pszCodeString, "DIERR_NOTFOUND");
            break;
        case DIERR_INVALIDPARAM:
            strcpy(pszCodeString, "DIERR_INVALIDPARAM");
            break;
        case DIERR_NOINTERFACE:
            strcpy(pszCodeString, "DIERR_NOINTERFACE");
            break;
        case DIERR_GENERIC:
            strcpy(pszCodeString, "DIERR_GENERIC");
            break;
        case DIERR_OUTOFMEMORY:
            strcpy(pszCodeString, "DIERR_OUTOFMEMORY");
            break;
        case DIERR_UNSUPPORTED:
            strcpy(pszCodeString, "DIERR_UNSUPPORTED");
            break;
        case DIERR_NOTINITIALIZED:
            strcpy(pszCodeString, "DIERR_NOTINITIALIZED");
            break;
        case DIERR_ALREADYINITIALIZED:
            strcpy(pszCodeString, "DIERR_ALREADYINITIALIZED");
            break;
        case DIERR_NOAGGREGATION:
            strcpy(pszCodeString, "DIERR_NOAGGREGATION");
            break;
        case DIERR_INPUTLOST:
            strcpy(pszCodeString, "DIERR_INPUTLOST");
            break;
        case DIERR_ACQUIRED:
            strcpy(pszCodeString, "DIERR_ACQUIRED");
            break;
        case DIERR_NOTACQUIRED:
            strcpy(pszCodeString, "DIERR_NOTACQUIRED");
            break;
        case E_ACCESSDENIED:
            strcpy(pszCodeString,
                   "E_ACCESSDENIED: DIERR_OTHERAPPHASPRIO, DIERR_READONLY, DIERR_HANDLEEXISTS");
            break;
        case E_PENDING:
            strcpy(pszCodeString, "E_PENDING");
            break;
        case DIERR_INSUFFICIENTPRIVS:
            strcpy(pszCodeString, "DIERR_INSUFFICIENTPRIVS");
            break;
        case DIERR_DEVICEFULL:
            strcpy(pszCodeString, "DIERR_DEVICEFULL");
            break;
        case DIERR_MOREDATA:
            strcpy(pszCodeString, "DIERR_MOREDATA");
            break;
        case DIERR_NOTDOWNLOADED:
            strcpy(pszCodeString, "DIERR_NOTDOWNLOADED");
            break;
        case DIERR_HASEFFECTS:
            strcpy(pszCodeString, "DIERR_HASEFFECTS");
            break;
        case DIERR_NOTEXCLUSIVEACQUIRED:
            strcpy(pszCodeString, "DIERR_NOTEXCLUSIVEACQUIRED");
            break;
        case DIERR_INCOMPLETEEFFECT:
            strcpy(pszCodeString, "DIERR_INCOMPLETEEFFECT");
            break;
        case DIERR_NOTBUFFERED:
            strcpy(pszCodeString, "DIERR_NOTBUFFERED");
            break;
        case DIERR_EFFECTPLAYING:
            strcpy(pszCodeString, "DIERR_EFFECTPLAYING");
            break;
        case SFERR_INVALID_OBJECT:
            strcpy(pszCodeString, "SFERR_INVALID_OBJECT");
            break;
        case SFERR_END_OF_LIST:
            strcpy(pszCodeString, "SFERR_END_OF_LIST");
            break;
        case SFERR_DEVICE_NACK:
            strcpy(pszCodeString, "SFERR_DEVICE_NACK");
            break;
        case SFERR_RAW_OUT_DATAEVENT_CREATION:
            strcpy(pszCodeString, "SFERR_RAW_OUT_DATAEVENT_CREATION");
            break;
        case SFERR_RAW_OUT_THREAD_CREATION:
            strcpy(pszCodeString, "SFERR_RAW_OUT_THREAD_CREATION");
            break;
        case SFERR_SYSTEM_INIT:
            strcpy(pszCodeString, "SFERR_SYSTEM_INIT");
            break;
        case SFERR_DRIVER_ERROR:
            strcpy(pszCodeString, "SFERR_DRIVER_ERROR");
            break;
        case SFERR_NON_FF_DEVICE:
            strcpy(pszCodeString, "SFERR_NON_FF_DEVICE");
            break;
        case SFERR_INVALID_HAL_OBJECT:
            strcpy(pszCodeString, "SFERR_INVALID_HAL_OBJECT");
            break;
...
//		case VFX_ERR_FILE_CANNOT_SEEK: strcpy(pszCodeString, "VFX_ERR_FILE_CANNOT_SEEK" ); break;
        case VFX_ERR_FILE_UNKNOWN_ERROR:
            strcpy(pszCodeString, "VFX_ERR_FILE_UNKNOWN_ERROR");
            break;
        case VFX_ERR_FILE_BAD_FORMAT:
            strcpy(pszCodeString, "VFX_ERR_FILE_BAD_FORMAT");
            break;
...
//		case VFX_ERR_FILE_INVALID: strcpy(pszCodeString, "VFX_ERR_FILE_INVALID" ); break;
        case VFX_ERR_FILE_END_OF_FILE:
            strcpy(pszCodeString, "VFX_ERR_FILE_END_OF_FILE");
            break;
        case SWDEV_ERR_INVALID_ID :
            strcpy(pszCodeString, "SWDEV_ERR_INVALID_ID");
            break;
        case SWDEV_ERR_INVALID_PARAM :
            strcpy(pszCodeString, "SWDEV_ERR_INVALID_PARAM");
            break;
        case SWDEV_ERR_CHECKSUM :
            strcpy(pszCodeString, "SWDEV_ERR_CHECKSUM");
            break;
        case SWDEV_ERR_TYPE_FULL :
            strcpy(pszCodeString, "SWDEV_ERR_TYPE_FULL");
            break;
        case SWDEV_ERR_UNKNOWN_CMD :
            strcpy(pszCodeString, "SWDEV_ERR_UNKNOWN_CMD");
            break;
        case SWDEV_ERR_PLAYLIST_FULL :
            strcpy(pszCodeString, "SWDEV_ERR_PLAYLIST_FULL");
            break;
        case SWDEV_ERR_PROCESSLIST_FULL :
            strcpy(pszCodeString, "SWDEV_ERR_PROCESSLIST_FULL");
            break;
        default:
            sprintf(pszCodeString, "%x", hResult);
            break;
    }
