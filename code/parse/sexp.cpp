...
sexp_oper Operators[] =
        {
                ...
                },
                {
                        ...
                        OP_PERCENT_SHIPS_DISABLED,
                        2,
                        INT_MAX,
                },
                {
                        "percent-ships-disarmed",
                        OP_PERCENT_SHIPS_DISARMED,
                        2,
                        INT_MAX,
                },
                {
                ...
                },
                {
                        ...
                        OP_IS_FRIENDLY_STEALTH_VISIBLE,
                        1,
                        1,
                },
                {
                ...
                {
                        "hits-left-subsystem",
                        OP_HITS_LEFT_SUBSYSTEM,
                        2,
                        3,
                },
                {
                        "hits-left-subsystem-generic",
                        OP_HITS_LEFT_SUBSYSTEM_GENERIC,
                        2,
                        2,
                },    // Goober5000
                {
                        "hits-left-subsystem-specific",
                        OP_HITS_LEFT_SUBSYSTEM_SPECIFIC,
                        2,
                        2,
                },    // Goober5000
                {
                ...
                {
                        "set-object-speed-x",
                        OP_SET_OBJECT_SPEED_X,
                        2,
                        3
                },    // WMC
                {
                        "set-object-speed-y",
                        OP_SET_OBJECT_SPEED_Y,
                        2,
                        3
                },    // WMC
                {
                        "set-object-speed-z",
                        OP_SET_OBJECT_SPEED_Z,
                        2,
                        3
                },    // WMC
                {
                ...
                {
                        "set-object-facing",
                        OP_SET_OBJECT_FACING,
                        4,
                        6
                },    // Goober5000
                {
                        "set-object-facing-object",
                        OP_SET_OBJECT_FACING_OBJECT,
                        2,
                        4
                },    // Goober5000
                ...
                {
                        "num-ships-in-battle",
                        OP_NUM_SHIPS_IN_BATTLE,
                        0,
                        INT_MAX
                },    //phreak modified by FUBAR
                {
                        "num-ships-in-wing",
                        OP_NUM_SHIPS_IN_WING,
                        1,
                        INT_MAX
                },    // Karajorma
                {
                ...
                {
                        "primary-fired-since",
                        OP_PRIMARY_FIRED_SINCE,
                        3,
                        3
                },    // Karajorma
                {
                        "secondary-fired-since",
                        OP_SECONDARY_FIRED_SINCE,
                        3,
                        3
                },    // Karajorma
                {
                        "get-throttle-speed",
                        OP_GET_THROTTLE_SPEED,
                        1,
                        1,
                }, // Karajorma
                ...
                {
                        "invalidate-argument",
                        OP_INVALIDATE_ARGUMENT,
                        1,
                        INT_MAX,
                },    // Goober5000
                {
                        "validate-argument",
                        OP_VALIDATE_ARGUMENT,
                        1,
                        INT_MAX,
                },    // Karajorma
                {
                        "do-for-valid-arguments",
                        OP_DO_FOR_VALID_ARGUMENTS,
                        1,
                        INT_MAX,
                },    // Karajorma
                ...
                {
                        "scramble-messages",
                        OP_SCRAMBLE_MESSAGES,
                        0,
                        0,
                },
                {
                        "unscramble-messages",
                        OP_UNSCRAMBLE_MESSAGES,
                        0,
                        0,
                },
                {
                        "disable-builtin-messages",
                        OP_DISABLE_BUILTIN_MESSAGES,
                        0,
                        INT_MAX,
                },    // Karajorma
                {
                        "enable-builtin-messages",
                        OP_ENABLE_BUILTIN_MESSAGES,
                        0,
                        INT_MAX,
                },    // Karajorma
                {
                ...
                },
                {
                        ...
                        OP_LOCK_ROTATING_SUBSYSTEM,
                        2,
                        INT_MAX
                },    // Goober5000
                {
                        "free-rotating-subsystem",
                        OP_FREE_ROTATING_SUBSYSTEM,
                        2,
                        INT_MAX
                },    // Goober5000
                {
                        "reverse-rotating-subsystem",
                        OP_REVERSE_ROTATING_SUBSYSTEM,
                        2,
                        INT_MAX
                },    // Goober5000
                {
                        "rotating-subsys-set-turn-time",
                        OP_ROTATING_SUBSYS_SET_TURN_TIME,
                        3,
                        INT_MAX
                },    // Goober5000
                {
                        "set-forward-deceleration",
                        OP_SET_FORWARD_DECELERATION,
                        2,
                        INT_MAX
                },        // KeldorKatarn
                {
                ...
                {
                        "set-secondary-ammo",
                        OP_SET_SECONDARY_AMMO,
                        3,
                        4
                },        // Karajorma
                {
                        "set-primary-weapon",
                        OP_SET_PRIMARY_WEAPON,
                        3,
                        5
                },        // Karajorma
                {
                        "set-secondary-weapon",
                        OP_SET_SECONDARY_WEAPON,
                        3,
                        5
                },        // Karajorma
                {
                        "lock-primary-weapon",
                        OP_LOCK_PRIMARY_WEAPON,
                        1,
                        INT_MAX
                },        // Karajorma
                {
                        "unlock-primary-weapon",
                        OP_UNLOCK_PRIMARY_WEAPON,
                        1,
                        INT_MAX
                },        // Karajorma
                {
                        "lock-secondary-weapon",
                        OP_LOCK_SECONDARY_WEAPON,
                        1,
                        INT_MAX
                },        // Karajorma
                {
                        "unlock-secondary-weapon",
                        OP_UNLOCK_SECONDARY_WEAPON,
                        1,
                        INT_MAX
                },        // Karajorma
                {
                        "change-subsystem-name",
                        OP_CHANGE_SUBSYSTEM_NAME,
                        3,
                        INT_MAX
                },        // Karajorma
                {
                ...
                },                // KeldorKatarn
                {
                        ...
                        OP_SET_AFTERBURNER_ENERGY,
                        2,
                        INT_MAX
                },        // Karajorma
                {
                        "set-weapon-energy",
                        OP_SET_WEAPON_ENERGY,
                        2,
                        INT_MAX
                },        // Karajorma
                {
                        "set-shield-energy",
                        OP_SET_SHIELD_ENERGY,
                        2,
                        INT_MAX
                },        // Karajorma
                {
                ...
                },
                {
                        ...
                        OP_SHIP_GUARDIAN_THRESHOLD,
                        2,
                        INT_MAX
                },
                {
                        "ship-subsys-guardian-threshold",
                        OP_SHIP_SUBSYS_GUARDIAN_THRESHOLD,
                        3,
                        INT_MAX
                },
                {
                ...
                },            // Goober5000
                {
                        ...
                        OP_FRIENDLY_STEALTH_INVISIBLE,
                        1,
                        INT_MAX
                },    // Goober5000
                {
                        "friendly-stealth-visible",
                        OP_FRIENDLY_STEALTH_VISIBLE,
                        1,
                        INT_MAX
                },    // Goober5000
                {
                        "ship-targetable-as-bomb",
                        OP_SHIP_BOMB_TARGETABLE,
                        1,
                        INT_MAX
                },
                {
                        "ship-untargetable-as-bomb",
                        OP_SHIP_BOMB_UNTARGETABLE,
                        1,
                        INT_MAX
                },
                {
                ...
                },
                {
                        ...
                        OP_TURRET_TAGGED_SPECIFIC,
                        2,
                        INT_MAX
                }, //phreak
                {
                        "turret-tagged-clear-specific",
                        OP_TURRET_TAGGED_CLEAR_SPECIFIC,
                        2,
                        INT_MAX
                }, //phreak
                {
                ...
                },    //WMC
                {
                        ...
                        OP_TURRET_SET_DIRECTION_PREFERENCE,
                        3,
                        INT_MAX
                },    //FUBAR
                {
                        "turret-set-optimum-range",
                        OP_TURRET_SET_OPTIMUM_RANGE,
                        3,
                        INT_MAX
                },    //FUBAR
                {
                        "turret-set-target-priorities",
                        OP_TURRET_SET_TARGET_PRIORITIES,
                        3,
                        INT_MAX
                },    //FUBAR
                {
                        ...
                        2,
                        2 + NUM_TURRET_ORDER_TYPES
                },    //WMC
                {
                        "ship-turret-target-order",
                        OP_SHIP_TURRET_TARGET_ORDER,
                        1,
                        1 + NUM_TURRET_ORDER_TYPES
                },    //WMC
                {
                        "turret-subsys-target-disable",
                        OP_TURRET_SUBSYS_TARGET_DISABLE,
                        2,
                        INT_MAX
                },
                {
                        "turret-subsys-target-enable",
                        OP_TURRET_SUBSYS_TARGET_ENABLE,
                        2,
                        INT_MAX
                },
                ...
                {
                        "set-nav-needslink",
                        OP_NAV_SET_NEEDSLINK,
                        1,
                        INT_MAX
                }, //kazan
                {
                        "unset-nav-needslink",
                        OP_NAV_UNSET_NEEDSLINK,
                        1,
                        INT_MAX
                }, //kazan
                {
                ...
                },    // Goober5000
                {
                        ...
                        OP_TECH_RESET_TO_DEFAULT,
                        0,
                        0
                },    // Goober5000
                {
                        "change-player-score",
                        OP_CHANGE_PLAYER_SCORE,
                        2,
                        INT_MAX
                },    // Karajorma
                {
                        "change-team-score",
                        OP_CHANGE_TEAM_SCORE,
                        2,
                        2
                },            // Karajorma
                {
...

                {
                        ...
                        OP_DONT_COLLIDE_INVISIBLE,
                        1,
                        INT_MAX
                },    // Goober5000
                {
                        "collide-invisible",
                        OP_COLLIDE_INVISIBLE,
                        1,
                        INT_MAX
                },    // Goober5000
                {
                        "change-ship-class",
                        OP_CHANGE_SHIP_CLASS,
                        2,
                        INT_MAX
                },    // Goober5000
                {
                        "deactivate-glow-points",
                        OP_DEACTIVATE_GLOW_POINTS,
                        1,
                        INT_MAX
                },    //-Bobboau
                {
                        "activate-glow-points",
                        OP_ACTIVATE_GLOW_POINTS,
                        1,
                        INT_MAX
                },    //-Bobboau
                {
                        "deactivate-glow-maps",
                        OP_DEACTIVATE_GLOW_MAPS,
                        1,
                        INT_MAX
                },    //-Bobboau
                {
                        "activate-glow-maps",
                        OP_ACTIVATE_GLOW_MAPS,
                        1,
                        INT_MAX
                },    //-Bobboau
                {
                        "deactivate-glow-point-bank",
                        OP_DEACTIVATE_GLOW_POINT_BANK,
                        2,
                        INT_MAX
                },    //-Bobboau
                {
                        "activate-glow-point-bank",
                        OP_ACTIVATE_GLOW_POINT_BANK,
                        2,
                        INT_MAX
                },    //-Bobboau
                ...
                {
                        "change-soundtrack",
                        OP_CHANGE_SOUNDTRACK,
                        1,
                        1
                },        // Goober5000
                {
                        "play-sound-from-table",
                        OP_PLAY_SOUND_FROM_TABLE,
                        4,
                        4
                },        // Goober5000
                {
                        "play-sound-from-file",
                        OP_PLAY_SOUND_FROM_FILE,
                        1,
                        2
                },        // Goober5000
                {
                        "close-sound-from-file",
                        OP_CLOSE_SOUND_FROM_FILE,
                        1,
                        1
                },        // Goober5000
                {
                        "trigger-arrival-track",
                        OP_TRIGGER_ARRIVAL_TRACK,
                        1,
                        1
                },        // KeldorKatarn
                {
                        "force-battle-music",
                        OP_FORCE_BATTLE_MUSIC,
                        1,
                        1
                },        // KeldorKatarn
                ...
                {
                        "variable-array-get",
                        OP_GET_VARIABLE_BY_INDEX,
                        1,
                        1,
                },
                {
                        "variable-array-set",
                        OP_SET_VARIABLE_BY_INDEX,
                        2,
                        2,
                },
                {
                ...
                },
                {
                        ...
                        OP_DAMAGED_ESCORT_LIST,
                        3,
                        INT_MAX
                },                    //phreak
                {
                        "damaged-escort-priority-all",
                        OP_DAMAGED_ESCORT_LIST_ALL,
                        1,
                        MAX_COMPLETE_ESCORT_LIST
                },                    // Goober5000
                {
                        "awacs-set-radius",
                        OP_AWACS_SET_RADIUS,
                ...
                },
                {
                        ...
                        OP_PRIMITIVE_SENSORS_SET_RANGE,
                        2,
                        2
                },    // Goober5000
                {
                ...
                {
                        "ship-rot-maneuver",
                        OP_SHIP_ROT_MANEUVER,
                        6,
                        6
                }, // Wanderer
                {
                        "ship-lat-maneuver",
                        OP_SHIP_LAT_MANEUVER,
                        6,
                        6
                }, // Wanderer
                ...
                },    // Goober5000
                {
                        ...
                        OP_HUD_DISABLE_EXCEPT_MESSAGES,
                        1,
                        1
                },    // Goober5000
                {
                ...
                }, //WMCoolmon
                {
                        ...
                        OP_HUD_SET_MAX_TARGETING_RANGE,
                        1,
                        1
                }, // Goober5000
                {
	...
	*/
                ...
                {
                        "set-cutscene-bars",
                        OP_CUTSCENES_SET_CUTSCENE_BARS,
                        0,
                        1,
                },
                {
                        "unset-cutscene-bars",
                        OP_CUTSCENES_UNSET_CUTSCENE_BARS,
                        0,
                        1,
                },
                {
                        "fade-in",
                        OP_CUTSCENES_FADE_IN,
                        0,
                        1,
                },
                {
                        "fade-out",
                        OP_CUTSCENES_FADE_OUT,
                        0,
                        2,
                },
                {
                        "set-camera",
                        OP_CUTSCENES_SET_CAMERA,
                        0,
                        1,
                },
                {
                        "set-camera-facing",
                        OP_CUTSCENES_SET_CAMERA_FACING,
                        3,
                        6,
                },
                {
                        "set-camera-facing-object",
                        OP_CUTSCENES_SET_CAMERA_FACING_OBJECT,
                        1,
                        4,
                },
                {
                        "set-camera-fov",
                        OP_CUTSCENES_SET_CAMERA_FOV,
                        1,
                        5,
                },
                {
                        "set-camera-host",
                        OP_CUTSCENES_SET_CAMERA_HOST,
                        1,
                        2,
                },
                {
                        "set-camera-position",
                        OP_CUTSCENES_SET_CAMERA_POSITION,
                        3,
                        6,
                },
                {
                ...
                {
                        "set-camera-target",
                        OP_CUTSCENES_SET_CAMERA_TARGET,
                        1,
                        2,
                },
                {
                        "set-fov",
                        OP_CUTSCENES_SET_FOV,
                        1,
                        1,
                },
                {
                        "get-fov",
                        OP_CUTSCENES_GET_FOV,
                        0,
                        0,
                },
                {
                        "reset-fov",
                        OP_CUTSCENES_RESET_FOV,
                        0,
                        0,
                },
                {
                        "reset-camera",
                        OP_CUTSCENES_RESET_CAMERA,
                        0,
                        1,
                },
                {
                        "show-subtitle",
                        OP_CUTSCENES_SHOW_SUBTITLE,
                        4,
                        13,
                },
                {
                        "show-subtitle-text",
                        OP_CUTSCENES_SHOW_SUBTITLE_TEXT,
                        6,
                        13,
                },
                {
                        "show-subtitle-image",
                        OP_CUTSCENES_SHOW_SUBTITLE_IMAGE,
                        8,
                        10,
                },
                {
                        "set-time-compression",
                        OP_CUTSCENES_SET_TIME_COMPRESSION,
                        1,
                        3,
                },
                {
                        "reset-time-compression",
                        OP_CUTSCENES_RESET_TIME_COMPRESSION,
                        0,
                        0,
                },
                {
                        "lock-perspective",
                        OP_CUTSCENES_FORCE_PERSPECTIVE,
                        1,
                        2,
                },
                {
                        "set-camera-shudder",
                        OP_SET_CAMERA_SHUDDER,
                        2,
                        2,
                },
                ...
                {
                        "set-jumpnode-model",
                        OP_JUMP_NODE_SET_JUMPNODE_MODEL,
                        3,
                        3,
                },
                {
                        "show-jumpnode",
                        OP_JUMP_NODE_SHOW_JUMPNODE,
                        1,
                        1,
                },
                {
                        "hide-jumpnode",
                        OP_JUMP_NODE_HIDE_JUMPNODE,
                        1,
                        1,
                },
...
boost::unordered_map<std::string, int> operator_indices;
...
void init_sexp() {
    ...
    for (int i = 0; i < Num_operators; i++) {
        operator_indices[Operators[i].text] = i;
    }
}
...
int get_operator_index(char *token) {
    boost::unordered_map<std::string, int>::const_iterator found_operator = operator_indices.find(token);

    if (found_operator != operator_indices.end())
        return found_operator->second;
    ...
    while (node != -1) {
        ...
        switch (type) {
                ...
                if (ship_name_lookup(CTEXT(node), 1) < 0) {
                    if (Fred_running || !mission_parse_get_arrival_ship(CTEXT(node))) {
                        ...
                        if (waypoint_lookup(CTEXT(node)) < 0) {
                            if (verify_vector(
                                    CTEXT(node)))                    // verify return non-zero on invalid point
                            {
            ...
            case OPF_SUBSYS_OR_GENERIC: {
                ...
                if (type == OPF_SUBSYS_OR_GENERIC && (!(stricmp(CTEXT(node),
                                                                SEXP_ALL_ENGINES_STRING)) || !(stricmp(CTEXT(node),
                                                                                                       SEXP_ALL_TURRETS_STRING)))) {
                    break;
                }
                ...
                if ((Operators[op].value == OP_SABOTAGE_SUBSYSTEM) || (Operators[op].value == OP_REPAIR_SUBSYSTEM) ||
                    (Operators[op].value == OP_SET_SUBSYSTEM_STRNGTH) || (Operators[op].value == OP_SET_ARMOR_TYPE)) {
                ...
                if (Fred_running) {
                    if ((type == OPF_AWACS_SUBSYSTEM) &&
                        !(Ship_info[ship_class].subsystems[i].flags & MSS_FLAG_AWACS)) {
                        return SEXP_CHECK_INVALID_SUBSYS;
                    }
                }
                ...
                if (Fred_running) {
                    if ((type == OPF_ROTATING_SUBSYSTEM) && !(Ship_info[ship_class].subsystems[i].flags &
                                                              MSS_FLAG_ROTATES)) {
                        return SEXP_CHECK_INVALID_SUBSYS;
                    }
                }
                    ...
                    if (mode == SEXP_MODE_CAMPAIGN) {
                        for (i = 0; i < Campaign.num_missions; i++)
                            if (!stricmp(CTEXT(node), Campaign.missions[i].name)) {
                                if ((i != Sexp_useful_number) && (Campaign.missions[i].level >= Campaign.
                                        missions[Sexp_useful_number].level))
                        ...
                        if ((Operators[op].value == OP_PREVIOUS_EVENT_TRUE) || (Operators[op].value ==
                                                                                OP_PREVIOUS_EVENT_FALSE) ||
                            (Operators[op].value == OP_PREVIOUS_EVENT_INCOMPLETE)
                            || (Operators[op].value == OP_PREVIOUS_GOAL_TRUE) || (Operators[op].value ==
                                                                                  OP_PREVIOUS_GOAL_FALSE) ||
            ...
            case OPF_GOAL_NAME:
                ...
                if (Fred_running && (mode == SEXP_MODE_CAMPAIGN)) {
                    ...
                    if ((Operators[op].value == OP_PREVIOUS_GOAL_TRUE) || (Operators[op].value ==
                                                                           OP_PREVIOUS_GOAL_FALSE) ||
                        (Operators[op].value == OP_PREVIOUS_GOAL_INCOMPLETE))
                        break;
            ...
            case OPF_WHO_FROM:
                ...
                if (*CTEXT(node) != '#') {  // not a manual source?
                    ...
                    if (stricmp(CTEXT(node), "<any wingman>"))  // not a special token?
                        if ((ship_name_lookup(CTEXT(node)) < 0) &&
                            (wing_name_lookup(CTEXT(node), 1) < 0))  // is it in the mission?
                            if (Fred_running || !mission_parse_get_arrival_ship(CTEXT(node)))
                                return SEXP_CHECK_INVALID_MSG_SOURCE;
                }
    ...
    if (!Fred_running) {
        ...
        switch (op) {
            ...
            case OP_WARP_EFFECT:
                ...
                // set flag for taylor
                if (CAR(n) != -1 || !strcmp(Sexp_nodes[n].text,
                                            SEXP_ARGUMENT_STRING))    // if it's evaluating a sexp or a special argument
...
bool has_special_explosion_block_index(ship *shipp, int *index) {
    ...
    for (current_index = (MAX_SEXP_VARIABLES - BLOCK_EXP_SIZE);
         current_index >= (MAX_SEXP_VARIABLES - (BLOCK_EXP_SIZE * Num_special_expl_blocks));
         current_index = (current_index - BLOCK_EXP_SIZE)) {
        if (
...
void build_sexp_text_string(char *buffer, int node, int mode) {
    ...
    if (Sexp_nodes[node].type & SEXP_FLAG_VARIABLE) {
        ...
        Assert((Sexp_variables[sexp_variables_index].type & SEXP_VARIABLE_NUMBER) ||
               (Sexp_variables[sexp_variables_index].type & SEXP_VARIABLE_STRING));
        ...
        if (Sexp_nodes[node].subtype == SEXP_ATOM_NUMBER) {
            ...
            if (mode == SEXP_ERROR_CHECK_MODE) {
                if (Fred_running) {
                    ...
                    sprintf(buffer, "%s[%s] ", Sexp_variables[sexp_variables_index].variable_name,
    ...
    if (n != -1) {
        if (CAR(n) != -1) {
            ...
            if (Sexp_nodes[CAR(n)].value !=
                SEXP_KNOWN_FALSE)        // if the value is still unknown, they all can't be false
                all_false = 0;
        } else
            result |= atoi(CTEXT(n));
...
int sexp_and(int n) {
    ...
    if (n != -1) {
        if (CAR(n) != -1) {
            ...
            if (Sexp_nodes[CAR(n)].value !=
                SEXP_KNOWN_TRUE)        // if the value is still unknown, they all can't be true
                all_true = 0;
        } else
            result &= atoi(CTEXT(n));
    ...
    if (n != -1) {
        if (CAR(n) != -1) {
            ...
            if (Sexp_nodes[CAR(n)].value == SEXP_KNOWN_FALSE)
                return SEXP_KNOWN_FALSE;                                                        // if one of the AND clauses is FALSE, whole clause is false
            if (Sexp_nodes[CAR(n)].value !=
                SEXP_KNOWN_TRUE)        // if value is true, mark our all_true variable for later checking
                all_true = 0;
        } else
            result &= atoi(CTEXT(n));
        ...
        while (CDR(n) != -1) {
            ...
            if (next_result &&
                !result)                // if current result is true, and our running result is false, thngs didn't become true in order
                return SEXP_KNOWN_FALSE;
            result &= next_result;
            if (Sexp_nodes[CDR(n)].value == SEXP_KNOWN_FALSE)
                return SEXP_KNOWN_FALSE;                                                            // if one of the OR clauses is TRUE, whole clause is true
            if (Sexp_nodes[CDR(n)].value !=
                SEXP_KNOWN_TRUE)                // if the value is still unknown, they all can't be false
                all_true = 0;
...
int sexp_number_compare(int n, int op) {
    ...
    // bail on NANs
    if (CAR(first_node) != -1) {
        if (Sexp_nodes[CAR(first_node)].value == SEXP_NAN)
            return SEXP_FALSE;
        if (Sexp_nodes[CAR(first_node)].value == SEXP_NAN_FOREVER)
            return SEXP_KNOWN_FALSE;
    }
    if (CDR(first_node) != -1) {
        if (Sexp_nodes[CDR(first_node)].value == SEXP_NAN)
            return SEXP_FALSE;
        if (Sexp_nodes[CDR(first_node)].value == SEXP_NAN_FOREVER)
            return SEXP_KNOWN_FALSE;
    }
    ...
    for (current_node = CDR(first_node); current_node != -1; current_node = CDR(current_node)) {
        ...
        if (CAR(current_node) != -1) {
            if (Sexp_nodes[CAR(current_node)].value == SEXP_NAN)
                return SEXP_FALSE;
            if (Sexp_nodes[CAR(current_node)].value == SEXP_NAN_FOREVER)
                return SEXP_KNOWN_FALSE;
        }
        if (CDR(current_node) != -1) {
            if (Sexp_nodes[CDR(current_node)].value == SEXP_NAN)
                return SEXP_FALSE;
            if (Sexp_nodes[CDR(current_node)].value == SEXP_NAN_FOREVER)
                return SEXP_KNOWN_FALSE;
        }
        ...
        switch (op) {
            case OP_EQUALS:
                if (first_number != current_number)
                    return SEXP_FALSE;
                break;
...
void sexp_get_object_ship_wing_point_team(object_ship_wing_point_team *oswpt, char *object_name) {
    ...
    if (mission_log_get_time(LOG_SHIP_DEPARTED, object_name, NULL, NULL) || mission_log_get_time(LOG_SHIP_DESTROYED,
                                                                                                 object_name, NULL,
                                                                                                 NULL)) {
    ...
    if (mission_log_get_time(LOG_WING_DESTROYED, object_name, NULL, NULL) || mission_log_get_time(LOG_WING_DEPARTED,
                                                                                                  object_name, NULL,
                                                                                                  NULL)) {
        oswpt->type = OSWPT_TYPE_EXITED;
        return;
...
int sexp_is_destroyed(int n, fix *latest_time) {
    ...
    while (n != -1) {
        ...
        if (mission_log_get_time(LOG_SHIP_DEPARTED, name, NULL, NULL) || mission_log_get_time(LOG_WING_DEPARTED, name,
                                                                                              NULL, NULL))
            return SEXP_KNOWN_FALSE;

        // check the mission log.  If ship/wing not destroyed, immediately return SEXP_FALSE.
        if (mission_log_get_time(LOG_SHIP_DESTROYED, name, NULL, &time) || mission_log_get_time(LOG_WING_DESTROYED,
                                                                                                name, NULL, &time) ||
...
int sexp_has_docked(int n) {
    ...
    if (!mission_log_get_time_indexed(LOG_SHIP_DOCKED, docker, dockee, count, NULL)) {
        ...
        if (mission_log_get_time(LOG_SHIP_DESTROYED, docker, NULL, NULL) || mission_log_get_time(LOG_SHIP_DESTROYED,
                                                                                                 dockee, NULL, NULL))
            return SEXP_KNOWN_FALSE;
            // if either ship departs before they dock, then sexp is known false
        else if (mission_log_get_time(LOG_SHIP_DEPARTED, docker, NULL, NULL) || mission_log_get_time(LOG_SHIP_DEPARTED,
                                                                                                     dockee, NULL,
                                                                                                     NULL))
            return SEXP_KNOWN_FALSE;
        else
...
int sexp_has_undocked(int n) {
    ...
    if (!mission_log_get_time_indexed(LOG_SHIP_UNDOCKED, docker, dockee, count, NULL)) {
        // if either ship destroyed before they undock, then sexp is known false
        if (mission_log_get_time(LOG_SHIP_DESTROYED, docker, NULL, NULL) || mission_log_get_time(LOG_SHIP_DESTROYED,
                                                                                                 dockee, NULL, NULL))
            return SEXP_KNOWN_FALSE;
            // if either ship departs before they dock, then sexp is known false
...
int sexp_has_arrived(int n, fix *latest_time) {
    ...
    while (n != -1) {
        ...
        if (mission_log_get_time(LOG_SHIP_ARRIVED, name, NULL, &time) || mission_log_get_time(LOG_WING_ARRIVED, name,
                                                                                              NULL, &time)) {
            num_arrived++;
            if (latest_time && (time > *latest_time))
                *latest_time = time;
...
int sexp_has_departed(int n, fix *latest_time) {
    ...
    while (n != -1) {
        ...
        if (mission_log_get_time(LOG_SHIP_DESTROYED, name, NULL, NULL) || mission_log_get_time(LOG_WING_DESTROYED,
                                                                                               name, NULL, NULL))
            return SEXP_KNOWN_FALSE;
        else if (mission_log_get_time(LOG_SHIP_DEPARTED, name, NULL, &time) || mission_log_get_time(LOG_WING_DEPARTED,
                                                                                                    name, NULL,
                                                                                                    &time)) {
            num_departed++;
            if (latest_time && (time > *latest_time))
...
int sexp_is_disabled(int n, fix *latest_time) {
    ...
    while (n != -1) {
        ...
        // the sexpression is not true.
        if (mission_log_get_time(LOG_SHIP_DEPARTED, name, NULL, &time) || mission_log_get_time(LOG_SHIP_DESTROYED,
                                                                                               name, NULL, &time))
            return SEXP_KNOWN_FALSE;
...
int sexp_has_undocked_delay(int n) {
    ...
    if (!mission_log_get_time_indexed(LOG_SHIP_UNDOCKED, docker, dockee, count, &time)) {
        ...
        if (mission_log_get_time(LOG_SHIP_DESTROYED, docker, NULL, NULL) || mission_log_get_time(LOG_SHIP_DESTROYED,
                                                                                                 dockee, NULL, NULL))
            return SEXP_KNOWN_FALSE;
            // if either ship departs before they undock, then sexp is known false
        else if (mission_log_get_time(LOG_SHIP_DEPARTED, docker, NULL, NULL) || mission_log_get_time(LOG_SHIP_DEPARTED,
                                                                                                     dockee, NULL,
                                                                                                     NULL))
            return SEXP_KNOWN_FALSE;
...
int sexp_special_warp_dist(int n) {
    ...
    // false
    if (mission_log_get_time(LOG_SHIP_DESTROYED, ship_name, NULL, NULL) || mission_log_get_time(LOG_SHIP_DEPARTED,
                                                                                                ship_name, NULL,
                                                                                                NULL)) {
        return SEXP_NAN_FOREVER;
    }
    ...
    // get distance
    vec3d hit_pt;
    float dist = fvi_ray_plane(&hit_pt, &warp_objp->pos, &warp_objp->orient.vec.fvec, &ship_objp->pos, &ship_objp->
            orient.vec.fvec, 0.0f);
...
int sexp_shields_left(int n) {
    ...
    if (mission_log_get_time(LOG_SHIP_DESTROYED, shipname, NULL, NULL) || mission_log_get_time(LOG_SHIP_DEPARTED,
                                                                                               shipname, NULL, NULL)) {
        return SEXP_NAN_FOREVER;
    }
...
int sexp_distance_subsystem(int n) {
    ...
    if (mission_log_get_time(LOG_SHIP_DESTROYED, ship_with_subsys_name, NULL, NULL) ||
        mission_log_get_time(LOG_SHIP_DEPARTED, ship_with_subsys_name, NULL, NULL))
        return SEXP_NAN_FOREVER;
...
void sexp_set_object_speed(object *objp, int speed, int axis, int subjective) {
    ...
    if (subjective) {
        ...
        vec3d subjective_desired_vel;

        // translate objective into subjective velocity
        vm_vec_rotate(&subjective_vel, &objp->phys_info.vel, &objp->orient);
        vm_vec_rotate(&subjective_desired_vel, &objp->phys_info.desired_vel, &objp->orient);

        // set it
        subjective_vel.a1d[axis] = i2fl(speed);
        subjective_desired_vel.a1d[axis] = i2fl(speed);

        // translate it back to objective
        vm_vec_unrotate(&objp->phys_info.vel, &subjective_vel, &objp->orient);
        vm_vec_unrotate(&objp->phys_info.desired_vel, &subjective_desired_vel, &objp->orient);
    } else {
        objp->phys_info.vel.a1d[axis] = i2fl(speed);
        objp->phys_info.desired_vel.a1d[axis] = i2fl(speed);
    }
}
...
int sexp_get_object_coordinate(int n, int axis) {
    ...
    if (oswpt.objp->type == OBJ_SHIP) {
        if ((subsystem_name != NULL) && stricmp(subsystem_name, SEXP_NONE_STRING) && stricmp(subsystem_name,
                                                                                             SEXP_HULL_STRING)) {
            pos = &subsys_pos_buf;
...
void sexp_set_object_orient(object *objp, vec3d *location, int turn_time, int bank) {
    ...
    if (turn_time) {
        ...
        // turn
        ai_turn_towards_vector(location, objp, flFrametime, float(turn_time) / (1000.0f), NULL, NULL, 0.0f, 0,
                               NULL, (AITTV_VIA_SEXP | bank));
    ...
    objp->phys_info.desired_rotvel = vmd_zero_vector;
...
void sexp_set_ship_man(object *objp, int duration, float heading, float pitch, float bank, int force_rotate, float up,
                       float sideways, float forward, int force_control) {
...
void sexp_set_oswpt_maneuver(object_ship_wing_point_team *oswpt, int duration, float heading, float pitch, float bank,
                             int force_rotate, float up, float sideways, float forward, int force_control) {
    Assert(oswpt);
    ...
    switch (oswpt->type) {
        case OSWPT_TYPE_TEAM: {
            for (ship_obj *so = GET_FIRST(&Ship_obj_list); so != GET_LAST(&Ship_obj_list); so = GET_NEXT(so)) {
                ...
                if (obj_team(objp) == oswpt->team)
                    sexp_set_ship_man(objp, duration, heading, pitch, bank, force_rotate, up, sideways, forward,
                                      force_control);
            }
        ...
        case OSWPT_TYPE_SHIP:
        case OSWPT_TYPE_WAYPOINT:
            sexp_set_ship_man(oswpt->objp, duration, heading, pitch, bank, force_rotate, up, sideways, forward,
                              force_control);
            break;
...
void sexp_set_ship_maneuver(int n) {
    ...
    if ((bank == 0.0f) && (pitch == 0.0f) && (heading == 0.0f) && (force_rotate == 0) && (up == 0.0f) &&
        (sideways == 0.0f) && (forward == 0.0f) && (force_control == 0))
        return;

    sexp_set_oswpt_maneuver(&oswpt, duration, heading, pitch, bank, force_rotate, up, sideways, forward,
                            force_control);
}
    ...
    for (n = CDR(n); n != -1; n = CDR(n)) {
        ...
        if (wingnum != -1) {
            ...
            if (what == OP_PERCENT_SHIPS_DEPARTED)
                ...
                Error(LOCATION,
                      "Invalid status check '%d' for wing '%s' in sexp_percent_ships_arrive_depart_destroy_disarm_disable",
                      what, name);
        } else {
            ...
            if (what == OP_PERCENT_SHIPS_DEPARTED) {
                ...
                Error("Invalid status check '%d' for ship '%s' in sexp_percent_ships_depart_destroy_disarm_disable",
                      what, name);
...
int sexp_destroyed_departed_delay(int n) {
    ...
    while (n != -1) {
        ...
        wingnum = wing_name_lookup(name, 1);
        if (wingnum != -1) {
            if (Wings[wingnum].flags & WF_NEVER_EXISTED) {
                // be sure to get the latest time of one of these
                if (Wings[wingnum].time_gone > latest_time) {
                    time_gone = Wings[wingnum].time_gone;
                }
                count++;
            } else if (mission_log_get_time(LOG_WING_DEPARTED, name, NULL, &time_gone)) {
                count++;
            } else if (mission_log_get_time(LOG_WING_DESTROYED, name, NULL, &time_gone)) {
                count++;
            }
...
int sexp_special_warpout_name(int node) {
    ...
    if (mission_log_get_time(LOG_SHIP_DESTROYED, ship_name, NULL, NULL) || mission_log_get_time(LOG_SHIP_DEPARTED,
                                                                                                ship_name, NULL,
                                                                                                NULL) ||
        mission_log_get_time(LOG_SHIP_DESTROYED, knossos, NULL, NULL) || mission_log_get_time(LOG_SHIP_DEPARTED,
                                                                                              knossos, NULL, NULL))
        return SEXP_NAN_FOREVER;
...
void sexp_set_scannable(int node) {
    bool scannable = (is_sexp_true(node) != 0);

    for (node = CDR(node); node != -1; node = CDR(node)) {
        int sindex = ship_name_lookup(CTEXT(node));

        if (scannable) {
            Ships[sindex].flags |= SF_SCANNABLE;
        } else {
            Ships[sindex].flags &= ~SF_SCANNABLE;
        }
    }
...
void sexp_set_scanned_unscanned(int n, int flag) {
    ...
    while (n != -1) {
        ...
        if (ss == NULL && ship_class_unchanged(shipnum)) {
            Error(LOCATION, "Couldn't find subsystem '%s' on ship '%s' in sexp_set_scanned_unscanned", subsys_name,
                  ship_name);
        }
...
// Goober5000
int test_argument_list_for_condition(int n, int condition_node, int *num_true, int *num_false, int *num_known_true,
                                     int *num_known_false) {
...
int eval_any_of(int arg_handler_node, int condition_node) {
    ...
    num_valid_arguments = test_argument_list_for_condition(n,
                                                           condition_node, &num_true, &num_false, &num_known_true,
                                                           &num_known_false);
...
int sexp_is_iff(int n) {
    ...
    for (; n != -1; n = CDR(n)) {
        ...
        switch (oswpt.type) {
            ...
            default: {
                // Invalid type or the ship or wing in question has already departed or been destroyed.
                // No valid IFF for this object, therefore we return false.
                return SEXP_FALSE;
            }
...
void sexp_ingame_ship_change_iff_color(ship *shipp, int observer_team, int observed_team, int alternate_iff_color) {
    ...
    if ((Game_mode & GM_MULTIPLAYER) && (Net_player != NULL) && (Net_player->flags & NETINFO_FLAG_AM_MASTER) &&
        (shipp->objnum >= 0))
        send_change_iff_color_packet(Objects[shipp->objnum].net_signature, observer_team, observed_team,
                                     alternate_iff_color);
}

void sexp_parse_ship_change_iff_color(p_object *parse_obj, int observer_team, int observed_team,
    ...
    for (; n != -1; n = CDR(n)) {
        ...
        switch (oswpt.type) {
            ...
            case OSWPT_TYPE_WING: {
                // current ships
                for (i = 0; i < oswpt.wingp->current_count; i++)
                    sexp_ingame_ship_change_iff_color(&Ships[oswpt.wingp->ship_index[i]], observer_team, observed_team,
                                                      alternate_iff_color);
...
void sexp_play_sound_from_table(int n) {
    ...
    game_snd *sound = &Snds[sound_index];

    if ((sound->flags & GAME_SND_USE_DS3D) != 0) {
        snd_play_3d(&Snds[sound_index], &origin, &View_position, 0.0f, NULL, 0, 1.0f, SND_PRIORITY_MUST_PLAY);
    } else {
        snd_play(sound, 0.0f, 1.0f, SND_PRIORITY_MUST_PLAY);
    }
...
void sexp_trigger_arrival_track(int n) {
    // First node
    if (n == -1) {
        Warning(LOCATION, "Detected missing team parameter in sexp_trigger_arrival_track");
        return;
    }

    int team = iff_lookup(CTEXT(n));

    if (team == -1) {
        Warning(LOCATION, "Detected invalid team parameter in sexp_trigger_arrival_track");
        return;
    }

    event_music_arrival(team);
}

void multi_sexp_trigger_arrival_track() {}
    ...
    if (max_damage || max_blast) {
        if (shockwave_speed > 0) {
            ...
            for (objp = GET_FIRST(&obj_used_list); objp != END_OF_LIST(&obj_used_list); objp = GET_NEXT(objp)) {
                ...
                if (ship_explode_area_calc_damage(&origin, &objp->
                                                          pos, (float) inner_radius, (float) outer_radius, (float) max_damage, (float) max_blast,
                                                  &t_damage,
                                                  &t_blast) == -1) {
                    continue;
                }
	...
	*/
{
    ...
    fireball_create(&origin, fireball_type, FIREBALL_WARP_EFFECT, -1, (float) radius, 0,
                    NULL, (float) duration, -1, &m_orient, 0, extra_flags, warp_open_sound_index,
                    warp_close_sound_index);
}
...
void sexp_send_one_message(char *name, char *who_from, char *priority, int group, int delay) {
    ...
    if (who_from[0] == '#') {
        ...
        ship_index = ship_get_random_ship_in_wing(num, SHIP_GET_UNSILENCED);
        if (ship_index == -1) {
    ...
    } else if (mission_log_get_time(LOG_SHIP_DESTROYED, who_from, NULL, NULL) || mission_log_get_time(LOG_SHIP_DEPARTED,
                                                                                                      who_from, NULL,
                                                                                                      NULL)
...
void sexp_set_cargo(int n) {
    ...
    // check to see if ship destroyed or departed.  In either case, do nothing.
    if (mission_log_get_time(LOG_SHIP_DEPARTED, ship, NULL, NULL) || mission_log_get_time(LOG_SHIP_DESTROYED, ship,
                                                                                          NULL, NULL))
        return;
    ...
    if (!(Ship_info[Ships[shipnum2].ship_info_index].flags & (SIF_BIG_SHIP | SIF_HUGE_SHIP))) {
        if (stricmp(Cargo_names[Ships[shipnum2].cargo1 & CARGO_INDEX_MASK], "nothing")) {
            Warning(LOCATION, "Transfering cargo to %s which already\nhas cargo %s.\nCargo will be replaced",
                    Ships[shipnum2].ship_name, Cargo_names[Ships[shipnum2].cargo1 & CARGO_INDEX_MASK]);
        }
    }
#endif
...
void sexp_add_background_bitmap(int n) {
    ...
    if (Sexp_variables[sexp_var].type & SEXP_VARIABLE_NUMBER) {
        ...
        Error(LOCATION, "sexp-add-background-bitmap: Variable %s must be a number variable!",
...
void sexp_add_sun_bitmap(int n) {
    ...
    if (Sexp_variables[sexp_var].type & SEXP_VARIABLE_NUMBER) {
        ...
        Error(LOCATION, "sexp-add-sun-bitmap: Variable %s must be a number variable!",
              Sexp_variables[sexp_var].variable_name);
        return;
    }
}
...
void sexp_good_time_to_rearm(int n) {
    ...
    team = iff_lookup(CTEXT(n));
    time = eval_num(
            CDR(n));                        // this is the time for how long a good rearm is active -- in seconds
...
void sexp_deal_with_ship_flag(int node, int object_flag, int object_flag2, int ship_flag, int ship_flag2,
                              int p_object_flag, int p_object_flag2, int set_it, bool send_multiplayer = false,
    ...
    for (; node >= 0; node = CDR(node)) {
        ...
        // check to see if ship destroyed or departed.  In either case, do nothing.
        if (mission_log_get_time(LOG_SHIP_DEPARTED, ship_name, NULL, NULL) || mission_log_get_time(LOG_SELF_DESTRUCTED,
                                                                                                   ship_name, NULL,
                                                                                                   NULL) ||
...
void sexp_good_secondary_time(int n) {
    ...
    // AI stuff
    if (mission_log_get_time(LOG_SHIP_DEPARTED, ship_name, NULL, NULL) || mission_log_get_time(LOG_SHIP_DESTROYED,
                                                                                               ship_name, NULL, NULL))
        return;
    ...
    if (Game_mode & GM_CAMPAIGN_MODE) {
        ...
        if (i == -1) {
            ...
            if (i == Campaign.missions[mission_num].num_goals) {
                Warning(LOCATION, "Couldn't find goal name %s in mission %s.\nReturning %s for goal-true function.",
                        goal_name, mission_name, (status == GOAL_COMPLETE) ? "false" : "true");
                if (status == GOAL_COMPLETE)
                    rval = SEXP_KNOWN_FALSE;
                else
                    rval = SEXP_KNOWN_TRUE;
    ...
    if (Game_mode & GM_CAMPAIGN_MODE) {
        ...
        if (i == -1) {
            ...
            if (i == Campaign.missions[mission_num].num_events) {
                Warning(LOCATION,
                        "Couldn't find event name %s in mission %s.\nReturning %s for event_status function.", name,
...
int sexp_goal_incomplete(int n) {
    ...
    if (mission_log_get_time(LOG_GOAL_SATISFIED, name, NULL, NULL) || mission_log_get_time(LOG_GOAL_FAILED, name, NULL,
                                                                                           NULL))
        return SEXP_KNOWN_FALSE;
    else
        return SEXP_TRUE;
...
void sexp_ship_subsys_untargetable(int n, int untargetable) {
    ...
    for (; n >= 0; n = CDR(n)) {
        ...
        if (generic_type) {
            for (ss = GET_FIRST(&Ships[ship_num].subsys_list); ss != END_OF_LIST(&Ships[ship_num].subsys_list);
                 ss = GET_NEXT(ss)) {
...
void sexp_ship_tag(int n, int tag) {
    ...
    // check to see if ship destroyed or departed.  In either case, do nothing.
    if (mission_log_get_time(LOG_SHIP_DEPARTED, CTEXT(n), NULL, NULL) || mission_log_get_time(LOG_SHIP_DESTROYED,
                                                                                              CTEXT(n), NULL, NULL))
        return;
    ...
    ship_apply_tag(ship_num, tag_level, (float) tag_time, &Objects[Ships[ship_num].objnum], &start, ssm_index,
                   ssm_team);
}
        ...
        if (hull_name != NULL) {
            ...
            if (!strcmp(hull_name, SEXP_HULL_STRING)) {
                ...
                if (ss == NULL) {
                    if (ship_class_unchanged(ship_num)) {
                        Warning(LOCATION,
                                "Invalid subsystem passed to ship-subsys-guardian-threshold: %s does not have a %s subsystem",
                                ship_name, hull_name);
                    }
                } else {
                    ss->subsys_guardian_threshold = threshold;
...
// KeldorKatarn
void sexp_hide_ship_name(int node) {
    bool hide_name = (is_sexp_true(node) != 0);

    for (node = CDR(node); node != -1; node = CDR(node)) {
        int sindex = ship_name_lookup(CTEXT(node));

        if (hide_name) {
            Ships[sindex].flags2 |= SF2_HIDE_SHIP_NAME;
        } else {
            Ships[sindex].flags2 &= ~SF2_HIDE_SHIP_NAME;
        }
    }
...
int sexp_primary_ammo_pct(int node) {
    ...
    if (check >= shipp->weapons.num_primary_banks) {
        for (idx = 0; idx < shipp->weapons.num_primary_banks; idx++) {
            // ballistic
            if (Weapon_info[shipp->weapons.primary_bank_weapons[idx]].wi_flags2 & WIF2_BALLISTIC) {
                ret_sum[idx] = (int) (((float) shipp->weapons.primary_bank_ammo[idx] / (float) shipp->weapons.
                        primary_bank_start_ammo[idx]) * 100.0f);
            }
                // non-ballistic
            else {
                ret_sum[idx] = 100;
        ...
        if (Weapon_info[shipp->weapons.primary_bank_weapons[check]].wi_flags2 & WIF2_BALLISTIC) {
            ret = (int) (((float) shipp->weapons.primary_bank_ammo[check] / (float) shipp->weapons.
                    primary_bank_start_ammo[check]) * 100.0f);
        }
            // non-ballistic
        else {
            ret = 100;
...
int sexp_secondary_ammo_pct(int node) {
    ...
    if (check >= shipp->weapons.num_secondary_banks) {
        for (idx = 0; idx < shipp->weapons.num_secondary_banks; idx++) {
            ret_sum[idx] = (int) (((float) shipp->weapons.secondary_bank_ammo[idx] / (float) shipp->weapons.
                    secondary_bank_start_ammo[idx]) * 100.0f);
        }
        ...
        ret = (int) (((float) shipp->weapons.secondary_bank_ammo[check] / (float) shipp->weapons.
                secondary_bank_start_ammo[check]) * 100.0f);
    }
...
void ship_copy_damage(ship *target_shipp, ship *source_shipp) {
    ...
    for (source_ss = GET_FIRST(&source_shipp->subsys_list); source_ss != GET_LAST(&source_shipp->subsys_list);
         source_ss = GET_NEXT(source_ss)) {
...
void copy_subsys_status_to_end(p_object *pobjp);
...
void parse_copy_damage(p_object *target_pobjp, ship *source_shipp) {
    ...
    for (source_ss = GET_FIRST(&source_shipp->subsys_list); source_ss != GET_LAST(&source_shipp->subsys_list);
        ...
        // At least one is not allocated.
        if (target_sssp == NULL) {
            subsystem_missing = true;
            break;
        }
    }

    if (subsystem_missing) {
        copy_subsys_status_to_end(target_pobjp);
    }
    ...
    for (source_ss = GET_FIRST(&source_shipp->subsys_list); source_ss != GET_LAST(&source_shipp->subsys_list);
        ...
        if (target_sssp == NULL) {
            int index = allocate_subsys_status();

            target_sssp = &Subsys_status[index];
...
void sexp_set_skybox_model(int n) {
    for (; n != -1; n = CDR(n)) {
        if (!stricmp("default", CTEXT(n))) {
            ...
            stars_set_background_model(CTEXT(n), NULL, The_mission.skybox_flags);
        }
    }
}
...
void sexp_beam_fire(int node) {
    ...
    if (fire_info.turret->weapons.num_primary_banks <= 0) {
        Warning(LOCATION, "Couldn't fire turret on ship %s; subsystem %s has no primary weapons", CTEXT(node),
                CTEXT(CDR(node)));
        return;
    }
    ...
    if (fire_info.beam_info_index != -1) {
        ...
        Warning(LOCATION, "Couldn't fire turret on ship %s; subsystem %s has no beam weapons", CTEXT(node),
                CTEXT(CDR(node)));
    }
}
    ...
    for (; node >= 0; node = CDR(node)) {
        ...
        if (locked) {
            ...
            if (rotate->system_info->rotation_snd >= 0) {
                obj_snd_assign(Ships[ship_num].objnum, rotate->system_info->rotation_snd, &rotate->system_info->pnt, 0,
                               OS_SUBSYS_ROTATION, rotate);
                rotate->subsys_snd_flags |= SSSF_ROTATE;
            }
        }
    }
...
void sexp_set_support_ship(int n) {
    ...
    if ((temp_val < 0) && ((stricmp(CTEXT(n), "<species support ship class>")) && (stricmp(CTEXT(n),
...
void sexp_remove_weapons(int node) {
    ...
    if (node >= 0) {
        ...
        if (weapon_info_index == -1) {
            char *buf = CTEXT(node);
            mprintf((
                            "Remove-weapons attempted to remove %s. Weapon not found. Remove-weapons will remove all weapons currently in the mission", buf));
        }
    }
        ...
        if (p_objp->flags & P_OF_PLAYER_START) {
            switch (type) {
                case OP_SHIP_DEATHS:
                    ...
                    return mission_log_get_count(LOG_SHIP_DESTROYED, CTEXT(node),
                                                 NULL) + mission_log_get_count(LOG_SELF_DESTRUCTED, CTEXT(node), NULL);
...
int process_special_sexps(int index) {
    switch (index) {
        ...
        case 5:    //	Player's shield is quick repaired
            ...
            //hud_shield_quadrant_hit(Player_obj, FRONT_QUAD);
            if (Player_obj->shield_quadrant[FRONT_QUAD] > Player_obj->shield_quadrant[(FRONT_QUAD +
                                                                                       1) % MAX_SHIELD_SECTIONS] - 2.0f)
                return SEXP_TRUE;
            else
                return SEXP_FALSE;
            break;
...
void sexp_set_camera_fov(int n) {
    ...
    float camera_zoom = Viewer_zoom_default;
    float camera_time = 0.0f;
    float camera_acc_time = 0.0f;
    float camera_dec_time = 0.0f;

    camera_zoom = i2fl(eval_num(n)) * (PI / 180.0f);
    n = CDR(n);
    ...
    cam->set_zoom(camera_zoom, camera_time, camera_acc_time, camera_dec_time);
}
...
void sexp_set_fov(int n) {
    ...
    Sexp_zoom = gr_fov_to_zoom(new_fov * (PI / 180.0f));
    //cam->set_zoom(eval_num(n) * (PI/180.0f));
}
...
int sexp_get_fov() {
    ...
    if (cam == NULL)
        return -1;
    else if (Sexp_zoom > 0.0f)
        // SEXP override has been set
        return (int) (gr_zoom_to_fov(Sexp_zoom) / (PI / 180.0f));
    else
        return (int) (gr_zoom_to_fov(cam->get_zoom()) / (PI / 180.0f));
}
...
void sexp_reset_fov() {
    ...
    Sexp_zoom = 0.0;
    //cam->set_zoom(Viewer_zoom_default);
}
...
void sexp_show_subtitle(int node) {
    ...
    subtitle new_subtitle(x_pos, y_pos, text, imageanim, display_time, fade_time, &new_color, center_x, center_y,
                          width, 0, post_shaded);
...
void sexp_show_subtitle_text(int node) {
    ...
    int x_pos = static_cast<int>(gr_screen.max_w * (x_pct / 100.0f));
    int y_pos = static_cast<int>(gr_screen.max_h * (y_pct / 100.0f));
    int width = static_cast<int>(gr_screen.max_w * (width_pct / 100.0f));

    // add the subtitle
    subtitle new_subtitle(x_pos, y_pos, text, NULL, display_time, fade_time, &new_color, center_x, center_y, width, 0,
                          post_shaded);
    Subtitles.push_back(new_subtitle);
}
...
void sexp_show_subtitle_image(int node) {
    ...
    int y_pos = static_cast<int>(gr_screen.max_h * (y_pct / 100.0f));
    int width = static_cast<int>(gr_screen.max_w * (width_pct / 100.0f));
    int height = static_cast<int>(gr_screen.max_h * (height_pct / 100.0f));

    // add the subtitle
    subtitle new_subtitle(x_pos, y_pos, NULL, image, display_time, fade_time, NULL, center_x, center_y, width, height,
                          post_shaded);
    Subtitles.push_back(new_subtitle);
}
...
int sexp_script_eval(int node, int return_type) {
    ...
    switch (return_type) {
        ...
        case OPR_STRING:
            Error(LOCATION,
                  "SEXP system does not support string return type; Goober must fix this before script-eval-string will work"
            );
            break;
        case OPR_NULL:
            while (n != -1) {
...
void multi_sexp_force_battle_music() {}


void sexp_force_battle_music(int node) {
    Force_battle_music = is_sexp_true(node) != 0;
}
...
int sexp_matching_speed() {
    return ((Player->flags & PLAYER_FLAGS_MATCH_TARGET) != 0);
}


void sexp_set_forward_deceleration(int node) {
    float new_deceleration_time_const = static_cast<float>(eval_num(node));

    // for all ships
    for (node = CDR(node); node != -1; node = CDR(node)) {
        char *ship_name = CTEXT(node);
        int ship_num = ship_name_lookup(ship_name);

        if (ship_num != -1) {
            ship *shipp = &Ships[ship_num];
            Objects[shipp->objnum].phys_info.forward_decel_time_const = new_deceleration_time_const;
        }
    }
}

void sexp_allow_dynamic_goals(int node) {
    bool allow_dynamic_goals = (is_sexp_true(node) != 0);
    ...
    for (node = CDR(node); node != -1; node = CDR(node)) {
        ...
        switch (oswpt.type) {
            // Change current ship
            case OSWPT_TYPE_SHIP: {
                ai_info *aip = &Ai_info[oswpt.shipp->ai_index];

                if (allow_dynamic_goals) {
            ...
            case OSWPT_TYPE_PARSE_OBJECT: {
                if (allow_dynamic_goals) {
                    oswpt.p_objp->flags &= ~P_AIF_NO_DYNAMIC;
                } else {
                    oswpt.p_objp->flags |= P_AIF_NO_DYNAMIC;
                }
            }
            ...
            case OSWPT_TYPE_WING: {
                // Current ships
                for (int i = 0; i < oswpt.wingp->current_count; i++) {
                    ai_info *aip = &Ai_info[Ships[oswpt.wingp->ship_index[i]].ai_index];
...
int eval_sexp(int cur_node, int referenced_node) {
    ...
    if (Sexp_nodes[cur_node].first != -1) {
        ...
        switch (op_num) {
            ...
            case OP_WAS_DESTROYED_BY:
                sexp_val = sexp_was_destroyed_by(node, NULL);
                break;
            ...
            case OP_SET_SCANNABLE:
                sexp_set_scannable(node);
                sexp_val = SEXP_TRUE;    // SEXP_TRUE means only do once.
                break;
            ...
            case OP_HIDE_SHIP_NAME:
                sexp_hide_ship_name(node);
                sexp_val = SEXP_TRUE;
                break;
            ...
            case OP_TRIGGER_ARRIVAL_TRACK:
                sexp_trigger_arrival_track(node);
                sexp_val = SEXP_TRUE;
                break;

            case OP_FORCE_BATTLE_MUSIC:
                sexp_force_battle_music(node);
                sexp_val = SEXP_TRUE;
                break;
            ...
            case OP_SET_FORWARD_DECELERATION:
                sexp_set_forward_deceleration(node);
                sexp_val = SEXP_TRUE;
                break;
            ...
            case OP_MATCHING_SPEED:
                sexp_val = sexp_matching_speed();
                break;
			...
			*/
            ...
            case OP_ALLOW_DYNAMIC_GOALS:
                sexp_allow_dynamic_goals(node);
                sexp_val = SEXP_TRUE;
                break;
...
void multi_sexp_eval() {
    ...
    while (Multi_sexp_bytes_left > 0) {
        ...
        if (op_num < 0) {
            Warning(LOCATION,
                    "Received invalid SEXP packet from host. Entire packet may be corrupt. Discarding packet");
            Int3();
            return;
        }
        ...
        switch (op_num) {
            ...
            case OP_TRIGGER_ARRIVAL_TRACK:
                multi_sexp_trigger_arrival_track();
                break;

            case OP_FORCE_BATTLE_MUSIC:
                multi_sexp_force_battle_music();
                break;
            ...
            default:
                ...
                if (multi_sexp_discard_operator()) {
                    Warning(LOCATION,
                            "Received invalid SEXP operator number from host. Operator number %d is not supported by this version.",
                            op_num);
                }
                    // a more major problem
                else {
                    Warning(LOCATION,
                            "Received invalid SEXP packet from host. Function involving operator %d lacks termination. Entire packet may be corrupt. Discarding remaining packet");
                    Int3();
                    return;
                }
        }
...
int get_sexp_main() {
    ...
    *Mp = '\0';
    ...
    char *node_text = CTEXT(start_node);
    op = get_operator_index(node_text);
    if (op == -1)
...
DCF(sexpc,
"Always runs the given sexp command ")
{
if (Dc_command)       {
...
snprintf(buf,
8191, "( when ( true ) ( %s ) )", Dc_command_line);
...
int query_operator_argument_type(int op, int argnum) {
    ...
    switch (op) {
        ...
        case OP_NAV_SET_VISITED:    //kazan
        case OP_NAV_UNSET_VISITED:    //kazan
        case OP_NAV_SELECT:    //KeldorKatarn
            return OPF_STRING;
        ...
        case OP_NAV_UNSELECT:        // KeldorKatarn
            return OPF_NONE;
...
void update_sexp_references(char *old_name, char *new_name, int format, int node) {
    ...
    while (n >= 0) {
        if (SEXP_NODE_TYPE(n) == SEXP_LIST) {
            ...
            Assert((SEXP_NODE_TYPE(n) == SEXP_ATOM) && ((Sexp_nodes[n].subtype == SEXP_ATOM_NUMBER) ||
...
void sexp_set_variable_by_index(int node) {
    ...
    if (sexp_variable_index < 0 || sexp_variable_index > MAX_SEXP_VARIABLES) {
        Warning(LOCATION, "variable-array-set: sexp variable index %d out of range!  min is 0; max is %d",
...
int sexp_get_variable_by_index(int node) {
    ...
    // check range
    if (sexp_variable_index < 0 || sexp_variable_index > MAX_SEXP_VARIABLES) {
        Warning(LOCATION, "variable-array-get: sexp variable index %d out of range!  min is 0; max is %d",
                sexp_variable_index, MAX_SEXP_VARIABLES - 1);
        return 0;
    }
...
int sexp_campaign_persistent_variable_count() {
    ...
    for (int i = 0; i < MAX_SEXP_VARIABLES; i++) {
        if ((Sexp_variables[i].type & SEXP_VARIABLE_SET) && (Sexp_variables[i].type &
                                                             SEXP_VARIABLE_CAMPAIGN_PERSISTENT)) {
            count++;
        }
    }
...
int get_subcategory(int sexp_id) {
    switch (sexp_id) {
        ...
        case OP_SET_WEAPON_ENERGY:
        case OP_SET_SHIELD_ENERGY:
        case OP_SET_SCANNABLE:    // KeldorKatarn
...
sexp_help_struct Sexp_help[] = {
        ...
        {OP_NAV_SELECT,                         "Takes 1 Argument: NavPoint Name, it then sets it as the currently selected one.\r\n"},

        {OP_NAV_UNSELECT,                       "Un-selects the currently selected nav (if any).\r\n"},
        ...
        {OP_WAS_DESTROYED_BY_DELAY,             "Was destroyed by delay (Boolean operator)\r\n"
                                                ...
                                                "\t1:\tTime delay in seconds (see above).\r\n"
                                                "\t1:\tShip that should have destroyed the other ships (see below).\r\n"
        ...
        // KeldorKatarn
        {OP_ALLOW_DYNAMIC_GOALS,                "Allow dynamic AI goals (Action operator)\r\n"
                                                "\tAllows/Prevents the specified ship(s) or wing(s) to get new AI goals dynamically.\r\n"
                                                "Takes 2 or more arguments...\r\n"
                                                "\t1:\tWhether or not to allow dynamic goals.\r\n"
                                                "\tRest:\tName of ship or wing to change dynamic goal behavior on."},
        ...
        {OP_SET_FORWARD_DECELERATION,           "Set forward deceleration\r\n"
                                                "\tSets the forward deceleration value for a ship.r\n"
                                                "Takes 2 or more arguments...\r\n"
                                                "\t1:\tNew forward deceleration value.\r\n"
                                                "\tRest:\tName of the ship."},
        ...
        // KeldorKatarn
        {OP_TRIGGER_ARRIVAL_TRACK,              "trigger-arrival-track\r\n"
                                                "\tTriggers the appropriate arrival track. Important: This may start a battle track if the team is hostile, however the battle track will be ended right away if no enemies are present!\r\n"
                                                "Takes 1 argument...\r\n"
                                                "\t1:\tTeam Name"},

        // KeldorKatarn
        {OP_FORCE_BATTLE_MUSIC,                 "force-battle-music\r\n"
                                                "\tForces the sound system to remain in battle mode. Important: This needs to be deactivated again to allow victory music etc. to begin!\r\n"
                                                "Takes 1 argument...\r\n"
                                                "\t1:\tTrue activates the battle music forcing, false deactivates it."},
	...
	*/
        ...
        {OP_MATCHING_SPEED,                     "Checks whether the player is currently matching speed with the selected target.\r\n"
                                                "Takes no arguments..."},
        ...
        {OP_SET_SCANNABLE,                      "Set scannable\r\n"
                                                "\tSets the scannable status of a ship.  Takes 2 or more arguments...\r\n"
                                                "\t1:\tTrue if the ship should be scannable, false if not."
                                                "\tRest:\tNames of ships to set.."},
        ...
        // KeldorKatarn
        {OP_HIDE_SHIP_NAME,                     "ship-hide-name\r\n"
                                                "\tHides or unhides the name of a ship.  Takes 2 or more arguments...\r\n"
                                                "\t1:\tTrue if the ship name should be hidden, false if not."
                                                "\tRest:\tNames of ships.."},
        ...
        {
                {
                        ...
                        CHANGE_SUBCATEGORY_MESSAGING_AND_MISSION_GOALS
                },
                {
                        "AI and IFF",
                        CHANGE_SUBCATEGORY_AI_AND_IFF
                },
                {
                        "Subsystems and Cargo",
                        CHANGE_SUBCATEGORY_SUBSYSTEMS_AND_CARGO
                },
                {
                        "Ship Status",
                ...
                {
                        "Special",
                        CHANGE_SUBCATEGORY_SPECIAL
                },
                {
                        "Multiplayer and Mission Config",
                        STATUS_SUBCATEGORY_MULTIPLAYER_AND_MISSION_CONFIG
                },
                {
                ...
                {
                        "Kills and Scoring",
                        STATUS_SUBCATEGORY_KILLS_AND_SCORING
                },
        };
...
static void output_sexp_html(int sexp_idx, FILE *fp) {
    ...
    if (!printed)
        fprintf(fp, "<dt><b>%s</b></dt>\n<dd>Min arguments: %d, Max arguments: %d</dd>\n", Operators[sexp_idx].text,
                Operators[sexp_idx].min, Operators[sexp_idx].max);
}
    ...
    for (x = 0; x < Num_op_menus; x++) {
        ...
        for (y = 0; y < Num_submenus; y++) {
            if (((op_submenu[y].id & OP_CATEGORY_MASK) == op_menu[x].id)) {
                fprintf(fp, "<dd><a href=\"#%d\">%s</a></dd>", op_submenu[y].id & (OP_CATEGORY_MASK |
                                                                                   SUBCATEGORY_MASK),
                        op_submenu[y].name);
            }
        }
