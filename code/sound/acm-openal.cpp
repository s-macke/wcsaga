...
static void do_adpcm_nibble(ubyte nib, ADPCMBLOCKHEADER *header, short lPredSamp)
{
...
int ACM_stream_open(WAVEFORMATEX *pwfxSrc, WAVEFORMATEX *pwfxDest, void **stream, ushort dest_bps)
{
    Assert( pwfxSrc != NULL );
    Assert( pwfxSrc->wFormatTag == WAVE_FORMAT_ADPCM );
    Assert( stream != NULL );
