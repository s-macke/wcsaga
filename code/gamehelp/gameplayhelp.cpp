...
void gameplay_help_draw_text() {
    ...
    switch (Current_help_page) {
        ...
        case GP_HELP_BASIC_KEYS:
            ...
            y_offset += separation;
            gameplay_help_blit_control_line(x_offset, y_offset, AUTO_PILOT_TOGGLE);

            y_offset += separation;
            gameplay_help_blit_control_line(x_offset, y_offset, NAV_CYCLE);
            ...
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("F1", 135),
                                                XSTR("context-sensitive help", 136));

            y_offset += separation;
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("F2", 137),
            ...
            y_offset += separation;
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("Shift-Esc", 145),
                                                XSTR("quit Wing Commander Saga immediately", 146));
        ...
        case GP_HELP_ADVANCED_TARGET_KEYS:
            ...
            y_offset += separation;
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("F5...F12", 143),
                                                XSTR("Select target assigned to that hotkey", 150));

            y_offset += separation;
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("Shift-F5...F12", 151),
                                                XSTR("Add/remove target from that hotkey", 152));

            y_offset += separation;
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("Alt-Shift-F5...F12", 153),
        ...
        case GP_HELP_MISC_KEYS:
            ...
            //
            y_offset += separation;
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("ESC", 160), XSTR("invoke abort mission popup",
                                                                                           161));
            ...
            y_offset += separation;
            gameplay_help_blit_control_line_raw(x_offset, y_offset, XSTR("Print Scrn", 164), XSTR("take screen shot",
                                                                                                  165));
        ...
        case GP_HELP_VIEW_KEYS:
            ...
            y_offset += separation;
            gameplay_help_blit_control_line(x_offset, y_offset, VIEW_TRACK_TARGET);
            break;
