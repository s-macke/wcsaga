...
#define MLF_SECONDARY_HIDDEN                (1 << 3)    // Secondary ship doesn't show up in displayed log.
...
typedef struct {
    ...
    char pdisplayname[NAME_LENGTH + 5];                    // display name of primary object of this action
    char sdisplayname[NAME_LENGTH + 5];                    // display name of secondary object of this action
