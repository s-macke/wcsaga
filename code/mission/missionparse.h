...
#define MAX_PARSE_OBJECT_FLAGS_2    21
...
#define P2_SF2_HIDE_LOG_ENTRIES                (1<<17)
#define P2_SF2_NO_ARRIVAL_LOG                (1<<18)
#define P2_SF2_NO_DEPARTURE_LOG                (1<<19)
#define P2_SF2_IS_HARMLESS                    (1<<20)
