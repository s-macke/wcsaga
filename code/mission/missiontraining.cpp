...
void training_obj_display() {
    ...
    hud_aabitmap(Directive_gauge[0].first_frame, Directive_coords[gr_screen.res][DIRECTIVE_COORDS_TOP][0] +
                                                 fl2i(HUD_offset_x),
                 Directive_coords[gr_screen.res][DIRECTIVE_COORDS_TOP][1] + fl2i(HUD_offset_y));
                        ...
                        if (The_mission.game_type & MISSION_TYPE_TRAINING) {
                            r = popup(PF_TITLE_BIG | PF_TITLE_RED, 2, XSTR("&Bind Control", 424),
                                      ...
                                      XSTR(
                                              ...
                                              426),
                                      XSTR(Control_config[Failed_key_index].text,
                                           CONTROL_CONFIG_XSTR + Failed_key_index));
                            ...
                            gameseq_post_event(
                                    GS_EVENT_CONTROL_CONFIG);  // goto control config screen to bind the control
                        }
                    }
