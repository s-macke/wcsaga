            ...
            if (code) {
                ...
                if (Net_players[player_index].p_info.p_objp != NULL) {
                    multi_respawn_player(&Net_players[player_index], Net_players[player_index].s_info.cur_primary_bank,
                                         ...
                                         Net_players[player_index].s_info.cur_link_status,
                                         Net_players[player_index].s_info.ship_ets, 0,
...
void multi_respawn_server() {
    ...
    multi_respawn_player(Net_player, Net_player->s_info.cur_primary_bank, Net_player->s_info.cur_secondary_bank,
                         Net_player->s_info.cur_link_status, Net_player->s_info.ship_ets, 0,
                         Net_player->p_info.p_objp->name);
