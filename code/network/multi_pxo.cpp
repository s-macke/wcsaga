                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_RANKINGS].button
                        },
                        {
                                "Ranking",
                                1314,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_PINFO].button
                        },
                        {
                                "Info",
                                1311,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_FIND].button
                        },
                        {
                                "Motd",
                                1316,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_MOTD].button
                        },
                        {
                                "Join",
                                1505,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_JOIN].button
                        },
                        {
                                "Channel",
                                1317,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_JOIN_PRIV].button
                        },
                        {
                                "Private",
                                1318,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_EXIT].button
                        },
                        {
                                "Help",
                                928,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_HELP].button
                        },
                        {
                                "Games",
                                1319,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[0][MULTI_PXO_GAMES].button
                        },
                        {
                                "Players",
                                1269,
                ...
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_RANKINGS].button
                        },
                        {
                                "Ranking",
                                1314,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_PINFO].button
                        },
                        {
                                "Info",
                                1311,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_FIND].button
                        },
                        {
                                "Motd",
                                1316,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_MOTD].button
                        },
                        {
                                "Join",
                                1505,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_JOIN].button
                        },
                        {
                                "Channel",
                                1317,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_JOIN_PRIV].button
                        },
                        {
                                "Private",
                                1318,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_EXIT].button
                        },
                        {
                                "Help",
                                928,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_HELP].button
                        },
                        {
                                "Games",
                                1319,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_buttons[1][MULTI_PXO_GAMES].button
                        },
                        {
                                "Players",
                                1269,
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_com_buttons[0][MULTI_PXO_COM_CANCEL].button
                        },
                        {
                                "&Ok",
                                669,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_com_buttons[0][MULTI_PXO_COM_OK].button
                        }
                },
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_com_buttons[1][MULTI_PXO_COM_CANCEL].button
                        },
                        {
                                "&Ok",
                                669,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_com_buttons[1][MULTI_PXO_COM_OK].button
                        }
                }
        };
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_pinfo_buttons[0][MULTI_PXO_PINFO_MEDALS].button
                        },
                        {
                                "Ok",
                                345,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_pinfo_buttons[0][MULTI_PXO_PINFO_OK].button
                        },
                },
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pxo_pinfo_buttons[1][MULTI_PXO_PINFO_MEDALS].button
                        },
                        {
                                "Ok",
                                345,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_pinfo_buttons[1][MULTI_PXO_PINFO_OK].button
                        },
                }
        };
                ...
                {    // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_help_buttons[0][MULTI_PXO_HELP_CONTINUE].button
                        },
                },
                {    // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_pxo_help_buttons[1][MULTI_PXO_HELP_CONTINUE].button
                        },
                },
        };
...
void multi_pxo_init(int use_last_channel) {
    ...
    for (idx = 0; idx < MULTI_PXO_NUM_BUTTONS; idx++) {
        ...
        Multi_pxo_buttons[gr_screen.res][idx].button.create(&Multi_pxo_window, "",
                                                            ...
                                                            Multi_pxo_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
    ...
    Multi_pxo_channel_button.create(&Multi_pxo_window, "", Multi_pxo_chan_coords[gr_screen.res][0],
                                    Multi_pxo_chan_coords[gr_screen.res][1], Multi_pxo_chan_coords[gr_screen.res][2],
                                    Multi_pxo_chan_coords[gr_screen.res][3], 0, 1);
    Multi_pxo_channel_button.hide();

    // create the player list select button and hide it
    Multi_pxo_player_button.create(&Multi_pxo_window, "", Multi_pxo_player_coords[gr_screen.res][0],
                                   Multi_pxo_player_coords[gr_screen.res][1], Multi_pxo_player_coords[gr_screen.res][2],
                                   Multi_pxo_player_coords[gr_screen.res][3], 0, 1);
    Multi_pxo_player_button.hide();

    // create the chat input box
    Multi_pxo_chat_input.create(&Multi_pxo_window, Multi_pxo_input_coords[gr_screen.res][0],
                                Multi_pxo_input_coords[gr_screen.res][1], Multi_pxo_input_coords[gr_screen.res][2],
                                MAX_CHAT_LINE_LEN + 1, "",
                                UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR | UI_INPUTBOX_FLAG_KEYTHRU |
                                UI_INPUTBOX_FLAG_EAT_USED);
    Multi_pxo_chat_input.set_focus();

    // create the banner button and hide it
    Multi_pxo_ban_button.create(&Multi_pxo_window, "", Pxo_ban_coords[gr_screen.res][0],
                                Pxo_ban_coords[gr_screen.res][1], Pxo_ban_coords[gr_screen.res][2],
                                Pxo_ban_coords[gr_screen.res][3], 0, 1);
    ...
    Multi_pxo_chat_slider.create(&Multi_pxo_window, Multi_pxo_chat_slider_coords[gr_screen.res][0],
                                 Multi_pxo_chat_slider_coords[gr_screen.res][1],
                                 Multi_pxo_chat_slider_coords[gr_screen.res][2],
                                 Multi_pxo_chat_slider_coords[gr_screen.res][3], 0,
                                 Multi_pxo_chat_slider_name[gr_screen.res],
                                 multi_pxo_scroll_chat_up, multi_pxo_scroll_chat_down, NULL);
...
void multi_pxo_button_pressed(int n) {
    switch (n) {
        ...
        case MULTI_PXO_RANKINGS:
            ...
            if ((Multi_pxo_ranking_last < 0.0f) || ((f2fl(timer_get_fixed_seconds()) -
                                                     Multi_pxo_ranking_last) > MULTI_PXO_RANK_TIME)) {
                gamesnd_play_iface(SND_USER_SELECT);
...
int multi_pxo_connect() {
    ...
    if (popup_till_condition(multi_pxo_connect_do, XSTR("&Cancel", 779), XSTR("Logging into Parallax Online",
                                                                              949)) == 10) {
        int rval;
...
void multi_pxo_blit_status_text() {
    ...
    if (strlen(Multi_pxo_status_text)) {
        ...
        gr_string(Multi_pxo_status_coords[gr_screen.res][0] + ((Multi_pxo_status_coords[gr_screen.res][2] - w) / 2),
                  Multi_pxo_status_coords[gr_screen.res][1], Multi_pxo_status_text);
    }
}
...
void multi_pxo_process_channels() {
    ...
    // last refresh time
    if ((Multi_pxo_channel_last_refresh > 0.0f) && ((f2fl(timer_get_fixed_seconds()) -
                                                     Multi_pxo_channel_last_refresh) > CHANNEL_REFRESH_TIME)) {
        // refresh channels
    ...
    // last refresh time
    if ((Multi_pxo_channel_server_refresh > 0.0f) && ((f2fl(timer_get_fixed_seconds()) -
                                                       Multi_pxo_channel_server_refresh) > CHANNEL_SERVER_REFRESH_TIME
    )) {
...
void multi_pxo_blit_channels() {
    ...
    do {
        ...
        gr_force_fit_string(chan_name, 254, Multi_pxo_chan_coords[gr_screen.res][2] -
                                            Multi_pxo_chan_column_offsets[gr_screen.res][CHAN_PLAYERS_COLUMN]);

        // blit the strings
        gr_string(Multi_pxo_chan_coords[gr_screen.res][0], y_start, chan_name + 1);
        gr_string(Multi_pxo_chan_coords[gr_screen.res][0] + Multi_pxo_chan_coords[gr_screen.res][2] -
                  Multi_pxo_chan_column_offsets[gr_screen.res][CHAN_PLAYERS_COLUMN], y_start, chan_users);
        gr_set_color_fast(&Color_bright);
        gr_string(Multi_pxo_chan_coords[gr_screen.res][0] + Multi_pxo_chan_coords[gr_screen.res][2] -
                  Multi_pxo_chan_column_offsets[gr_screen.res][CHAN_GAMES_COLUMN], y_start, chan_servers);
...
void multi_pxo_chat_add_line(char *txt, int mode) {
    ...
    // set the count
    Multi_pxo_chat_slider.set_numberItems(Multi_pxo_chat_count > Multi_pxo_max_chat_display[gr_screen.res] ?
                                          Multi_pxo_chat_count - Multi_pxo_max_chat_display[gr_screen.res] : 0,
                                          0);        // the 0 means don't reset
...
void multi_pxo_chat_blit() {
    ...
    if (ON_CHANNEL()) {
        if (strlen(Multi_pxo_channel_current.name) > 1) {
            sprintf(title, XSTR("%s on %s", 955), Multi_pxo_nick,
                    Multi_pxo_channel_current.name + 1);  // [[ <who> on <channel> ]]
        } else {
            sprintf(title, XSTR("%s on %s", 955), Multi_pxo_nick,
                    Multi_pxo_channel_current.name);      // [[ <who> on <channel> ]]
        }
    } else {
    ...
    gr_set_color_fast(&Color_normal);
    gr_string(Multi_pxo_chat_coords[gr_screen.res][0] + ((Multi_pxo_chat_coords[gr_screen.res][2] - token_width) / 2),
              Multi_pxo_chat_title_y[gr_screen.res], title);
...
int multi_pxo_is_server_text(char *txt) {
    ...
    if ((strlen(txt) >= strlen(MULTI_PXO_SERVER_PREFIX)) && !strncmp(txt, MULTI_PXO_SERVER_PREFIX,
                                                                     strlen(MULTI_PXO_SERVER_PREFIX))) {
        return 1;
    }
...
int multi_pxo_is_motd_text(char *txt) {
    ...
    if ((strlen(txt) >= strlen(PXO_CHAT_MOTD_PREFIX)) && !strncmp(txt, PXO_CHAT_MOTD_PREFIX,
                                                                  strlen(PXO_CHAT_MOTD_PREFIX))) {
        return 1;
    }
...
int multi_pxo_is_end_of_motd_text(char *txt) {
    // if we're not on a channel, and this is not a channel switching message assume its coming from a server
    if ((strlen(txt) >= strlen(PXO_CHAT_END_OF_MOTD_PREFIX)) && !strncmp(txt, PXO_CHAT_END_OF_MOTD_PREFIX,
                                                                         strlen(PXO_CHAT_END_OF_MOTD_PREFIX))) {
        return 1;
    }
...
int multi_pxo_chat_is_left_message(char *txt) {
    ...
    if ((strlen(txt) > strlen(MULTI_PXO_HAS_LEFT)) && !strcmp(&txt[strlen(txt) - strlen(MULTI_PXO_HAS_LEFT)],
                                                              MULTI_PXO_HAS_LEFT)) {
        return 1;
    }
...
void multi_pxo_com_init(int input_len) {
    ...
    for (idx = 0; idx < MULTI_PXO_COM_NUM_BUTTONS; idx++) {
        // create the object
        Multi_pxo_com_buttons[gr_screen.res][idx].button.create(&Multi_pxo_com_window, "",
                                                                Multi_pxo_com_buttons[gr_screen.res][idx].x,
                                                                Multi_pxo_com_buttons[gr_screen.res][idx].y, 1, 1, 0,
                                                                1);
        ...
        // set the hotspot
        Multi_pxo_com_buttons[gr_screen.res][idx].button.link_hotspot(Multi_pxo_com_buttons[gr_screen.res][idx].
                hotspot);
    }
    ...
    Multi_pxo_com_input.create(&Multi_pxo_com_window, Multi_pxo_com_input_coords[gr_screen.res][0],
                               Multi_pxo_com_input_coords[gr_screen.res][1],
                               Multi_pxo_com_input_coords[gr_screen.res][2], input_len, "",
                               UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR | UI_INPUTBOX_FLAG_KEYTHRU |
                               UI_INPUTBOX_FLAG_EAT_USED);
...
void multi_pxo_com_blit_text() {
    ...
    if (strlen(Multi_pxo_com_top_text) > 0) {
        gr_set_color_fast(&Color_bright);
        gr_string(Multi_pxo_com_top_text_coords[gr_screen.res][0], Multi_pxo_com_top_text_coords[gr_screen.res][1],
                  Multi_pxo_com_top_text);
    }
    if (strlen(Multi_pxo_com_middle_text) > 0) {
        gr_set_color_fast(&Color_bright);
        gr_string(Multi_pxo_com_top_text_coords[gr_screen.res][0], Multi_pxo_com_middle_text_y[gr_screen.res],
                  Multi_pxo_com_middle_text);
    }
    if (strlen(Multi_pxo_com_bottom_text) > 0) {
        gr_set_color_fast(&Color_bright);
        gr_string(Multi_pxo_com_top_text_coords[gr_screen.res][0], Multi_pxo_com_bottom_text_y[gr_screen.res],
                  Multi_pxo_com_bottom_text);
    }
}
...
int multi_pxo_pinfo_get(char *name) {
    ...
    switch (popup_till_condition(multi_pxo_pinfo_cond, XSTR("&Cancel", 779), XSTR("Retrieving player tracker id",
                                                                                  969))) {
        // success
        case 10 :
            return 1;
...
void multi_pxo_pinfo_build_vals() {
    ...
    gr_force_fit_string(Multi_pxo_pinfo_vals[0], 49,
                        Multi_pxo_pinfo_coords[gr_screen.res][2] - (Multi_pxo_pinfo_val_x[gr_screen.res] -
                                                                    Multi_pxo_pinfo_coords[gr_screen.res][0]));

    // rank
    memset(Multi_pxo_pinfo_vals[1], 0, 50);
    multi_sg_rank_build_name(Ranks[fs->stats.rank].name, Multi_pxo_pinfo_vals[1]);
    gr_force_fit_string(Multi_pxo_pinfo_vals[1], 49,
                        Multi_pxo_pinfo_coords[gr_screen.res][2] - (Multi_pxo_pinfo_val_x[gr_screen.res] -
                                                                    Multi_pxo_pinfo_coords[gr_screen.res][0]));
    ...
    if (fs->stats.p_shots_fired > 0) {
        sprintf(Multi_pxo_pinfo_vals[10], "%d%%", (int) ((float) fs->stats.p_shots_hit * 100.0f / (float) fs->stats.
                p_shots_fired));
    } else {
    ...
    if (fs->stats.s_shots_fired > 0) {
        sprintf(Multi_pxo_pinfo_vals[13], "%d%%", (int) ((float) fs->stats.s_shots_hit * 100.0f / (float) fs->stats.
                s_shots_fired));
    } else {
    ...
    if (fs->stats.p_shots_fired > 0) {
        sprintf(Multi_pxo_pinfo_vals[15], "%d%%",
                (int) ((float) 100.0f * ((float) fs->stats.p_bonehead_hits / (float) fs->
                        stats.p_shots_fired)));
    } else {
    ...
    if (fs->stats.s_shots_fired > 0) {
        sprintf(Multi_pxo_pinfo_vals[17], "%d%%",
                (int) ((float) 100.0f * ((float) fs->stats.s_bonehead_hits / (float) fs->
                        stats.s_shots_fired)));
    } else {
...
void multi_pxo_pinfo_init() {
    ...
    for (idx = 0; idx < MULTI_PXO_PINFO_NUM_BUTTONS; idx++) {
        // create the object
        Multi_pxo_pinfo_buttons[gr_screen.res][idx].button.create(&Multi_pxo_pinfo_window, "",
                                                                  Multi_pxo_pinfo_buttons[gr_screen.res][idx].x,
                                                                  Multi_pxo_pinfo_buttons[gr_screen.res][idx].y, 1, 1,
                                                                  0, 1);
        ...
        // set the ani for the button
        Multi_pxo_pinfo_buttons[gr_screen.res][idx].button.set_bmaps(Multi_pxo_pinfo_buttons[gr_screen.res][idx].
                filename);

        // set the hotspot
        Multi_pxo_pinfo_buttons[gr_screen.res][idx].button.link_hotspot(Multi_pxo_pinfo_buttons[gr_screen.res][idx].
                hotspot);
    }
...
void multi_pxo_help_init() {
    ...
    for (idx = 0; idx < MULTI_PXO_HELP_NUM_BUTTONS; idx++) {
        // create the object
        Multi_pxo_help_buttons[gr_screen.res][idx].button.create(&Multi_pxo_help_window, "",
                                                                 Multi_pxo_help_buttons[gr_screen.res][idx].x,
                                                                 Multi_pxo_help_buttons[gr_screen.res][idx].y, 1, 1, 0,
                                                                 1);
        ...
        // set the ani for the button
        Multi_pxo_help_buttons[gr_screen.res][idx].button.set_bmaps(Multi_pxo_help_buttons[gr_screen.res][idx].
                filename);

        // set the hotspot
        Multi_pxo_help_buttons[gr_screen.res][idx].button.link_hotspot(Multi_pxo_help_buttons[gr_screen.res][idx].
                hotspot);
    }
...
void multi_pxo_ban_process() {
    ...
    switch (Multi_pxo_ban_mode) {
        ...
        case PXO_BAN_MODE_LIST_STARTUP:
            // remote file
            sprintf(url_string, /*"%s/%s"*/ "http://www.pxo.net/files/%s", /*Multi_options_g.pxo_banner_url,*/
                    PXO_BANNERS_CONFIG_FILE);

            // local file
            cf_create_default_path_string(local_file, sizeof(local_file) - 1, CF_TYPE_MULTI_CACHE,
                                          PXO_BANNERS_CONFIG_FILE);
...
void multi_pxo_ban_draw() {
    ...
    if (Multi_pxo_banner.ban_bitmap >= 0) {
        ...
        if (Multi_pxo_ban_button.is_mouse_on()) {
            ...
            gr_rect(Pxo_ban_coords[gr_screen.res][0] - 1, Pxo_ban_coords[gr_screen.res][1] - 1,
                    Pxo_ban_coords[gr_screen.res][2] + 2, Pxo_ban_coords[gr_screen.res][3] + 2);
        }
