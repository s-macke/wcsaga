...
void multi_pxo_init(int use_last_channel)
{
	...
	for (idx = 0; idx < MULTI_PXO_NUM_BUTTONS; idx++)
	{
		...
		Multi_pxo_buttons[gr_screen.res][idx].button.create(&Multi_pxo_window, "",
			Multi_pxo_buttons[gr_screen.res][idx].x, Multi_pxo_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
	...
	Multi_pxo_chat_input.create(&Multi_pxo_window, Multi_pxo_input_coords[gr_screen.res][0],
		Multi_pxo_input_coords[gr_screen.res][1], Multi_pxo_input_coords[gr_screen.res][2], MAX_CHAT_LINE_LEN + 1, "",
		UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR | UI_INPUTBOX_FLAG_KEYTHRU | UI_INPUTBOX_FLAG_EAT_USED);
	...
	Multi_pxo_ban_button.create(&Multi_pxo_window, "", Pxo_ban_coords[gr_screen.res][0],
		Pxo_ban_coords[gr_screen.res][1], Pxo_ban_coords[gr_screen.res][2], Pxo_ban_coords[gr_screen.res][3], 0, 1);
	...
	Multi_pxo_chat_slider.create(&Multi_pxo_window, Multi_pxo_chat_slider_coords[gr_screen.res][0],
		Multi_pxo_chat_slider_coords[gr_screen.res][1], Multi_pxo_chat_slider_coords[gr_screen.res][2],
		Multi_pxo_chat_slider_coords[gr_screen.res][3], 0, Multi_pxo_chat_slider_name[gr_screen.res],
...
void multi_pxo_chat_add_line(char* txt, int mode)
{
	...
	Multi_pxo_chat_slider.set_numberItems(Multi_pxo_chat_count > Multi_pxo_max_chat_display[gr_screen.res] ?
		Multi_pxo_chat_count - Multi_pxo_max_chat_display[gr_screen.res] : 0, 0);		// the 0 means don't reset
...
void multi_pxo_com_init(int input_len)
{
	...
	for (idx = 0; idx < MULTI_PXO_COM_NUM_BUTTONS; idx++)
	{
		...
		Multi_pxo_com_buttons[gr_screen.res][idx].button.create(&Multi_pxo_com_window, "",
			Multi_pxo_com_buttons[gr_screen.res][idx].x, Multi_pxo_com_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
	...
	Multi_pxo_com_input.create(&Multi_pxo_com_window, Multi_pxo_com_input_coords[gr_screen.res][0],
		Multi_pxo_com_input_coords[gr_screen.res][1], Multi_pxo_com_input_coords[gr_screen.res][2], input_len, "",
		UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_ESC_CLR | UI_INPUTBOX_FLAG_KEYTHRU | UI_INPUTBOX_FLAG_EAT_USED);
...
void multi_pxo_pinfo_build_vals()
{
	...
	if (fs->stats.p_shots_fired > 0)
	{
		sprintf(Multi_pxo_pinfo_vals[15], "%d%%", (int)((float)100.0f * ((float)fs->stats.p_bonehead_hits / (float)fs->
																		 stats.p_shots_fired)));
	}
	else
	{
	...
	if (fs->stats.s_shots_fired > 0)
	{
		sprintf(Multi_pxo_pinfo_vals[17], "%d%%", (int)((float)100.0f * ((float)fs->stats.s_bonehead_hits / (float)fs->
																		 stats.s_shots_fired)));
	}
	else
	{
...
void multi_pxo_pinfo_init()
{
	...
	for (idx = 0; idx < MULTI_PXO_PINFO_NUM_BUTTONS; idx++)
	{
		...
		Multi_pxo_pinfo_buttons[gr_screen.res][idx].button.create(&Multi_pxo_pinfo_window, "",
			Multi_pxo_pinfo_buttons[gr_screen.res][idx].x, Multi_pxo_pinfo_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
...
void multi_pxo_help_init()
{
	...
	for (idx = 0; idx < MULTI_PXO_HELP_NUM_BUTTONS; idx++)
	{
		...
		Multi_pxo_help_buttons[gr_screen.res][idx].button.create(&Multi_pxo_help_window, "",
			Multi_pxo_help_buttons[gr_screen.res][idx].x, Multi_pxo_help_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
