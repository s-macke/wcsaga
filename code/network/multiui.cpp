...
void multi_common_split_text() {
    ...
    n_lines = split_str(Multi_common_all_text, Multi_common_text_coords[gr_screen.res][2], n_chars, p_str,
                        MULTI_COMMON_TEXT_MAX_LINES, MULTI_COMMON_TEXT_META_CHAR);
    Assert(n_lines != -1);
...
void multi_common_render_text() {
    ...
    for (i = Multi_common_top_text_line; i < Multi_common_num_text_lines; i++) {
        ...
        gr_string(Multi_common_text_coords[gr_screen.res][0],
                  Multi_common_text_coords[gr_screen.res][1] + (line_count * fh), Multi_common_text[i]);
        line_count++;
    }

    if ((Multi_common_num_text_lines - Multi_common_top_text_line) > Multi_common_text_max_display[gr_screen.res]) {
        gr_set_color_fast(&Color_bright_red);
        gr_string(Multi_common_text_coords[gr_screen.res][0], (Multi_common_text_coords[gr_screen.res][1] +
                                                               Multi_common_text_coords[gr_screen.res][3]) - 5,
                  XSTR("more", 755));
    }
}
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[0][MJ_REFRESH].button
                        },
                        {
                                "Join as",
                                1300,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[0][MJ_JOIN_OBSERVER].button
                        },
                        {
                                "Observer",
                                1301,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[0][MJ_START_GAME].button
                        },
                        {
                                "Game",
                                1302,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_join_buttons[0][MJ_CANCEL].button
                        },
                        {
                                "Help",
                                928,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[0][MJ_HELP].button
                        },
                        {
                                "Options",
                                1036,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[0][MJ_OPTIONS].button
                        },
                        {
                                "Join",
                                1303,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_join_buttons[0][MJ_ACCEPT].button
                        },
                        {
                                "Status",
                                1304,
                ...
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[1][MJ_REFRESH].button
                        },
                        {
                                "Join as",
                                1300,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[1][MJ_JOIN_OBSERVER].button
                        },
                        {
                                "Observer",
                                1301,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[1][MJ_START_GAME].button
                        },
                        {
                                "Game",
                                1302,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_join_buttons[1][MJ_CANCEL].button
                        },
                        {
                                "Help",
                                928,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[1][MJ_HELP].button
                        },
                        {
                                "Options",
                                1036,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_join_buttons[1][MJ_OPTIONS].button
                        },
                        {
                                "Join",
                                1303,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_join_buttons[1][MJ_ACCEPT].button
                        },
                        {
                                "Status",
                                1304,
...
void multi_join_notify_new_game() {
    // reset the # of items
    Multi_join_slider.set_numberItems(Active_game_count > Mj_max_game_items[gr_screen.res] ? Active_game_count -
                                                                                             Mj_max_game_items[gr_screen.res]
                                                                                           : 0);
...
void multi_join_game_init() {
    ...
    for (idx = 0; idx < MULTI_JOIN_NUM_BUTTONS; idx++) {
        // create the object
        Multi_join_buttons[gr_screen.res][idx].button.create(&Multi_join_window, "",
                                                             Multi_join_buttons[gr_screen.res][idx].x,
                                                             Multi_join_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
    ...
    Multi_join_select_button.create(&Multi_join_window, "", Mj_list_area_coords[gr_screen.res][MJ_X_COORD],
                                    Mj_list_area_coords[gr_screen.res][MJ_Y_COORD],
                                    Mj_list_area_coords[gr_screen.res][MJ_W_COORD],
                                    Mj_list_area_coords[gr_screen.res][MJ_H_COORD], 0, 1);
    Multi_join_select_button.hide();

    // slider
    Multi_join_slider.create(&Multi_join_window, Mj_slider_coords[gr_screen.res][MJ_X_COORD],
                             Mj_slider_coords[gr_screen.res][MJ_Y_COORD], Mj_slider_coords[gr_screen.res][MJ_W_COORD],
                             Mj_slider_coords[gr_screen.res][MJ_H_COORD], 0,
                             Mj_slider_name[gr_screen.res], &multi_join_list_scroll_up, &multi_join_list_scroll_down,
                             NULL);
...
void multi_join_display_games() {
    ...
    if (moveup != NULL) {
        do {
            ...
            gr_string(Mj_players_coords[gr_screen.res][MJ_X_COORD] + (Mj_players_coords[gr_screen.res][MJ_W_COORD] -
                                                                      w) / 2, y_start, str);
...
void multi_join_blit_game_status(active_game *game, int y) {
    ...
    gr_string(Mj_status_coords[gr_screen.res][MJ_X_COORD] + ((Mj_status_coords[gr_screen.res][MJ_W_COORD] - str_w) /
                                                             2), y, status_text);
}
...
void multi_join_do_netstuff() {
    ...
    if (Net_player->flags & (NETINFO_FLAG_ACCEPT_INGAME | NETINFO_FLAG_ACCEPT_CLIENT | NETINFO_FLAG_ACCEPT_HOST |
                             NETINFO_FLAG_ACCEPT_OBSERVER)) {
...
void multi_join_list_page_down() {
    ...
    while ((count < Mj_max_game_items[gr_screen.res]) && ((Active_game_count - Multi_join_list_start) >
                                                          Mj_max_game_items[gr_screen.res])) {
        Multi_join_list_start_item = Multi_join_list_start_item->next;
        MJ_LIST_START_INC();
...
void multi_join_send_join_request(int as_observer) {
    ...
    if ((Multi_join_selected_item->flags & AG_FLAG_TEAMS) && (Multi_join_selected_item->flags & (AG_FLAG_PAUSE |
                                                                                                 AG_FLAG_IN_MISSION))) {
...
int multi_join_warn_pxo() {
    return popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON | PF_TITLE_BIG | PF_TITLE_RED, 2, XSTR("&Back", 995),
                 XSTR("&Continue", 780),
                 XSTR(
...
UI_XSTR Multi_sg_text[GR_NUM_RESOLUTIONS][MULTI_SG_NUM_TEXT] =
        {
                { // GR_640
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[0][MSG_RANK_SET_GAME].button
                        },
                        {
                                "Above",
                                1327,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[0][MSG_RANK_ABOVE].button
                        },
                        {
                                "Below",
                                1328,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[0][MSG_RANK_BELOW].button
                        },
                        {
                                "Help",
                                928,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[0][MSG_HELP].button
                        },
                        {
                                "Options",
                                1036,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[0][MSG_OPTIONS].button
                        },
                        {
                                "Accept",
                                1035,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sg_buttons[0][MSG_ACCEPT].button
                        },
                        {
                                "Start Game",
                                1329,
                ...
                { // GR_1024
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[1][MSG_RANK_SET_GAME].button
                        },
                        {
                                "Above",
                                1327,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[1][MSG_RANK_ABOVE].button
                        },
                        {
                                "Below",
                                1328,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[1][MSG_RANK_BELOW].button
                        },
                        {
                                "Help",
                                928,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[1][MSG_HELP].button
                        },
                        {
                                "Options",
                                1036,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_sg_buttons[1][MSG_OPTIONS].button
                        },
                        {
                                "Accept",
                                1035,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sg_buttons[1][MSG_ACCEPT].button
                        },
                        {
                                "Start Game",
                                1329,
...
void multi_start_game_init() {
    ...
    for (idx = 0; idx < MULTI_SG_NUM_BUTTONS; idx++) {
        // create the object
        Multi_sg_buttons[gr_screen.res][idx].button.create(&Multi_sg_window, "",
                                                           Multi_sg_buttons[gr_screen.res][idx].x,
                                                           Multi_sg_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
    ...
    Multi_sg_rank_button.create(&Multi_sg_window, "", Msg_rank_list_coords[gr_screen.res][MSG_X_COORD],
                                Msg_rank_list_coords[gr_screen.res][MSG_Y_COORD],
                                Msg_rank_list_coords[gr_screen.res][MSG_W_COORD],
                                Msg_rank_list_coords[gr_screen.res][MSG_H_COORD], 0, 1);
    Multi_sg_rank_button.hide();

    // create the netgame name input box
    Multi_sg_game_name.create(&Multi_sg_window, Msg_title_coords[gr_screen.res][MSG_X_COORD],
                              Msg_title_coords[gr_screen.res][MSG_Y_COORD],
                              Msg_title_coords[gr_screen.res][MSG_W_COORD], MAX_GAMENAME_LEN,
                              "", UI_INPUTBOX_FLAG_ESC_CLR | UI_INPUTBOX_FLAG_INVIS, -1, &Color_normal);

    // create the netgame password input box, and disable it by default
    Multi_sg_game_passwd.create(&Multi_sg_window, Msg_passwd_coords[gr_screen.res][MSG_X_COORD],
                                Msg_passwd_coords[gr_screen.res][MSG_Y_COORD],
                                Msg_passwd_coords[gr_screen.res][MSG_W_COORD], 16, "",
                                UI_INPUTBOX_FLAG_ESC_CLR | UI_INPUTBOX_FLAG_PASSWD | UI_INPUTBOX_FLAG_INVIS, -1,
                                &Color_normal);
...
void multi_sg_init_gamenet() {
    ...
    if (Net_player->state != NETPLAYER_STATE_STD_HOST_SETUP) {
        ...
        ml_printf(NOX("Starting netgame as Host on Standalone server : %s"), (server_addr == NULL) ? NOX("Unknown") :
                                                                             server_addr);
    }
...
void multi_sg_rank_display_stuff() {
    ...
    gr_string(Msg_rank_sel_coords[gr_screen.res][MSG_X_COORD], Msg_rank_sel_coords[gr_screen.res][MSG_Y_COORD],
              rank_name);
        ...
        if (item + Multi_sg_rank_start < NUM_RANKS) {
            ...
            if (multi_sg_rank_select_valid(item + Multi_sg_rank_start)) {
                ...
                sprintf(string, XSTR("Illegal value for a host of your rank (%s)\n", 784),
                        Ranks[Net_player->m_player->stats.rank].name);
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_SHOW_ALL].button
                        },
                        {
                                "Coop",
                                1257,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_SHOW_COOP].button
                        },
                        {
                                "Team",
                                1258,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_SHOW_TEAM].button
                        },
                        {
                                "Dogfight",
                                1259,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_SHOW_DOGFIGHT].button
                        },
                        {
                                "Refresh Missions",
                                1260,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_PXO_REFRESH].button
                        },
                        {
                                "Pilot Info",
                                1261,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_PILOT_INFO].button
                        },
                        {
                                "Missions",
                                1262,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_MISSION_FILTER].button
                        },
                        {
                                "Campaigns",
                                1263,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_CAMPAIGN_FILTER].button
                        },
                        {
                                "Cancel",
                                387,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[0][MC_CANCEL].button
                        },
                        {
                                "1",
                                1264,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_TEAM0].button
                        },
                        {
                                "2",
                                1265,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_TEAM1].button
                        },
                        {
                                "Kick",
                                1266,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[0][MC_KICK].button
                        },
                        {
                                "Close",
                                1508,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[0][MC_CLOSE].button
                        },
                        {
                                "Host Options",
                                1267,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[0][MC_HOST_OPTIONS].button
                        },
                        {
                                "Commit",
                                1062,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[0][MC_ACCEPT].button
                        }
                },
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_SHOW_ALL].button
                        },
                        {
                                "Coop",
                                1257,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_SHOW_COOP].button
                        },
                        {
                                "Team",
                                1258,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_SHOW_TEAM].button
                        },
                        {
                                "Dogfight",
                                1259,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_SHOW_DOGFIGHT].button
                        },
                        {
                                "Refresh Missions",
                                1260,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_PXO_REFRESH].button
                        },
                        {
                                "Pilot Info",
                                1261,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_PILOT_INFO].button
                        },
                        {
                                "Missions",
                                1262,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_MISSION_FILTER].button
                        },
                        {
                                "Campaigns",
                                1263,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_CAMPAIGN_FILTER].button
                        },
                        {
                                "Cancel",
                                387,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[1][MC_CANCEL].button
                        },
                        {
                                "1",
                                1264,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_TEAM0].button
                        },
                        {
                                "2",
                                1265,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_TEAM1].button
                        },
                        {
                                "Kick",
                                1266,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[1][MC_KICK].button
                        },
                        {
                                "Close",
                                1508,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[1][MC_CLOSE].button
                        },
                        {
                                "Host Options",
                                1267,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_create_buttons[1][MC_HOST_OPTIONS].button
                        },
                        {
                                "Commit",
                                1062,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_create_buttons[1][MC_ACCEPT].button
                        }
                },
        };
...
void multi_create_setup_list_data(int mode) {
    ...
    // reset the slider
    Multi_create_slider.set_numberItems(Multi_create_list_count > Multi_create_list_max_display[gr_screen.res] ?
                                        Multi_create_list_count - Multi_create_list_max_display[gr_screen.res] : 0);
}
...
void multi_create_game_init() {
    ...
    for (idx = 0; idx < MULTI_CREATE_NUM_BUTTONS; idx++) {
        ...
        // create the object
        b->button.create(&Multi_create_window, "", b->x, b->y, 1,
                         1, ((idx == MC_SCROLL_LIST_UP) || (idx == MC_SCROLL_LIST_DOWN)), 1);
    ...
    Multi_create_sw_checkbox.create(&Multi_create_window, "", Multi_create_sw_checkbox_coords[gr_screen.res][0],
                                    Multi_create_sw_checkbox_coords[gr_screen.res][1], 0);
    ...
    Multi_create_slider.create(&Multi_create_window, Mc_slider_coords[gr_screen.res][MC_X_COORD],
                               Mc_slider_coords[gr_screen.res][MC_Y_COORD], Mc_slider_coords[gr_screen.res][MC_W_COORD],
                               Mc_slider_coords[gr_screen.res][MC_H_COORD], -1,
                               Mc_slider_bitmap[gr_screen.res], &multi_create_list_scroll_up,
                               &multi_create_list_scroll_down, NULL);

    // create the player list select button
    Multi_create_player_select_button.create(&Multi_create_window, "", Mc_players_coords[gr_screen.res][MC_X_COORD],
                                             Mc_players_coords[gr_screen.res][MC_Y_COORD],
                                             Mc_players_coords[gr_screen.res][MC_W_COORD],
                                             Mc_players_coords[gr_screen.res][MC_H_COORD], 0, 1);
    Multi_create_player_select_button.hide();

    // create the mission/campaign list select button
    Multi_create_list_select_button.create(&Multi_create_window, "", Mc_list_coords[gr_screen.res][MC_X_COORD],
                                           Mc_list_coords[gr_screen.res][MC_Y_COORD],
                                           Mc_list_coords[gr_screen.res][MC_W_COORD],
                                           Mc_list_coords[gr_screen.res][MC_H_COORD], 0, 1);
...
void multi_create_game_do() {
    ...
    if ((Cmdline_almission) && (Net_player->flags & NETINFO_FLAG_AM_MASTER)) {    //
        ...
        if (flags) { //only continue if mission is multiplayer mission
            ...
            std::fill(almissionname, almissionname + 256, 0);
            ...
            strncpy(Game_current_mission_filename, almissionname,
                    MAX_FILENAME_LEN); // copying almissionname to Game_current_mission_filename
            strncpy(Netgame.mission_name, almissionname,
                    MAX_FILENAME_LEN);// copying almission name to netgame.mission_name
            ...
            popup(PF_BODY_BIG | PF_USE_AFFIRMATIVE_ICON, 1, POPUP_OK,
                  XSTR(" Not a multi player-mission", 9999)); //DTP startgame popup pilot error
            gamesnd_play_iface(SND_GENERAL_FAIL);
    ...
    gr_string(Mc_create_game_text[gr_screen.res][MC_X_COORD], Mc_create_game_text[gr_screen.res][MC_Y_COORD],
              XSTR("Create Game", 1268));

    // draw players text
    gr_string(Mc_players_text[gr_screen.res][MC_X_COORD], Mc_players_text[gr_screen.res][MC_Y_COORD], XSTR("Players",
                                                                                                           1269));
    ...
    if (MULTI_IS_TRACKER_GAME) {
        ...
        gr_string(Multi_create_sw_checkbox_text[gr_screen.res][0], Multi_create_sw_checkbox_text[gr_screen.res][1],
                  "SquadWar");
    }
...
void multi_create_list_load_missions() {
    ...
    Multi_create_slider.set_numberItems(int(Multi_create_mission_list.size()) > Multi_create_list_max_display[
            gr_screen.res] ? int(Multi_create_mission_list.size()) - Multi_create_list_max_display[gr_screen.res] : 0);
...
void multi_create_list_do() {
    ...
    stop_index = (Multi_create_list_mode == MULTI_CREATE_SHOW_MISSIONS) ? Multi_create_mission_list.size() :
                 Multi_create_campaign_list.size();
...
void multi_create_list_select_item(int n) {
    ...
    if (n != Multi_create_list_select) {
        ...
        if ((ng->type_flags & NG_TYPE_TEAM) && (ng->type_flags != old_type) && (Net_player->flags &
                                                                                NETINFO_FLAG_AM_MASTER)) {
            multi_team_reset();
        }
...
void multi_create_list_blit_icons(int list_index, int y_start) {
    ...
    max_index = (Multi_create_list_mode == MULTI_CREATE_SHOW_MISSIONS) ? Multi_create_mission_list.size() -
                                                                         1 : Multi_create_campaign_list.size() - 1;
    ...
    if (mcip->flags & MISSION_TYPE_MULTI_COOP) {
        if (Multi_common_icons[MICON_COOP] >= 0) {
            gr_set_bitmap(Multi_common_icons[MICON_COOP]);
            gr_bitmap(Mc_icon_type_coords[gr_screen.res][MC_X_COORD],
                      y_start + Mc_icon_type_coords[gr_screen.res][MC_Y_COORD]);
        }
    ...
    if (MULTI_IS_TRACKER_GAME && (mcip->valid_status == MVALID_STATUS_VALID)) {
        if (Multi_common_icons[MICON_VALID] >= 0) {
            ...
            gr_bitmap(Mc_icon_valid_coords[gr_screen.res][MC_X_COORD],
                      y_start + Mc_icon_valid_coords[gr_screen.res][MC_Y_COORD]);
        }
    }
    ...
    if ((fb != NULL) && (fb->flags & FSB_FROM_VOLITION)) {
        if (Multi_common_icons[MICON_VOLITION] >= 0) {
            ...
            gr_bitmap(Mc_icon_volition_coords[gr_screen.res][MC_X_COORD],
                      y_start + Mc_icon_volition_coords[gr_screen.res][MC_Y_COORD]);
        }
    }
}
...
void multi_create_accept_hit() {
    ...
    if (!multi_netplayer_state_check(NETPLAYER_STATE_JOINED, 1)) {
        popup(PF_BODY_BIG | PF_USE_AFFIRMATIVE_ICON, 1, POPUP_OK,
              XSTR("Please wait until all clients have finished joining", 788));
        gamesnd_play_iface(SND_GENERAL_FAIL);
        return;
    } else {
        gamesnd_play_iface(SND_COMMIT_PRESSED);
    ...
    switch (Multi_create_list_mode) {
        case MULTI_CREATE_SHOW_MISSIONS:
            if (Multi_create_list_select != -1) {
                ...
                // NETLOG
                ml_printf(NOX("Starting single mission %s, with %d players"), Game_current_mission_filename,
                          multi_num_players());
            } else {
...
int multi_create_ok_to_commit() {
    ...
    if (notify_of_hacked_ships_tbl) {
        if (popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON, 2, XSTR("&Back", 995), XSTR("&Continue", 780),
                  XSTR("You or the server you are playing on has a hacked ships.tbl. Your stats will not be updated on PXO",
                       1051)) <= 0) {
            return 0;
        }
    }
    ...
    if (notify_of_hacked_weapons_tbl) {
        if (popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON, 2, XSTR("&Back", 995), XSTR("&Continue", 780),
                  XSTR("You or the server you are playing on has a hacked weapons.tbl. Your stats will not be updated on PXO",
                       1052)) <= 0) {
            return 0;
        }
    }
    ...
    for (idx = 0; idx < MAX_PLAYERS; idx++) {
        ...
        if (MULTI_CONNECTED(Net_players[idx]) && (Net_players[idx].flags & NETINFO_FLAG_HAXOR)) {
            ...
            if (Net_players[idx].m_player != NULL) {
                sprintf(err_string, "%s %s", Net_players[idx].m_player->callsign, XSTR("has hacked tables/data",
                                                                                       1271));
            } else {
    ...
    if (found_hack) {
        ...
        if (MULTI_IS_TRACKER_GAME) {
            ...
            if (Netgame.type_flags & NG_TYPE_SW) {
                ...
                // if this is squad war, don't allow it to continue
                if (popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON, 2, XSTR("&Back", 995), XSTR("&Continue",
                                                                                                      780),
                          XSTR(
            ...
            if (popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON, 2, XSTR("&Back", 995), XSTR("&Continue", 780),
                      XSTR("One or more players has hacked data files", 1274)) <= 0) {
                return 0;
            }
        }
    }
    ...
    if (observer_count > Netgame.options.max_observers) {
        ...
        sprintf(err_string,
                XSTR("There are too many observers in the game\n\nMax : %d\nCurrently %d\n\nPlease dump a few", 791),
                Netgame.options.max_observers, observer_count);
    ...
    if (player_count > Netgame.max_players) {
        // print up the error string
        sprintf(err_string,
                XSTR("There are too many players in the game\n\nMax : %d\nCurrently %d\n\nPlease dump a few", 792),
                Netgame.max_players, player_count);
    ...
    if (Netgame.type_flags & NG_TYPE_TEAM) {
        if (!multi_team_ok_to_commit()) {
            gamesnd_play_iface(SND_GENERAL_FAIL);
            popup(PF_BODY_BIG | PF_USE_AFFIRMATIVE_ICON, 1, POPUP_OK,
                  XSTR("Teams and/or team captains are not assigned properly", 793));
            return 0;
        }
    }
    ...
    if (MULTI_IS_TRACKER_GAME) {
        ...
        if ((Multi_create_list_mode == MULTI_CREATE_SHOW_MISSIONS) && (Multi_create_mission_list[abs_index].
        ...
        if (!(Netgame.type_flags & NG_TYPE_SW)) {
            ...
            if (multi_num_players() == 1) {
                if (popup(PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON | PF_TITLE_RED | PF_TITLE_BIG, 2,
                          XSTR("&Back", 995), XSTR("&Continue", 780),
...
int multi_create_verify_cds() {
    ...
    multi_cd_count = 0;
    for (idx = 0; idx < MAX_PLAYERS; idx++) {
        if (MULTI_CONNECTED(Net_players[idx]) && !MULTI_STANDALONE(Net_players[idx]) && (Net_players[idx].flags &
                                                                                         NETINFO_FLAG_HAS_CD)) {
            multi_cd_count++;
        }
    }
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_MSG_RANK].button
                        },
                        {
                                "Team / wing-leader",
                                1281,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_MSG_LEADER].button
                        },
                        {
                                "Any",
                                1282,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_MSG_ANY].button
                        },
                        {
                                "Host",
                                1283,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_MSG_HOST].button
                        },
                        {
                                "Highest rank",
                                1280,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_END_RANK].button
                        },
                        {
                                "Team / wing-leader",
                                1281,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_END_LEADER].button
                        },
                        {
                                "Any",
                                1282,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_END_ANY].button
                        },
                        {
                                "Host",
                                1283,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_END_HOST].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_VOICE_ON].button
                        },
                        {
                                "Off",
                                1286,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_VOICE_OFF].button
                        },
                        {
                                "Host modifies ships",
                                1287,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_HOST_MODIFIES].button
                        },
                        {
                                "Exit",
                                1417,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_ho_buttons[0][MULTI_HO_ACCEPT].button
                        },
                },
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_MSG_RANK].button
                        },
                        {
                                "Team / wing-leader",
                                1281,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_MSG_LEADER].button
                        },
                        {
                                "Any",
                                1282,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_MSG_ANY].button
                        },
                        {
                                "Host",
                                1283,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_MSG_HOST].button
                        },
                        {
                                "Highest rank",
                                1280,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_END_RANK].button
                        },
                        {
                                "Team / wing-leader",
                                1281,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_END_LEADER].button
                        },
                        {
                                "Any",
                                1282,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_END_ANY].button
                        },
                        {
                                "Host",
                                1283,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_END_HOST].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_VOICE_ON].button
                        },
                        {
                                "Off",
                                1286,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_VOICE_OFF].button
                        },
                        {
                                "Host modifies ships",
                                1287,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_HOST_MODIFIES].button
                        },
                        {
                                "Exit",
                                1417,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_ho_buttons[1][MULTI_HO_ACCEPT].button
                        },
                }
        };
...
int Multi_ho_radio_info[MULTI_HO_NUM_RADIO_BUTTONS][3] =
        {    // info related to each of the radio buttons themselves
                // { group #, value, button id# }
                {
                        0,
                        0,
                        0
                },                // highest ranking players can do messaging
                {
                        0,
                        1,
                        1
                },                // wing/team leaders can do messaging
                {
                        0,
                        2,
                        2
                },                // any player can do messaging
                {
                        0,
                        3,
                        3
                },                // only host can do messaging
                {
                        1,
                        0,
                        4
                },                // highest rank and host can end the mission
                {
                        1,
                        1,
                        5
                },                // team/wing leader can end the mission
                {
                        1,
                        2,
                        6
                },                // any player can end the mission
                {
                        1,
                        3,
                        7
...
void multi_host_options_init() {
    ...
    for (idx = 0; idx < MULTI_HO_NUM_BUTTONS; idx++) {
        // create the object
        Multi_ho_buttons[gr_screen.res][idx].button.create(&Multi_ho_window, "",
                                                           Multi_ho_buttons[gr_screen.res][idx].x,
                                                           Multi_ho_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
    ...
    for (idx = 0; idx < MULTI_HO_NUM_SLIDERS; idx++) {
        // create the object
        Multi_ho_sliders[gr_screen.res][idx].slider.create(&Multi_ho_window, Multi_ho_sliders[gr_screen.res][idx].x,
                                                           Multi_ho_sliders[gr_screen.res][idx].y,
                                                           Multi_ho_sliders[gr_screen.res][idx].dots,
                                                           Multi_ho_sliders[gr_screen.res][idx].filename,
                                                           Multi_ho_sliders[gr_screen.res][idx].hotspot,
                                                           NULL, -1, -1, -1, NULL, -1, -1, -1,
                                                           Multi_ho_sliders[gr_screen.res][idx].dot_w);
    }

    // create the respawn count input box
    Multi_ho_respawns.create(&Multi_ho_window, Ho_rsp_coords[gr_screen.res][MULTI_HO_X_COORD],
                             Ho_rsp_coords[gr_screen.res][MULTI_HO_Y_COORD],
                             Ho_rsp_coords[gr_screen.res][MULTI_HO_W_COORD], 6, "",
                             UI_INPUTBOX_FLAG_ESC_FOC | UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_NO_LETTERS, -1,
                             &Color_bright);
    ...
    Multi_ho_time_limit.create(&Multi_ho_window, Ho_time_coords[gr_screen.res][MULTI_HO_X_COORD],
                               Ho_time_coords[gr_screen.res][MULTI_HO_Y_COORD],
                               Ho_time_coords[gr_screen.res][MULTI_HO_W_COORD], 3, "",
                               UI_INPUTBOX_FLAG_ESC_FOC | UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_NO_LETTERS, -1,
                               &Color_bright);
    Multi_ho_time_limit.set_valid_chars("-0123456789");

    // create the voice token wait input box
    Multi_ho_voice_wait.create(&Multi_ho_window, Ho_vw_coords[gr_screen.res][MULTI_HO_X_COORD],
                               Ho_vw_coords[gr_screen.res][MULTI_HO_Y_COORD],
                               Ho_vw_coords[gr_screen.res][MULTI_HO_W_COORD], 1, "",
                               UI_INPUTBOX_FLAG_ESC_FOC | UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_NO_LETTERS, -1,
                               &Color_bright);
    Multi_ho_voice_wait.set_valid_chars("01243456789");

    // create the furball kill limit input box
    Multi_ho_kill_limit.create(&Multi_ho_window, Ho_kill_coords[gr_screen.res][MULTI_HO_X_COORD],
                               Ho_kill_coords[gr_screen.res][MULTI_HO_Y_COORD],
                               Ho_kill_coords[gr_screen.res][MULTI_HO_W_COORD], 4, "",
                               UI_INPUTBOX_FLAG_ESC_FOC | UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_NO_LETTERS, -1,
                               &Color_bright);
    Multi_ho_kill_limit.set_valid_chars("0123456789");

    // create the observer limit input box
    Multi_ho_obs.create(&Multi_ho_window, Ho_obs_coords[gr_screen.res][MULTI_HO_X_COORD],
                        Ho_obs_coords[gr_screen.res][MULTI_HO_Y_COORD], Ho_obs_coords[gr_screen.res][MULTI_HO_W_COORD],
                        1, "",
                        UI_INPUTBOX_FLAG_ESC_FOC | UI_INPUTBOX_FLAG_INVIS | UI_INPUTBOX_FLAG_NO_LETTERS, -1,
                        &Color_bright);
...
void multi_ho_update_sliders() {
    ...
    if (Netgame.options.voice_record_time != (int) (0.5f * (float) (Multi_ho_sliders[gr_screen.
            res][MULTI_HO_SLIDER_VOICE_DUR].slider.pos + 1) *
                                                    1000.0f)) {
...
void multi_ho_get_options() {
    ...
    Multi_ho_sliders[gr_screen.res][MULTI_HO_SLIDER_VOICE_DUR].slider.pos = ((int) ((float) Netgame.options.
            voice_record_time / 500.0f)) - 1;
...
void multi_ho_display_record_time() {
    ...
    half_seconds = ((((Multi_ho_sliders[gr_screen.res][MULTI_HO_SLIDER_VOICE_DUR].slider.pos + 1) * 500) % 1000) /
                    500) * 5;
...
int multi_ho_check_values() {
    ...
    if (Multi_ho_mission_respawn != -1) {
        ...
        if (atoi(val_txt) > Multi_ho_mission_respawn) {
            memset(val_txt, 0, 255);
            sprintf(val_txt, XSTR("Warning\nRespawn count in greater than mission specified max (%d)", 796),
                    Multi_ho_mission_respawn);
    ...
    if (atoi(val_txt) > MULTI_HO_MAX_TIME_LIMIT) {
        memset(val_txt, 0, 255);
        sprintf(val_txt, XSTR("Warning\nMission time limit is greater than max allowed (%d)", 797),
                MULTI_HO_MAX_TIME_LIMIT);
        popup(PF_USE_AFFIRMATIVE_ICON | PF_TITLE_RED | PF_TITLE_BIG, 1, POPUP_OK, val_txt);
        return 0;
    }
    ...
    if (atoi(val_txt) > MULTI_HO_MAX_KILL_LIMIT) {
        memset(val_txt, 0, 255);
        sprintf(val_txt, XSTR("Warning\nMission kill limit is greater than max allowed (%d)", 799),
    ...
    if (atoi(val_txt) > MULTI_HO_MAX_TOKEN_WAIT) {
        memset(val_txt, 0, 255);
        sprintf(val_txt, XSTR("Warning\nvoice wait time is greater than max allowed (%d)", 800),
                MULTI_HO_MAX_TOKEN_WAIT);
        popup(PF_USE_AFFIRMATIVE_ICON | PF_TITLE_RED | PF_TITLE_BIG, 1, POPUP_OK, val_txt);
        return 0;
    }
...
void multi_ho_check_focus() {
    ...
    if (Multi_ho_respawns.pressed() || Multi_ho_time_limit.pressed() || Multi_ho_voice_wait.pressed() ||
        Multi_ho_kill_limit.pressed() || Multi_ho_obs.pressed()) {
        ...
        if (Multi_ho_respawns.has_focus() || Multi_ho_time_limit.has_focus() || Multi_ho_kill_limit.has_focus() ||
            Multi_ho_voice_wait.has_focus()) {
            chatbox_lose_focus();
        ...
        if (!Multi_ho_respawns.has_focus() && !Multi_ho_time_limit.has_focus() && !Multi_ho_kill_limit.has_focus() &&
            !Multi_ho_voice_wait.has_focus() && !chatbox_has_focus()) {
            chatbox_set_focus();
        }
...
void multi_ho_blit_max_respawns() {
    ...
    gr_set_color_fast(&Color_normal);
    gr_string(Ho_max_rsp_coords[gr_screen.res][MULTI_HO_X_COORD], Ho_max_rsp_coords[gr_screen.res][MULTI_HO_Y_COORD],
              string);
}
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_jw_buttons[0][MJW_TEAM0].button
                        },
                        {
                                "Team 2",
                                1309,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_jw_buttons[0][MJW_TEAM1].button
                        },
                        {
                                "Pilot",
                                1310,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_jw_buttons[0][MJW_PILOT_INFO].button
                        },
                        {
                                "Info",
                                1311,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_jw_buttons[0][MJW_CANCEL].button
                        },
                        {
                                "Players",
                                1269,
                ...
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_jw_buttons[1][MJW_TEAM0].button
                        },
                        {
                                "Team 2",
                                1309,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_jw_buttons[1][MJW_TEAM1].button
                        },
                        {
                                "Pilot",
                                1310,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_jw_buttons[1][MJW_PILOT_INFO].button
                        },
                        {
                                "Info",
                                1311,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_jw_buttons[1][MJW_CANCEL].button
                        },
                        {
                                "Players",
                                1269,
...
void multi_game_client_setup_init() {
    ...
    for (idx = 0; idx < MULTI_JW_NUM_BUTTONS; idx++) {
        // create the object
        Multi_jw_buttons[gr_screen.res][idx].button.create(&Multi_jw_window, "",
                                                           Multi_jw_buttons[gr_screen.res][idx].x,
                                                           Multi_jw_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
    ...
    // if this is a PXO game, enable the squadwar checkbox
    Multi_jw_sw_checkbox.create(&Multi_jw_window, "", Multi_jw_sw_checkbox_coords[gr_screen.res][0],
                                Multi_jw_sw_checkbox_coords[gr_screen.res][1], 0);
    ...
    Multi_jw_plist_select_button.create(&Multi_jw_window, "", Mjw_players_coords[gr_screen.res][MJW_X_COORD],
                                        Mjw_players_coords[gr_screen.res][MJW_Y_COORD],
                                        Mjw_players_coords[gr_screen.res][MJW_W_COORD],
                                        Mjw_players_coords[gr_screen.res][MJW_H_COORD], 0, 1);
...
void multi_game_client_setup_do_frame() {
    ...
    if (MULTI_IS_TRACKER_GAME) {
        ...
        gr_string(Multi_jw_sw_checkbox_text[gr_screen.res][0], Multi_jw_sw_checkbox_text[gr_screen.res][1],
                  "SquadWar");
    }
    ...
    if (Netgame.campaign_mode) {
        if (strlen(Netgame.campaign_name) > 0) {
            ...
            gr_string(Mjw_mission_name_coords[gr_screen.res][MJW_X_COORD],
                      Mjw_mission_name_coords[gr_screen.res][MJW_Y_COORD], mission_text);
        }
    } else {
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sync_buttons[0][MS_KICK].button
                        },
                        {
                                "Cancel",
                                387,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sync_buttons[0][MS_CANCEL].button
                        },
                        {
                                "Launch",
                                801,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sync_buttons[0][MS_LAUNCH].button
                        },
                        {
                                "Players",
                                1269,
                ...
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sync_buttons[1][MS_KICK].button
                        },
                        {
                                "Cancel",
                                387,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sync_buttons[1][MS_CANCEL].button
                        },
                        {
                                "Launch",
                                801,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Multi_sync_buttons[1][MS_LAUNCH].button
                        },
                        {
                                "Players",
                                1269,
...
void multi_sync_display_name(char *name, int index,
                             int np_index);        // display info on the left hand portion of the status window thingie
void multi_sync_display_status(char *status,
                               int index);                    // display info on the right hand portion of the status window thingie
...
void multi_sync_common_init() {
    ...
    for (idx = 0; idx < Multi_sync_button_count; idx++) {
        // create the object
        Multi_sync_buttons[gr_screen.res][idx].button.create(&Multi_sync_window, "",
                                                             Multi_sync_buttons[gr_screen.res][idx].x,
                                                             Multi_sync_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
        ...
        if ((idx == MS_CANCEL) || (idx == MS_KICK) || (idx == MS_LAUNCH)) {
            Multi_sync_buttons[gr_screen.res][idx].button.set_bmaps(Multi_sync_buttons[gr_screen.res][idx].filename, 3,
                                                                    0);
        } else {
    ...
    Multi_sync_plist_button.create(&Multi_sync_window, "", Ms_status_coords[gr_screen.res][MS_X_COORD],
                                   Ms_status_coords[gr_screen.res][MS_Y_COORD],
                                   Ms_status_coords[gr_screen.res][MS_W_COORD],
                                   Ms_status_coords[gr_screen.res][MS_H_COORD], 0, 1);
...
void multi_sync_blit_screen_all() {
    ...
    for (idx = 0; idx < MAX_PLAYERS; idx++) {
        if (MULTI_CONNECTED(Net_players[idx]) && !MULTI_STANDALONE(Net_players[idx])) {
            ...
            if ((Net_player != NULL) && (&Net_players[idx] != Net_player) && ((Multi_sync_mode == MULTI_SYNC_INGAME) ||
                                                                              (Net_player->flags &
                                                                               NETINFO_FLAG_INGAME_JOIN))) {
    ...
    if ((gameseq_get_state() == GS_STATE_MULTI_MISSION_SYNC &&
         Multi_sync_countdown_timer > -1.0f) || (Multi_sync_countdown != -1))
        generic_anim_render(&Multi_sync_countdown_anim, flFrametime,
                            Multi_sync_countdown_coords[gr_screen.res][MS_X_COORD],
                            Multi_sync_countdown_coords[gr_screen.res][MS_Y_COORD]);
...
void multi_sync_pre_do() {
    ...
    if (Net_player->flags & NETINFO_FLAG_AM_MASTER) {
        ...
        if (multi_netplayer_state_check(NETPLAYER_STATE_MISSION_SYNC) &&
            !(Mission_sync_flags & MS_FLAG_SENT_FILESIG) && !multi_endgame_ending()) {
        ...
        if ((Mission_sync_flags & MS_FLAG_SENT_FILESIG) && !multi_netplayer_flag_check(NETINFO_FLAG_MISSION_OK) &&
        ...
        if (multi_netplayer_flag_check(NETINFO_FLAG_MISSION_OK) && !(Mission_sync_flags & MS_FLAG_DATA_DONE) &&
            !multi_endgame_ending()) {
            // do nothing for now
        ...
        if ((Mission_sync_flags & MS_FLAG_DATA_DONE) && !(Mission_sync_flags & MS_FLAG_CAMP_DONE) &&
            !multi_endgame_ending()) {
        ...
        // move along faster
        if ((Mission_sync_flags & MS_FLAG_CAMP_DONE) && !(Mission_sync_flags & MS_FLAG_SENT_LOAD) &&
            !multi_endgame_ending()) {
        ...
        if (multi_netplayer_state_check(NETPLAYER_STATE_MISSION_LOADED) && !(Mission_sync_flags & MS_FLAG_TS_SLOTS) &&
            !multi_endgame_ending()) {
        ...
        if (Sync_test && multi_netplayer_state_check(NETPLAYER_STATE_SLOT_ACK) &&
            !(Mission_sync_flags & MS_FLAG_PUSHED_BRIEFING) && !multi_endgame_ending()) {
        ...
        if ((Net_player->state == NETPLAYER_STATE_MISSION_XFER) && (Net_player->s_info.xfer_handle != -1) &&
            !multi_endgame_ending()) {
    ...
    if (Net_player->flags & NETINFO_FLAG_AM_MASTER) {
        ...
        if (multi_netplayer_state_check(NETPLAYER_STATE_WAITING) && !(Mission_sync_flags & MS_FLAG_POST_DATA)) {
            ...
            if (Net_player->flags & NETINFO_FLAG_GAME_HOST) {
                ...
                for (idx = 0; idx < MAX_PLAYERS; idx++) {
                    if (MULTI_CONNECTED(Net_players[idx]) && !MULTI_STANDALONE(Net_players[idx]) &&
                        !MULTI_PERM_OBSERVER(Net_players[idx]) && (Net_players[idx].m_player->objnum != -1)) {
                        multi_server_update_player_weapons(&Net_players[idx], &Ships[Objects[Net_players[idx].
                                m_player->objnum].instance]);
                    }
                }
            }
...
void multi_sync_display_name(char *name, int index, int np_index) {
    ...
    if (Netgame.type_flags & NG_TYPE_TEAM) {
        gr_force_fit_string(fit, CALLSIGN_LEN, Ms_status2_coords[gr_screen.res][MS_X_COORD] -
                                               Ms_status_coords[gr_screen.res][MS_X_COORD] - 20 -
                                               Ms_cd_icon_offset[gr_screen.res] -
                                               Ms_team_icon_offset[gr_screen.res]);
        ...
        // blit the string
        gr_string(Ms_status_coords[gr_screen.res][0] + Ms_cd_icon_offset[gr_screen.res] +
                  Ms_team_icon_offset[gr_screen.res], Ms_status_coords[gr_screen.res][MS_Y_COORD] + (index * 10), fit);
        ...
        if (Net_players[np_index].p_info.team == 0) {
            ...
            if (Net_players[np_index].flags & NETINFO_FLAG_TEAM_CAPTAIN) {
                if (Multi_common_icons[MICON_TEAM0_SELECT] != -1) {
                    gr_set_bitmap(Multi_common_icons[MICON_TEAM0_SELECT]);
                    gr_bitmap(Ms_status_coords[gr_screen.res][MS_X_COORD] + Ms_cd_icon_offset[gr_screen.res],
                              Ms_status_coords[gr_screen.res][MS_Y_COORD] + (index * 10) - 2);
                }
            }
        ...
        // blit the string
        gr_string(Ms_status_coords[gr_screen.res][MS_X_COORD] + Ms_cd_icon_offset[gr_screen.res],
                  Ms_status_coords[gr_screen.res][MS_Y_COORD] + (index * 10), fit);
    }

    // maybe blit his CD status icon
    if ((Net_players[np_index].flags & NETINFO_FLAG_HAS_CD) && (Multi_common_icons[MICON_CD] != -1)) {
        gr_set_bitmap(Multi_common_icons[MICON_CD]);
        gr_bitmap(Ms_status_coords[gr_screen.res][MS_X_COORD], Ms_status_coords[gr_screen.res][MS_Y_COORD] + (index *
                                                                                                              10));
    }
}
...
void multi_sync_display_status(char *status, int index) {
    ...
    gr_set_color_fast(&Color_bright);
    gr_string(Ms_status2_coords[gr_screen.res][MS_X_COORD], Ms_status2_coords[gr_screen.res][MS_Y_COORD] + (index *
                                                                                                            10), fit);
}
...
void multi_sync_force_start_pre() {
    ...
    for (idx = 0; idx < MAX_PLAYERS; idx++) {
        if (MULTI_CONNECTED(Net_players[idx]) && !MULTI_STANDALONE(Net_players[idx]) &&
            (Net_player != &Net_players[idx]) && (Net_players[idx].state == want_state)) {
            multi_kick_player(idx, 0);
        }
    }
}
...
void multi_sync_create_launch_button() {
    if (!Multi_launch_button_created) {
        // create the object
        Multi_sync_buttons[gr_screen.res][MS_LAUNCH].button.create(&Multi_sync_window, "",
                                                                   Multi_sync_buttons[gr_screen.res][MS_LAUNCH].x,
                                                                   Multi_sync_buttons[gr_screen.res][MS_LAUNCH].y, 1, 1,
                                                                   0,
                                                                   1);
        ...
        // set the ani for the button
        Multi_sync_buttons[gr_screen.res][MS_LAUNCH].button.set_bmaps(Multi_sync_buttons[gr_screen.res][MS_LAUNCH].
                filename, 3, 0);

        // set the hotspot
        Multi_sync_buttons[gr_screen.res][MS_LAUNCH].button.link_hotspot(Multi_sync_buttons[gr_screen.res][MS_LAUNCH].
                hotspot);
...
void multi_sync_handle_plist() {
    ...
    if (Multi_sync_plist_button.pressed()) {
        ...
        // of the loop
        if ((Multi_sync_player_select >= 0) && (!MULTI_CONNECTED(Net_players[Multi_sync_player_select]) ||
                                                MULTI_STANDALONE(Net_players[Multi_sync_player_select]))) {
            Multi_sync_player_select = -1;
        }
    }
}
...
void multi_debrief_do_frame() {
    ...
    if ((Net_player->flags & NETINFO_FLAG_AM_MASTER) && (Netgame.game_state != NETGAME_STATE_DEBRIEF) &&
        multi_netplayer_state_check3(NETPLAYER_STATE_DEBRIEF, NETPLAYER_STATE_DEBRIEF_ACCEPT,
                                     NETPLAYER_STATE_DEBRIEF_REPLAY)) {
...
void multi_debrief_accept_hit() {
    ...
    if (MULTI_IS_TRACKER_GAME) {
        int res = popup(PF_TITLE | PF_BODY_BIG | PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON | PF_IGNORE_ESC, 3,
                        XSTR("&Cancel", 779), XSTR("&Accept", 844), XSTR("&Toss", 845),
                        XSTR("(Continue Netgame)\nDo you wish to accept these stats?", 846));
    ...
    if (Multi_debrief_server_left) {
        ...
        if (Net_player->flags & NETINFO_FLAG_GAME_HOST) {
            ...
            if (MULTI_IS_TRACKER_GAME) {
                ...
                int res = popup(PF_TITLE | PF_BODY_BIG | PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON |
                                PF_IGNORE_ESC, 3, XSTR("&Cancel", 779), XSTR("&Accept", 844), XSTR("&Toss", 845),
                                XSTR("(Continue Netgame)\nDo you wish to accept these stats?", 846));
...
void multi_debrief_esc_hit() {
    ...
    if (MULTI_IS_TRACKER_GAME) {
        res = popup(PF_TITLE | PF_BODY_BIG | PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON | PF_IGNORE_ESC, 3,
                    XSTR("&Cancel", 779), XSTR("&Accept", 844), XSTR("&Toss", 845),
    ...
    if (Net_player->flags & NETINFO_FLAG_GAME_HOST) {
        ...
        if ((Multi_debrief_stats_accept_code == -1) && !(MULTI_IS_TRACKER_GAME)) {
            res = popup(PF_BODY_BIG | PF_USE_AFFIRMATIVE_ICON | PF_USE_NEGATIVE_ICON, 2, XSTR("&Cancel", 779),
                        XSTR("&Leave", 848),
                        XSTR("Are you sure you want to leave the netgame before stats are stored?", 849));
...
void multi_debrief_server_process() {
    ...
    if ((Multi_debrief_time >= Multi_debrief_resend_time) && !multi_netplayer_state_check3(NETPLAYER_STATE_DEBRIEF,
                                                                                           NETPLAYER_STATE_DEBRIEF_ACCEPT,
                                                                                           NETPLAYER_STATE_DEBRIEF_REPLAY,
                                                                                           1)) {
    ...
    if (multi_netplayer_state_check3(NETPLAYER_STATE_DEBRIEF, NETPLAYER_STATE_DEBRIEF_ACCEPT,
                                     NETPLAYER_STATE_DEBRIEF_REPLAY) && (Netgame.type_flags & NG_TYPE_TEAM) &&
        !Multi_debrief_reported_tvt &&
        (Multi_debrief_server_framecount > 4)) {
        multi_team_report();
                ...
                { // GR_640
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pwd_buttons[0][MPWD_CANCEL].button
                        },
                        {
                                "Commit",
                                1062,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pwd_buttons[0][MPWD_COMMIT].button
                        },
                        {
                                "Enter Password",
                                1332,
                ...
                { // GR_1024
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pwd_buttons[1][MPWD_CANCEL].button
                        },
                        {
                                "Commit",
                                1062,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Multi_pwd_buttons[1][MPWD_COMMIT].button
                        },
                        {
                                "Enter Password",
                                1332,
...
void multi_passwd_init() {
    ...
    for (idx = 0; idx < MULTI_PWD_NUM_BUTTONS; idx++) {
        // create the object
        Multi_pwd_buttons[gr_screen.res][idx].button.create(&Multi_pwd_window, "",
                                                            Multi_pwd_buttons[gr_screen.res][idx].x,
                                                            Multi_pwd_buttons[gr_screen.res][idx].y, 1, 1, 0, 1);
    ...
    Multi_pwd_passwd.create(&Multi_pwd_window, Mpwd_coords[gr_screen.res][MPWD_X_COORD],
                            Mpwd_coords[gr_screen.res][MPWD_Y_COORD], Mpwd_coords[gr_screen.res][MPWD_W_COORD],
                            MAX_PASSWD_LEN, "",
                            UI_INPUTBOX_FLAG_ESC_CLR | UI_INPUTBOX_FLAG_INVIS, -1, &Color_normal);
