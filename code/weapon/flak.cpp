...
DCF(flak_err,
"set the radius of error for flak targeting")
{
...
DCF(flak_range,
"set the radius of error for detonation of a flak shell")
{
dc_get_arg(ARG_FLOAT);
if (
Dc_arg_type &ARG_FLOAT
...
DCF(flak_rad,
"set the radius of flak gun muzzle flash")
{
dc_get_arg(ARG_FLOAT);
if (
Dc_arg_type &ARG_FLOAT
