...
def_file Default_files[] =
{
	...
	{
		"objecttypes.tbl",
		Default_shiptypes_table
	},
	{
		"ai_profiles.tbl",
		Default_ai_profiles_table
	},
	{
		"autopilot.tbl",
		Default_autopilot_table
	},
	{
		"fonts.tbl",
		Default_fonts_table
...
$Fog:																	\n\
	...
	+Compl dist:			500.0										\n\
$AI:																	\n\
	+Valid goals:			( \"fly to ship\" \"attack ship\" \"dock\" \"waypoints\" \"waypoints once\" \"depart\" \"undock\" \"attack subsys\" \"attack wing\" \"guard ship\" \"disable ship\" \"disarm ship\" \"attack any\" \"ignore ship\" \"ignore ship (new)\" \"guard wing\" \"evade ship\" \"stay still\" \"play dead\" \"stay near ship\" \"keep safe dist\" )	\n\
	+Accept Player Orders:	YES											\n\
...
$fix AI class bug:	NO													\n\
																		\n\
;; Performs capship vs capship collisions (NON_SMALL_SHIPS)				\n\
;; Deactivate this to save performance if you are sure such collisions  \n\
;; will never happen													\n\
$do capship vs capship collisions:	YES									\n\
																		\n\
#End																	\n\
";
