...
// Goober5000
extern void ship_apply_tag(int ship_num, int tag_level, float tag_time, object *target, vec3d *start, int ssm_index,
                           int ssm_team);
...
void ship_apply_local_damage(object *ship_obj, object *other_obj, vec3d *hitpos, float damage, int quadrant,
                             bool create_spark = true, int submodel_num = -1, vec3d *hit_normal = 0/*NULL*/);
...
// player pain
void ship_hit_pain(float damage, int quadrant = -1);
