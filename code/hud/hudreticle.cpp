...
void hud_render_throttle_background(int y_end) {
    ...
    if (y_end > y) {
        hud_aabitmap_ex(Reticle_gauges[RETICLE_LEFT_ARC].first_frame + 1, x + HUD_nose_x, y + HUD_nose_y, w,
                        y_end - y + 1, 0, 0);
    }
}
...
void hud_render_throttle_foreground(int y_end) {
    ...
    if (y_end < (y + h - 1)) {
        hud_aabitmap_ex(Reticle_gauges[RETICLE_LEFT_ARC].first_frame + 2, x + HUD_nose_x, y_end + HUD_nose_y, w,
                        h - (y_end - y), 0, y_end - y);
    }
}
...
void hud_render_throttle_line(int y) {
    ...
    hud_aabitmap_ex(Reticle_gauges[RETICLE_LEFT_ARC].first_frame + 3,
                    Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_LEFT_ARC][0] + HUD_nose_x,
                    y + HUD_nose_y,
                    Hud_throttle_frame_w[gr_screen.res], 1, 0, y - Reticle_frame_coords[Hud_reticle_style][gr_screen.
                    res][RETICLE_LEFT_ARC][1]);
}

// Draw the throttle gauge along the left arc of the reticle
void hud_show_throttle() {
    float desired_speed, max_speed, current_speed, absolute_speed, absolute_displayed_speed, max_displayed_speed,
            percent_max, percent_aburn_max;
    ...
    desired_y_pos = Hud_throttle_bottom_y[Hud_reticle_style][gr_screen.res] - fl2i(Hud_throttle_h[gr_screen.res] *
                                                                                   desired_speed / max_speed + 0.5f) -
                    1;
    ...
    y_end = Hud_throttle_bottom_y[Hud_reticle_style][gr_screen.res] - fl2i(Hud_throttle_h[gr_screen.res] *
                                                                           percent_max + 0.5f);
    if (percent_aburn_max > 0) {
    ...
    gr_printf(Max_speed_coords[gr_screen.res][0] + HUD_nose_x, Max_speed_coords[gr_screen.res][1] + HUD_nose_y, "%d",
              fl2i(max_displayed_speed + 0.5f));
    gr_printf(Zero_speed_coords[gr_screen.res][0] + HUD_nose_x, Zero_speed_coords[gr_screen.res][1] + HUD_nose_y,
              XSTR("0", 292));
}
...
void hud_show_reticle_weapons() {
    ...
    if (gauge_index != -1) {
        hud_aabitmap(Reticle_gauges[gauge_index].first_frame + frame_offset,
                     Reticle_frame_coords[Hud_reticle_style][gr_screen.res][gauge_index][0] + HUD_nose_x,
                     Reticle_frame_coords[Hud_reticle_style][gr_screen.res][gauge_index][1] + HUD_nose_y);
    }
...
void hud_show_lock_threat() {
    ...
    hud_aabitmap(Reticle_gauges[RETICLE_LOCK_WARN].first_frame + frame_offset,
                 Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_LOCK_WARN][0] + HUD_nose_x,
                 Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_LOCK_WARN][1] + HUD_nose_y);
...
void hud_show_dumbfire_threat() {
    ...
    hud_aabitmap(Reticle_gauges[RETICLE_LASER_WARN].first_frame + frame_offset,
                 Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_LASER_WARN][0] + HUD_nose_x,
                 Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_LASER_WARN][1] + HUD_nose_y);
}
...
void hud_show_center_reticle() {
    ...
    hud_aabitmap(Reticle_gauges[RETICLE_CENTER].first_frame, Reticle_frame_coords[Hud_reticle_style][gr_screen.
            res][RETICLE_CENTER][0] + HUD_nose_x, Reticle_frame_coords[Hud_reticle_style][gr_screen.
            res][RETICLE_CENTER][1] + HUD_nose_y);
}
...
void hud_show_top_arc() {
    ...
    if (hud_gauge_active(HUD_THREAT_GAUGE)) {
        // draw top arc
        hud_aabitmap(Reticle_gauges[RETICLE_TOP_ARC].first_frame + 1,
                     Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_TOP_ARC][0] + HUD_nose_x,
                     Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_TOP_ARC][1] + HUD_nose_y);
        ...
        hud_aabitmap(Reticle_gauges[RETICLE_TOP_ARC].first_frame, Reticle_frame_coords[Hud_reticle_style][gr_screen.
                res][RETICLE_TOP_ARC][0] + HUD_nose_x, Reticle_frame_coords[Hud_reticle_style][gr_screen.
                res][RETICLE_TOP_ARC][1] + HUD_nose_y);
    }
}
...
void hud_show_right_arc() {
    ...
    if (Hud_reticle_style != HUD_RETICLE_STYLE_FS1) {
        hud_aabitmap(Reticle_gauges[RETICLE_RIGHT_ARC].first_frame + 1,
                     Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_RIGHT_ARC][0] + HUD_nose_x,
                     Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_RIGHT_ARC][1] + HUD_nose_y);
    } else {
        ...
        if (hud_gauge_active(HUD_WEAPON_LINKING_GAUGE)) {
            ...
            hud_aabitmap(Reticle_gauges[RETICLE_RIGHT_ARC].first_frame,
                         Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_RIGHT_ARC][0] + HUD_nose_x,
                         Reticle_frame_coords[Hud_reticle_style][gr_screen.res][RETICLE_RIGHT_ARC][1] + HUD_nose_y);
        }
    }
...
void hud_show_left_arc() {
    ...
    if (Hud_reticle_style != HUD_RETICLE_STYLE_FS1) {
        // draw left arc (the dark portion of the throttle gauge)
        hud_set_gauge_color(HUD_CENTER_RETICLE);
        hud_aabitmap(Reticle_gauges[RETICLE_LEFT_ARC].first_frame, Reticle_frame_coords[Hud_reticle_style][gr_screen.
                res][RETICLE_LEFT_ARC][0] + HUD_nose_x, Reticle_frame_coords[Hud_reticle_style][gr_screen.
                res][RETICLE_LEFT_ARC][1] + HUD_nose_y);
    }
