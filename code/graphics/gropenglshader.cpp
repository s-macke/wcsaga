...
static opengl_shader_file_t GL_shader_file[] =
{
...

	{
		"b-v.sdr",
		"bg-f.sdr",
		(SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP),
		2,
		{
			"sBasemap",
			"sGlowmap"
...

	{
		"l-v.sdr",
		"lb-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP),
		2,
		{
			"sBasemap",
			"n_lights"
...

	{
		"l-v.sdr",
		"lbg-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP),
		3,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"l-v.sdr",
		"lbgs-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP),
		4,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"l-v.sdr",
		"lbs-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP),
		3,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		"le-v.sdr",
		"lbgse-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP),
		7,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"le-v.sdr",
		"lbse-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP),
		6,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		"ln-v.sdr",
		"lbgn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_NORMAL_MAP),
		4,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"ln-v.sdr",
		"lbgsn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP),
		5,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"ln-v.sdr",
		"lbn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_NORMAL_MAP),
		3,
		{
			"sBasemap",
			"sNormalmap",
...

	{
		"ln-v.sdr",
		"lbsn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP),
		4,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		"ln-v.sdr",
		"lbgnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		5,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"ln-v.sdr",
		"lbnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		4,
		{
			"sBasemap",
			"sNormalmap",
...

	{
		"ln-v.sdr",
		"lbsnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		5,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		"lne-v.sdr",
		"lbsne-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_ENV_MAP),
		7,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		...
		"lbgsnhe-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP |
		 SDR_FLAG_HEIGHT_MAP | SDR_FLAG_ENV_MAP),
		9,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"lf-v.sdr",
		"lfb-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP),
		2,
		{
			"sBasemap",
			"n_lights"
...

	{
		"lf-v.sdr",
		"lfbg-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP),
		3,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"lf-v.sdr",
		"lfbgs-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP),
		4,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"lf-v.sdr",
		"lfbs-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP),
		3,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		"lfe-v.sdr",
		"lfbse-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP),
		6,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		"lfn-v.sdr",
		"lfbgn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_NORMAL_MAP),
		4,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"lfn-v.sdr",
		"lfbn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_NORMAL_MAP),
		3,
		{
			"sBasemap",
			"sNormalmap",
...

	{
		"lfn-v.sdr",
		"lfbsn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP),
		4,
		{
			"sBasemap",
			"sSpecmap",
...

	{
		...
		"lfbgsnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP |
		 SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		6,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"lfn-v.sdr",
		"lfbnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		4,
		{
			"sBasemap",
			"sNormalmap",
...

	{
		...
		"lfbgsne-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP |
		 SDR_FLAG_NORMAL_MAP | SDR_FLAG_ENV_MAP),
		8,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		...
		"lfbgsnhe-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_FOG | SDR_FLAG_DIFFUSE_MAP | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP |
		 SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP | SDR_FLAG_ENV_MAP),
		9,
		{
			"sBasemap",
			"sGlowmap",
...

	{
		"l-v.sdr",
		"lg-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP),
		2,
		{
			"sGlowmap",
			"n_lights"
...

	{
		"l-v.sdr",
		"lgs-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP),
		3,
		{
			"sGlowmap",
			"sSpecmap",
...

	{
		"l-v.sdr",
		"ls-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_SPEC_MAP),
		2,
		{
			"sSpecmap",
			"n_lights"
...

	{
		"le-v.sdr",
		"lgse-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP),
		6,
		{
			"sGlowmap",
			"sSpecmap",
...

	{
		"le-v.sdr",
		"lse-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_SPEC_MAP | SDR_FLAG_ENV_MAP),
		5,
		{
			"sSpecmap",
			"sEnvmap",
...

	{
		"ln-v.sdr",
		"lgn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP | SDR_FLAG_NORMAL_MAP),
		3,
		{
			"sGlowmap",
			"sNormalmap",
...

	{
		"ln-v.sdr",
		"lgsn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP),
		4,
		{
			"sGlowmap",
			"sSpecmap",
...

	{
		"ln-v.sdr",
		"ln-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_NORMAL_MAP),
		2,
		{
			"sNormalmap",
			"n_lights"
...

	{
		"ln-v.sdr",
		"lsn-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP),
		3,
		{
			"sSpecmap",
			"sNormalmap",
...

	{
		"ln-v.sdr",
		"lgnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		4,
		{
			"sGlowmap",
			"sNormalmap",
...

	{
		"ln-v.sdr",
		"lgsnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		5,
		{
			"sGlowmap",
			"sSpecmap",
...

	{
		"ln-v.sdr",
		"lnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		3,
		{
			"sNormalmap",
			"sHeightmap",
...

	{
		"ln-v.sdr",
		"lsnh-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP),
		4,
		{
			"sSpecmap",
			"sNormalmap",
...

	{
		"lne-v.sdr",
		"lgsne-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_GLOW_MAP | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_ENV_MAP),
		7,
		{
			"sGlowmap",
			"sSpecmap",
...

	{
		"lne-v.sdr",
		"lsne-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_ENV_MAP),
		6,
		{
			"sSpecmap",
			"sNormalmap",
...

	{
		"lne-v.sdr",
		"lsnhe-f.sdr",
		(SDR_FLAG_LIGHT | SDR_FLAG_SPEC_MAP | SDR_FLAG_NORMAL_MAP | SDR_FLAG_HEIGHT_MAP | SDR_FLAG_ENV_MAP),
		7,
		{
			"sSpecmap",
			"sNormalmap",
...
opengl::shader::shader(resources::text_file* vert, resources::text_file* frag)
	: last_texture(0),
	  shader_program(0)
{
...
GLhandleARB opengl::shader::compile_object(const GLcharARB* shader_source, GLenum shader_type)
{
	...
	{
		// basic error check
		mprintf(("    %s shader failed to compile:\n%s\n", (shader_type == GL_VERTEX_SHADER_ARB) ? "Vertex" :
				 "Fragment", info_log.c_str()));
		if (shader_object)
		{
	...
	else if (info_log.length() > 5)
	{
		nprintf(("SHADER-DEBUG", "%s shader compiled with warnings:\n%s\n", (shader_type == GL_VERTEX_SHADER_ARB) ?
				 "Vertex" : "Fragment", info_log.c_str()));
	}
...
opengl::special_shader* shader_manager::get_special_shader(int flags)
{
	...
	{
		mprintf(("  Compiling special shader ->  %s / %s ... \n", special_shader::get_vert_name(flags).c_str(),
				 special_shader::get_frag_name(flags).c_str()));
