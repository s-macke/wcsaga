...
// OGL defaults
static const float GL_light_color[4] =
{
	0.8f,
	0.8f,
	0.8f,
...
static const float GL_light_spec[4] =
{
	1.0f,
	1.0f,
	1.0f,
...
static const float GL_light_zero[4] =
{
	0.0f,
	0.0f,
	0.0f,
...
static const float GL_light_emission[4] =
{
	0.09f,
	0.09f,
	0.09f,
...
static const float GL_light_true_zero[4] =
{
	0.0f,
	0.0f,
	0.0f,
	...
	case LT_DIRECTIONAL:
		{
			...
			GLLight->Diffuse[0] *= sunFactor;
			GLLight->Diffuse[1] *= sunFactor;
			GLLight->Diffuse[2] *= sunFactor;
...
void opengl_change_active_lights(int pos, int d_offset)
{
	...
	if (!memcmp(&Eye_position, &last_view_pos, sizeof(vec3d)) && !memcmp(&Eye_matrix, &last_view_orient,
		sizeof(matrix)))
	{
		use_last_view = true;
	}
