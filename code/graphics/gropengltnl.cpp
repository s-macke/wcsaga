...
static GLfloat GL_env_texture_matrix[16] =
{
	0.0f
};
...
struct opengl_vertex_buffer
{
	...
	{
		memset(this, 0, sizeof(opengl_vertex_buffer));
	}
};
...
void gr_opengl_set_projection_matrix(float fov, float aspect, float z_near, float z_far)
{
	...
	{
		glViewport(gr_screen.offset_x, (gr_screen.max_h - gr_screen.offset_y - gr_screen.clip_height),
