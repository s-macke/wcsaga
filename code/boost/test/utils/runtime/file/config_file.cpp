...
//____________________________________________________________________________//
            ...
            get_requ_param_value(param_namespace const &where_from,
                                 ...
                                 cstring name_part4,
                                 cstring name_part5) {
                boost::optional<cstring> v = get_param_value(where_from, name_part1, name_part2, name_part3, name_part4,
                                                             name_part5);
...
//____________________________________________________________________________//
            ...
            param_namespace::load_impl(config_file_iterator cf_it,
                ...
                while (cf_it != config_file_iterator()) {
                    string_token_iterator ti(*cf_it,
                                             (max_tokens = 2, kept_delimeters = dt_none, dropped_delimeters = value_delimeter));
