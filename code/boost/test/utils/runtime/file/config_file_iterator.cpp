...
//____________________________________________________________________________//
            ...
            config_file_iterator::Impl::Impl()
                    : m_path_separators(BOOST_RT_PARAM_LITERAL("/\\")), m_line_delimeter(BOOST_RT_PARAM_LITERAL('\n')),
                      ...
                      m_command_delimeter(BOOST_RT_PARAM_LITERAL("$")), m_line_beak(BOOST_RT_PARAM_LITERAL("\\")),
                      m_macro_ref_begin(BOOST_RT_PARAM_LITERAL("$")), m_macro_ref_end(BOOST_RT_PARAM_LITERAL("$")),
                      m_include_kw(BOOST_RT_PARAM_LITERAL("include")), m_define_kw(BOOST_RT_PARAM_LITERAL("define")),
                      m_undef_kw(BOOST_RT_PARAM_LITERAL("undef")), m_ifdef_kw(BOOST_RT_PARAM_LITERAL("ifdef")),
                      m_ifndef_kw(BOOST_RT_PARAM_LITERAL("ifndef")), m_else_kw(BOOST_RT_PARAM_LITERAL("else")),
                      m_endif_kw(BOOST_RT_PARAM_LITERAL("endif")), m_buffer_size(8192), m_trim_trailing_spaces(true),
                      m_trim_leading_spaces(false), m_skip_empty_lines(true), m_detect_missing_macro(true),
...
//____________________________________________________________________________//
            ...
            config_file_iterator::Impl::process_command_line(cstring line) {
                ...
                BOOST_RT_PARAM_VALIDATE_LOGIC(it != m_command_handler_map.end(),
                                              BOOST_RT_PARAM_LITERAL("Invalid command ") << *tit);
...
//____________________________________________________________________________//
            ...
            config_file_iterator::Impl::process_include(cstring line) {
                ...
                BOOST_RT_PARAM_VALIDATE_LOGIC(++tit == string_token_iterator(),
                                              BOOST_RT_PARAM_LITERAL(
                                                      "unexpected tokens at the end of include command"));
...
//____________________________________________________________________________//
            ...
            config_file_iterator::Impl::process_else(cstring line) {
                ...
                m_inactive_ifdef_level =
                        m_conditional_states.size() == m_inactive_ifdef_level ? 0 : m_conditional_states.size();

                BOOST_RT_PARAM_VALIDATE_LOGIC(line.is_empty(),
                                              BOOST_RT_PARAM_LITERAL("unexpected tokens at the end of else command"));
            }
...
//____________________________________________________________________________//
            ...
            config_file_iterator::Impl::process_endif(cstring line) {
                BOOST_RT_PARAM_VALIDATE_LOGIC(m_conditional_states.size() > 0,
                                              BOOST_RT_PARAM_LITERAL("endif without matching if"));
                ...
                BOOST_RT_PARAM_VALIDATE_LOGIC(line.is_empty(),
                                              BOOST_RT_PARAM_LITERAL("unexpected tokens at the end of endif command"));
            }
...
//____________________________________________________________________________//
            ...
            config_file_iterator::Impl::substitute_macros(cstring &where) {
                ...
                while ((pos = where.find(m_macro_ref_begin)) != cstring::npos) {
                    ...
                    BOOST_RT_PARAM_VALIDATE_LOGIC(pos != cstring::npos,
                                                  BOOST_RT_PARAM_LITERAL("incomplete macro reference"));
