...
/// \brief from 4-channel planar data
        ...
        planar_devicen_view(std::size_t width, std::size_t height, IC c0, IC c1, IC c2, IC c3,
                            std::ptrdiff_t rowsize_in_bytes) {
...
/// \brief from 5-channel planar data
        ...
        planar_devicen_view(std::size_t width, std::size_t height, IC c0, IC c1, IC c2, IC c3, IC c4,
                            std::ptrdiff_t rowsize_in_bytes) {
