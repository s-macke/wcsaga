...
// typedefs required by ConstRandomAccess2DLocatorConcept
            ...
            template<std::size_t D>
            typename axis<D>::iterator &axis_iterator() { return detail::locator_axis<D, Loc>()(concrete()); }
...
////////////////////////////////////////////////////////////////////////////////////////
        ...
        public:
            ...
            memory_based_2d_locator(const memory_based_2d_locator<SI> &loc, coord_t y_step) : _p(loc.x(),
                                                                                                 loc.row_size() *
                                                                                                 y_step) {}

            template<typename SI>
            memory_based_2d_locator(const memory_based_2d_locator<SI> &loc, coord_t x_step, coord_t y_step,
