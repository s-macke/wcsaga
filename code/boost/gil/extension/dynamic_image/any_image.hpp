    ...
    namespace gil {
        ...
        namespace detail {
            ...
            struct recreate_image_fnobj {
                ...
                recreate_image_fnobj(const point2<std::ptrdiff_t> &dims, unsigned alignment) : _dimensions(dims),
            ...
            struct any_image_get_view {
                ...
                template<typename Image>
                result_type operator()(Image &img) const { return result_type(view(img)); }
            };
            ...
            struct any_image_get_const_view {
                ...
                template<typename Image>
                result_type operator()(const Image &img) const { return result_type(const_view(img)); }
            };
        }
...
/// \brief Returns the constant-pixel view of any image. The returned view is any view.
        ...
        typename any_image<Types>::const_view_t const_view(const any_image<Types> &anyImage) {
            return apply_operation(anyImage,
                                   detail::any_image_get_const_view<typename any_image<Types>::const_view_t>());
        }
///@}
