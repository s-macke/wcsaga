    ...
    namespace gil {
        ...
        namespace detail {
            ...
            struct destructor_op {
                ...
                template<typename T>
                result_type operator()(const T &t) const { t.~T(); }
            };
...
*/
        ...
        class variant {
            ...
            static const std::size_t MAX_SIZE = mpl::fold < Types, mpl::size_t<0>, mpl::max<mpl::_1,
                    mpl::sizeof_ < mpl::_2>
            > >::type::value;
        ...
        public:
            ...
            template<typename T>
            static bool has_type() { return type_id<T>() != NUM_TYPES; }
            ...
            template<typename T>
            bool current_type_is() const { return type_id<T>() == _index; }
        ...
        private:
            template<typename T>
            static std::size_t type_id() { return detail::type_to_index<Types, T>::value; }
        ...
        namespace detail {
            ...
            struct copy_construct_in_place_fn {
                ...
                template<typename T>
                void operator()(const T &src) const { copy_construct_in_place(src, _dst); }
            };
...
// When doSwap is true, swaps obj with the contents of the variant. obj will contain default-constructed instance after the call
        ...
        inline bool operator==(const variant<Types> &x, const variant<Types> &y) {
            return x._index == y._index &&
                   apply_operation(x, detail::equal_to_fn<typename variant<Types>::base_t>(y._bits));
        }
