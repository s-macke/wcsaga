    ...
    namespace gil {
        ...
        namespace detail {
            ...
            struct flipped_up_down_view_fn {
                ...
                result_type operator()(const View &src) const { return result_type(flipped_up_down_view(src)); }
            };
            ...
            struct flipped_left_right_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(flipped_left_right_view(src)); }
            };
            ...
            struct rotated90cw_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(rotated90cw_view(src)); }
            };
            ...
            struct rotated90ccw_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(rotated90ccw_view(src)); }
            };
            ...
            struct tranposed_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(tranposed_view(src)); }
            };
            ...
            struct rotated180_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(rotated180_view(src)); }
            };
            ...
            struct subimage_view_fn {
                ...
                subimage_view_fn(const point2<std::ptrdiff_t> &topleft, const point2<std::ptrdiff_t> &dimensions)
            ...
            struct subsampled_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(subsampled_view(src, _step)); }
            };
            ...
            struct nth_channel_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(nth_channel_view(src, _n)); }
            };
            ...
            struct color_converted_view_fn {
                ...
                template<typename View>
                result_type operator()(const View &src) const { return result_type(color_converted_view<DstP>(src)); }
            };
        } // namespace detail
...
/// \ingroup ImageViewTransformationsFlipUD
        ...
        flipped_up_down_view(const any_image_view<ViewTypes> &src) {
            return apply_operation(src,
                                   detail::flipped_up_down_view_fn<typename dynamic_y_step_type<any_image_view<ViewTypes> >::type>());
        }
...
/// \ingroup ImageViewTransformationsFlipLR
        ...
        flipped_left_right_view(const any_image_view<ViewTypes> &src) {
            return apply_operation(src,
                                   detail::flipped_left_right_view_fn<typename dynamic_x_step_type<any_image_view<ViewTypes> >::type>());
        }
...
/// \ingroup ImageViewTransformationsTransposed
        ...
        transposed_view(const any_image_view<ViewTypes> &src) {
            return apply_operation(src,
                                   detail::tranposed_view_fn<typename dynamic_xy_step_transposed_type<any_image_view<ViewTypes> >::type>());
        }
...
/// \ingroup ImageViewTransformations90CW
        ...
        rotated90cw_view(const any_image_view<ViewTypes> &src) {
            return apply_operation(src,
                                   detail::rotated90cw_view_fn<typename dynamic_xy_step_transposed_type<any_image_view<ViewTypes> >::type>());
        }
...
/// \ingroup ImageViewTransformations90CCW
        ...
        rotated90ccw_view(const any_image_view<ViewTypes> &src) {
            return apply_operation(src,
                                   detail::rotated90ccw_view_fn<typename dynamic_xy_step_transposed_type<any_image_view<ViewTypes> >::type>());
        }
...
/// \ingroup ImageViewTransformations180
        ...
        rotated180_view(const any_image_view<ViewTypes> &src) {
            return apply_operation(src,
                                   detail::rotated180_view_fn<typename dynamic_xy_step_type<any_image_view<ViewTypes> >::type>());
        }
...
/// \ingroup ImageViewTransformationsSubimage
        ...
        subimage_view(const any_image_view<ViewTypes> &src, const point2<std::ptrdiff_t> &topleft,
...
/// \ingroup ImageViewTransformationsSubimage
        ...
        inline // Models MPL Random Access Container of models of ImageViewConcept
        any_image_view<ViewTypes>
        subimage_view(const any_image_view<ViewTypes> &src, int xMin, int yMin, int width, int height) {
            return apply_operation(src, detail::subimage_view_fn<any_image_view<ViewTypes> >(
                    point2<std::ptrdiff_t>(xMin, yMin), point2<std::ptrdiff_t>(width, height)));
        }
...
/// \ingroup ImageViewTransformationsSubsampled
        ...
        subsampled_view(const any_image_view<ViewTypes> &src, const point2<std::ptrdiff_t> &step) {
            return apply_operation(src,
                                   detail::subsampled_view_fn<typename dynamic_xy_step_type<any_image_view<ViewTypes> >::type>(
                                           step));
        }
...
/// \ingroup ImageViewTransformationsNthChannel
        ...
        nth_channel_view(const any_image_view<ViewTypes> &src, int n) {
            return apply_operation(src,
                                   detail::nth_channel_view_fn<typename nth_channel_view_type<any_image_view<ViewTypes> >::type>(
                                           n));
        }
...
/// \brief overload of generic color_converted_view with user defined color-converter
        ...
        inline // Models MPL Random Access Container of models of ImageViewConcept
        typename color_converted_view_type<any_image_view<ViewTypes>, DstP, CC>::type
        color_converted_view(const any_image_view<ViewTypes> &src, CC cc) {
            return apply_operation(src,
                                   detail::color_converted_view_fn<DstP, typename color_converted_view_type<any_image_view<ViewTypes>, DstP, CC>::type>());
        }
...
/// \brief overload of generic color_converted_view with the default color-converter
        ...
        color_converted_view(const any_image_view<ViewTypes> &src) {
            return apply_operation(src,
                                   detail::color_converted_view_fn<DstP, typename color_converted_view_type<any_image_view<ViewTypes>, DstP>::type>());
        }
