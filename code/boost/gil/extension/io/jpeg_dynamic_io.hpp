    ...
    namespace gil {
        ...
        namespace detail {
            ...
            public:
                ...
                jpeg_writer_dynamic(const char *filename, int quality = 100) : jpeg_writer(filename),
                                                                               _quality(quality) {}
            ...
            public:
                ...
                void read_image(any_image<Images> &im) {
                    if (!construct_matched(im, detail::jpeg_type_format_checker(_cinfo.out_color_space))) {
                        io_error(
                                "jpeg_reader_dynamic::read_image(): no matching image type between those of the given any_image and that of the file");
                    } else {
