...
// Forward-declare semantic_at_c
        ...
        ::type semantic_at_c(ColorBase &p);
        ...
        struct PixelDereferenceAdaptorConcept {
            void constraints() {
                ...
                gil_function_requires<
                        PixelConcept < typename remove_const_and_reference<typename D::result_type>::type> > ();
        ...
        struct PixelIteratorConcept {
            void constraints() {
                ...
                ignore_unused_variable_warning(
                        const_it);  // immutable iterator must be constructible from (possibly mutable) iterator
...
*/
        ...
        struct RandomAccessNDLocatorConcept {
            void constraints() {
                ...
                BOOST_STATIC_ASSERT(
                        (is_same<typename std::iterator_traits<first_it_type>::difference_type, typename point_t::template axis<0>::coord_t>::value));
                BOOST_STATIC_ASSERT(
                        (is_same<typename std::iterator_traits<last_it_type>::difference_type, typename point_t::template axis<
                                N - 1>::coord_t>::value));
        ...
        namespace detail {
            ...
            struct RandomAccessNDLocatorIsMutableConcept {
                void constraints() {
                    ...
                    gil_function_requires<detail::RandomAccessIteratorIsMutableConcept<typename Loc::template axis<
                            Loc::num_dimensions - 1>::iterator> >();
        ...
        namespace detail {
            ...
            struct RandomAccessNDImageViewIsMutableConcept {
                void constraints() {
                    ...
                    gil_function_requires<detail::RandomAccessIteratorIsMutableConcept<typename View::template axis<
                            View::num_dimensions - 1>::iterator> >();
