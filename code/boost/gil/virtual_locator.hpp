...
/// 
        ...
        class virtual_2d_locator
                : public pixel_2d_locator_base<virtual_2d_locator<Deref, IsTransposed>, position_iterator<Deref, IsTransposed>, position_iterator<Deref,
                        1 - IsTransposed> > {
            typedef virtual_2d_locator<Deref, IsTransposed> this_t;
        public:
            typedef pixel_2d_locator_base<virtual_2d_locator<Deref, IsTransposed>, position_iterator<Deref, IsTransposed>, position_iterator<Deref,
            ...
            virtual_2d_locator(const point_t &p = point_t(0, 0), const point_t &step = point_t(1, 1),
            ...
            template<typename D, bool TR>
            virtual_2d_locator(const virtual_2d_locator<D, TR> &loc, coord_t x_step, coord_t y_step,
            ...
            bool is_1d_traversable(
                    x_coord_t) const { return false; }   // is there no gap at the end of each row? I.e. can we use x_iterator to visit every pixel instead of nested loops?
        ...
        private:
            template<typename D, bool TR> friend
            class virtual_2d_locator;
