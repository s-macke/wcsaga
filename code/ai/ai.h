...
#define    MAX_GOAL_SHIP_NAMES    MAX_SHIPS
...
typedef struct ai_class {
    ...
    float ai_bump_range_mult[NUM_SKILL_LEVELS];
...
extern void
ai_do_repair_frame(object *objp, ai_info *aip, float frametime);        //	Repair a ship object, player or AI.
