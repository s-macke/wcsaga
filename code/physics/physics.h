...
extern void physics_read_flying_controls(matrix *orient, physics_info *pi, control_info *ci, float sim_time,
                                         vec3d *wash_rot = NULL);
...
extern void physics_apply_shock(vec3d *direction_vec, float pressure, physics_info *pi, matrix *orient, vec3d *min,
...
public:
    ...
    void setAVD(float final_position, float total_movement_time, float starting_accleration_time,
