...
typedef BOOL (FAR
PASCAL *LPDIENUMDEVICEOBJECTSCALLBACKA
)(LPCDIDEVICEOBJECTINSTANCEA, LPVOID);
typedef BOOL (FAR
PASCAL *LPDIENUMDEVICEOBJECTSCALLBACKW
...
STDMETHOD
(GetCapabilities)(THIS_ LPDIDEVCAPS)
...
STDMETHOD
(SetDataFormat)(THIS_ LPCDIDATAFORMAT)

PURE;

STDMETHOD
(SetEventNotification)(THIS_ HANDLE)
...
STDMETHOD
(GetDeviceInfo)(THIS_ LPDIDEVICEINSTANCEW)
...
STDMETHOD
(GetDeviceInfo)(THIS_ LPDIDEVICEINSTANCEA)
...
typedef BOOL (FAR
PASCAL *LPDIENUMEFFECTSCALLBACKA
)(LPCDIEFFECTINFOA, LPVOID);
typedef BOOL (FAR
PASCAL *LPDIENUMEFFECTSCALLBACKW
)(LPCDIEFFECTINFOW, LPVOID);
#ifdef UNICODE
...
#endif // !UNICODE
typedef BOOL (FAR
PASCAL *LPDIENUMCREATEDEFFECTOBJECTSCALLBACK
...
STDMETHOD
(GetForceFeedbackState)(THIS_ LPDWORD)

PURE;

STDMETHOD
(SendForceFeedbackCommand)(THIS_ DWORD)
...
STDMETHOD (SendDeviceData)(THIS_ DWORD, LPDIDEVICEOBJECTDATA, LPDWORD, DWORD)
...
typedef BOOL (FAR
PASCAL *LPDIENUMDEVICESCALLBACKA
)(LPCDIDEVICEINSTANCEA, LPVOID);
typedef BOOL (FAR
PASCAL *LPDIENUMDEVICESCALLBACKW
)(LPCDIDEVICEINSTANCEW, LPVOID);
#ifdef UNICODE
...
hinst,
DWORD dwVersion, LPDIRECTINPUTA
* ppDI,
LPUNKNOWN punkOuter
);
extern HRESULT WINAPI
DirectInputCreateW(HINSTANCE
hinst,
DWORD dwVersion, LPDIRECTINPUTW
* ppDI,
LPUNKNOWN punkOuter
);
#ifdef UNICODE
