...
#define MOUSE_OFF                            9
#define MOUSE_ON                            10
#define MOUSE_ON_V2                        11
#define GAMMA_DOWN                        12
#define GAMMA_UP                            13

// detail level screen buttons
#define PLANETS_ON                        14
#define PLANETS_OFF                        15
#define HUD_TARGETVIEW_RENDER_ON        16
#define HUD_TARGETVIEW_RENDER_OFF    17
#define WEAPON_EXTRAS_ON                18
#define WEAPON_EXTRAS_OFF                19

#define LOW_DETAIL_N                        20
#define MEDIUM_DETAIL_N                    21
#define HIGH_DETAIL_N                    22
#define VERY_HIGH_DETAIL_N                23
#define CUSTOM_DETAIL_N                    24
...
static options_buttons Buttons[GR_NUM_RESOLUTIONS][NUM_BUTTONS] =
        {
                {    // GR_640
                        ...
                        options_buttons("OMB_07", 51, 74, 7, OPTIONS_TAB,
                                        2),            // Briefing / debriefing voice toggle off
                        options_buttons("OMB_08", 106, 74, 8, OPTIONS_TAB,
                                        2),            // Briefing / debriefing voice toggle on
                        options_buttons("OMB_18", 51, 266, 18, OPTIONS_TAB, 2),            // Mouse off
                        options_buttons("OMB_19", 106, 266, 19, OPTIONS_TAB, 2),            // Mouse V1
                        options_buttons("OMB_19", 126, 266, 22, OPTIONS_TAB, 2),            // Mouse V2
                ...
                {    // GR_1024
                        ...
                        options_buttons("2_OMB_07", 81, 118, 7, OPTIONS_TAB,
                                        2),            // Briefing / debriefing voice toggle off
                        options_buttons("2_OMB_08", 170, 118, 8, OPTIONS_TAB,
                                        2),            // Briefing / debriefing voice toggle on
                        options_buttons("2_OMB_18", 81, 425, 18, OPTIONS_TAB, 2),            // Mouse off
                        options_buttons("2_OMB_19", 170, 425, 19, OPTIONS_TAB, 2),            // Mouse v1
                        options_buttons("2_OMB_19", 260, 425, 22, OPTIONS_TAB, 2),            // Mouse v2
...
op_sliders Options_sliders[GR_NUM_RESOLUTIONS][NUM_OPTIONS_SLIDERS] =
        {
                { // GR_640
                        ...
                        op_sliders("OMB_20", 6, 316, -1, -1, 20, 20, 10, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),    // mouse sensitivity
                        op_sliders("OMB_28", 440, 259, -1, -1, 28, 20, 10, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),    // joystick sensitivity
                        op_sliders("OMB_29", 440, 290, -1, -1, 29, 20, 10, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),    // joystick deadzone
                ...
                { // GR_1024
                        ...
                        op_sliders("2_OMB_20", 9, 505, -1, -1, 20, 32, 10, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),    // mouse sensitivity
                        op_sliders("2_OMB_28", 705, 413, -1, -1, 28, 32, 10, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),    // joystick sensitivity
                        op_sliders("2_OMB_29", 705, 514, -1, -1, 29, 32, 10, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),    // joystick deadzone
...
op_sliders Detail_sliders[GR_NUM_RESOLUTIONS][NUM_DETAIL_SLIDERS] =
        {
                { // GR_640
                        op_sliders("ODB_07", 21, 71, -1, -1, 7, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // model detail
                        op_sliders("ODB_08", 21, 119, -1, -1, 8, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // nebula detail
                        op_sliders("ODB_09", 21, 166, -1, -1, 9, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // textures
                        op_sliders("ODB_10", 21, 212, -1, -1, 10, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // particles
                        op_sliders("ODB_11", 21, 260, -1, -1, 11, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // debris
                        op_sliders("ODB_12", 21, 307, -1, -1, 12, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // shield hit
                        op_sliders("ODB_13", 21, 354, -1, -1, 13, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // stars
                        op_sliders("ODB_19", 518, 212, -1, -1, 19, 20, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),            // lighting
                },
                { // GR_1024
                        op_sliders("2_ODB_07", 34, 114, -1, -1, 7, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // model detail
                        op_sliders("2_ODB_08", 34, 190, -1, -1, 8, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // nebula detail
                        op_sliders("2_ODB_09", 34, 265, -1, -1, 9, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // textures
                        op_sliders("2_ODB_10", 34, 340, -1, -1, 10, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // particles
                        op_sliders("2_ODB_11", 34, 416, -1, -1, 11, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // debris
                        op_sliders("2_ODB_12", 34, 492, -1, -1, 12, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // shield hit
                        op_sliders("2_ODB_13", 34, 567, -1, -1, 13, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // stars
                        op_sliders("2_ODB_19", 829, 340, -1, -1, 19, 32, 5, NULL, -1, -1, -1, NULL, -1, -1,
                                   -1),        // lighting
                }
        };
...
UI_XSTR Options_text[GR_NUM_RESOLUTIONS][OPTIONS_NUM_TEXT] =
        {
                { // GR_640
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][MULTIPLAYER_TAB].button
                        },
                        {
                                "Detail",
                                1351,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][DETAIL_LEVELS_TAB].button
                        },
                        {
                                "Exit",
                                1059,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][ABORT_GAME_BUTTON].button
                        },
                        {
                                "Game",
                                1412,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][CONTROL_CONFIG_BUTTON].button
                        },
                        {
                                "Config",
                                1353,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][HUD_CONFIG_BUTTON].button
                        },
                        {
                                "Config",
                                1415,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][MEDIUM_DETAIL_N].button
                        },
                        {
                                "High",
                                1162,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][HIGH_DETAIL_N].button
                        },
                        {
                                "Very High",
                                1163,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][VERY_HIGH_DETAIL_N].button
                        },
                        {
                                "Custom",
                                1356,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][CUSTOM_DETAIL_N].button
                        },
                        {
                                "Off",
                                1286,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][HUD_TARGETVIEW_RENDER_OFF].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][HUD_TARGETVIEW_RENDER_ON].button
                        },
                        {
                                "Off",
                                1286,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][WEAPON_EXTRAS_OFF].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[0][WEAPON_EXTRAS_ON].button
                        },
                        {
                                "Planets/Backgrounds",
                                1357,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[0][BRIEF_VOICE_OFF].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[0][BRIEF_VOICE_ON].button
                        },
                        {
                                "Volume",
                                1369,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Options_sliders[0][OPT_MOUSE_SENS_SLIDER].slider
                        },
                        {
                                "Skill Level",
                                1509,
                ...
                { // GR_1024
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][MULTIPLAYER_TAB].button
                        },
                        {
                                "Detail",
                                1351,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][DETAIL_LEVELS_TAB].button
                        },
                        {
                                "Exit",
                                1059,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][ABORT_GAME_BUTTON].button
                        },
                        {
                                "Game",
                                1412,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][CONTROL_CONFIG_BUTTON].button
                        },
                        {
                                "Config",
                                1353,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][HUD_CONFIG_BUTTON].button
                        },
                        {
                                "Config",
                                1415,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][MEDIUM_DETAIL_N].button
                        },
                        {
                                "High",
                                1162,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][HIGH_DETAIL_N].button
                        },
                        {
                                "Very High",
                                1163,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][VERY_HIGH_DETAIL_N].button
                        },
                        {
                                "Custom",
                                1356,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Buttons[1][CUSTOM_DETAIL_N].button
                        },
                        {
                                "Off",
                                1286,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[1][HUD_TARGETVIEW_RENDER_OFF].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[1][HUD_TARGETVIEW_RENDER_ON].button
                        },
                        {
                                "Off",
                                1286,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[1][WEAPON_EXTRAS_OFF].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[1][WEAPON_EXTRAS_ON].button
                        },
                        {
                                "Planets/Backgrounds",
                                1357,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][DETAIL_DISTANCE_SLIDER].slider
                        },
                        {
                                "Nebula Detail",
                                1361,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][NEBULA_DETAIL_SLIDER].slider
                        },
                        {
                                "3D Hardware Textures",
                                1362,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][HARDWARE_TEXTURES_SLIDER].slider
                        },
                        {
                                "Particles",
                                1363,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][NUM_PARTICLES_SLIDER].slider
                        },
                        {
                                "Impact Effects",
                                1364,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][SHARD_CULLING_SLIDER].slider
                        },
                        {
                                "Shield Hit Effects",
                                1365,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][SHIELD_DETAIL_SLIDER].slider
                        },
                        {
                                "Stars",
                                1366,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][NUM_STARS_SLIDER].slider
                        },
                        {
                                "Lighting",
                                1367,
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Detail_sliders[1][LIGHTING_SLIDER].slider
                        },
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[1][BRIEF_VOICE_OFF].button
                        },
                        {
                                "On",
                                1285,
                                ...
                                UI_XSTR_COLOR_GREEN,
                                -1,
                                &Buttons[1][BRIEF_VOICE_ON].button
                        },
                        {
                                "Volume",
                                1369,
                        ...
                        },
                        {
                                ...
                                UI_XSTR_COLOR_PINK,
                                -1,
                                &Options_sliders[1][OPT_MOUSE_SENS_SLIDER].slider
                        },
                        {
                                "Skill Level",
                                1509,
...
void options_tab_setup(int set_palette) {
    ...
    for (i = 0; i < NUM_BUTTONS; i++) {
        if (((Buttons[gr_screen.res][i].tab == Tab) || (Buttons[gr_screen.res][i].tab == -1)) &&
            !flags[Buttons[gr_screen.res][i].hotspot]) {
...
void options_menu_init() {
    ...
    */
    ...
    // create slider
    for (i = 0; i < NUM_OPTIONS_SLIDERS; i++) {
        Options_sliders[gr_screen.res][i].slider.create(&Ui_window, Options_sliders[gr_screen.res][i].x,
                                                        Options_sliders[gr_screen.res][i].y,
                                                        Options_sliders[gr_screen.res][i].dots,
                                                        Options_sliders[gr_screen.res][i].filename,
                                                        Options_sliders[gr_screen.res][i].hotspot,
                                                        Options_sliders[gr_screen.res][i].right_filename,
                                                        Options_sliders[gr_screen.res][i].right_mask,
                                                        Options_sliders[gr_screen.res][i].right_x,
                                                        Options_sliders[gr_screen.res][i].right_y,
                                                        Options_sliders[gr_screen.res][i].left_filename,
                                                        Options_sliders[gr_screen.res][i].left_mask,
                                                        Options_sliders[gr_screen.res][i].left_x,
                                                        Options_sliders[gr_screen.res][i].left_y,
    ...
    Sound_volume_int = Options_sliders[gr_screen.res][OPT_SOUND_VOLUME_SLIDER].slider.pos = (int) (Master_sound_volume *
                                                                                                   9.0f + 0.5f);
    Music_volume_int = Options_sliders[gr_screen.res][OPT_MUSIC_VOLUME_SLIDER].slider.
            pos = (int) (Master_event_music_volume * 9.0f + 0.5f);
    Voice_volume_int = Options_sliders[gr_screen.res][OPT_VOICE_VOLUME_SLIDER].slider.pos = (int) (Master_voice_volume *
                                                                                                   9.0f + 0.5f);
...
void options_menu_close() {
    ...
    for (i = 0; i < NUM_TABS; i++) {
        ...
        if ((Backgrounds[gr_screen.res][i].mask >= 0) &&
            (i != Tab)) {  // Ui_window.destroy() expects to release current tab's mask.
...
void draw_gamma_box() {
...

    {
        ...
        int Gamma_bitmap = bm_create(16, Options_gamma_coords[gr_screen.res][OPTIONS_W_COORD],
                                     Options_gamma_coords[gr_screen.res][OPTIONS_H_COORD], Gamma_data, 0);
        gr_set_bitmap(Gamma_bitmap);
        gr_bitmap(Options_gamma_coords[gr_screen.res][OPTIONS_X_COORD],
                  Options_gamma_coords[gr_screen.res][OPTIONS_Y_COORD]);
...
void options_menu_do_frame(float frametime) {
    ...
    if (Tab == OPTIONS_TAB) {
        ...
        if (Use_mouse_to_fly == 1) {
            options_force_button_frame(MOUSE_ON, 2);
            options_force_button_frame(MOUSE_ON_V2, 0);
            options_force_button_frame(MOUSE_OFF, 0);

        } else if (Use_mouse_to_fly == 2) {
            options_force_button_frame(MOUSE_ON_V2, 2);
        ...
        gr_string(x + (Options_skills_text_coords[gr_screen.res][OPTIONS_W_COORD] / 2) - (w / 2), y,
...
void options_detail_synch_sliders() {
    Detail_slider_pos[DETAIL_DISTANCE_SLIDER] = Detail_sliders[gr_screen.res][DETAIL_DISTANCE_SLIDER].slider.pos =
            Detail.detail_distance;
    Detail_slider_pos[NEBULA_DETAIL_SLIDER] = Detail_sliders[gr_screen.res][NEBULA_DETAIL_SLIDER].slider.pos = Detail.
            nebula_detail;
    Detail_slider_pos[HARDWARE_TEXTURES_SLIDER] = Detail_sliders[gr_screen.res][HARDWARE_TEXTURES_SLIDER].slider.pos =
            Detail.hardware_textures;
    Detail_slider_pos[SHARD_CULLING_SLIDER] = Detail_sliders[gr_screen.res][SHARD_CULLING_SLIDER].slider.pos = Detail.
            num_small_debris;
    Detail_slider_pos[SHIELD_DETAIL_SLIDER] = Detail_sliders[gr_screen.res][SHIELD_DETAIL_SLIDER].slider.pos = Detail.
            shield_effects;
    Detail_slider_pos[NUM_STARS_SLIDER] = Detail_sliders[gr_screen.res][NUM_STARS_SLIDER].slider.pos = Detail.
            num_stars;
    Detail_slider_pos[NUM_PARTICLES_SLIDER] = Detail_sliders[gr_screen.res][NUM_PARTICLES_SLIDER].slider.pos = Detail.
            num_particles;
...
void options_detail_init() {
    ...
    for (i = 0; i < NUM_DETAIL_SLIDERS; i++) {
        Detail_sliders[gr_screen.res][i].slider.create(&Ui_window, Detail_sliders[gr_screen.res][i].x,
                                                       Detail_sliders[gr_screen.res][i].y,
                                                       Detail_sliders[gr_screen.res][i].dots,
                                                       Detail_sliders[gr_screen.res][i].filename,
                                                       Detail_sliders[gr_screen.res][i].hotspot,
                                                       Detail_sliders[gr_screen.res][i].right_filename,
                                                       Detail_sliders[gr_screen.res][i].right_mask,
                                                       Detail_sliders[gr_screen.res][i].right_x,
                                                       Detail_sliders[gr_screen.res][i].right_y,
                                                       Detail_sliders[gr_screen.res][i].left_filename,
                                                       Detail_sliders[gr_screen.res][i].left_mask,
                                                       Detail_sliders[gr_screen.res][i].left_x,
                                                       Detail_sliders[gr_screen.res][i].left_y,
