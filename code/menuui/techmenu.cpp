...
static techroom_buttons Buttons[GR_NUM_RESOLUTIONS][NUM_BUTTONS] =
{
	...
	{	// GR_1024
		...
		techroom_buttons("2_TDB_13", 854, 681, 822, 704, 13, -1),									// help
		techroom_buttons("2_TDB_14", 854, 728, 800, 743, 14, -1),									// options
		techroom_buttons("2_TDB_15a", 914, 681, 956, 671, 15, -1),									// exit		
	},
};
...
void tech_common_render()
{
	...
	while (y + font_height <= Tech_list_coords[gr_screen.res][SHIP_H_COORD])
	{
		...
		List_buttons[z - List_offset].update_dimensions(Tech_list_coords[gr_screen.res][SHIP_X_COORD],
			Tech_list_coords[gr_screen.res][SHIP_Y_COORD] + y, Tech_list_coords[gr_screen.res][SHIP_W_COORD],
			font_height);
...
void techroom_ships_render(float frametime)
{
	...
	gr_set_clip(Tech_ship_display_coords[gr_screen.res][SHIP_X_COORD],
		Tech_ship_display_coords[gr_screen.res][SHIP_Y_COORD], Tech_ship_display_coords[gr_screen.res][SHIP_W_COORD],
		...
		if (Ships_loaded == 0)
		{
			...
			for (i = 0; i < Num_ship_classes; i++)
			{
				if (Techroom_show_all || (Ship_info[i].flags & mask) || (Ship_info[i].flags2 & mask2))
				{
					...
					Ship_list[Ship_list_size].name = (Ship_info[i].alt_name[0]) ? Ship_info[i].alt_name : Ship_info[i].
						name;
...
void techroom_init()
{
	...
	*/
	...
	for (i = 0; i < NUM_BUTTONS; i++)
	{
		Buttons[gr_screen.res][i].button.create(&Ui_window, "", Buttons[gr_screen.res][i].x,
			Buttons[gr_screen.res][i].y, 60, 30, Buttons[gr_screen.res][i].flags & REPEAT, 1);
	...
	Ui_window.add_XSTR("Mission Simulator", 1056, Buttons[gr_screen.res][SIMULATOR_TAB].xt,
		Buttons[gr_screen.res][SIMULATOR_TAB].yt, &Buttons[gr_screen.res][SIMULATOR_TAB].button, UI_XSTR_COLOR_PINK);
	Ui_window.add_XSTR("Cutscenes", 1057, Buttons[gr_screen.res][CUTSCENES_TAB].xt,
		Buttons[gr_screen.res][CUTSCENES_TAB].yt, &Buttons[gr_screen.res][CUTSCENES_TAB].button, UI_XSTR_COLOR_PINK);
	Ui_window.add_XSTR("Credits", 1058, Buttons[gr_screen.res][CREDITS_TAB].xt,
		Buttons[gr_screen.res][CREDITS_TAB].yt, &Buttons[gr_screen.res][CREDITS_TAB].button, UI_XSTR_COLOR_PINK);

	// common ship/weapon/intel text
	Ui_window.add_XSTR("Ships", 293, Buttons[gr_screen.res][SHIPS_DATA_TAB].xt,
		Buttons[gr_screen.res][SHIPS_DATA_TAB].yt, &Buttons[gr_screen.res][SHIPS_DATA_TAB].button, UI_XSTR_COLOR_PINK);
	...
	Ui_window.add_XSTR("Intel", 1066, Buttons[gr_screen.res][INTEL_DATA_TAB].xt,
		Buttons[gr_screen.res][INTEL_DATA_TAB].yt, &Buttons[gr_screen.res][INTEL_DATA_TAB].button, UI_XSTR_COLOR_PINK);
	...
	Ui_window.add_XSTR("Exit", 1418, Buttons[gr_screen.res][EXIT_BUTTON].xt,
		Buttons[gr_screen.res][EXIT_BUTTON].yt, &Buttons[gr_screen.res][EXIT_BUTTON].button, UI_XSTR_COLOR_PINK);
	...
	*/
	...
	Tech_slider.create(&Ui_window, Tech_slider_coords[gr_screen.res][SHIP_X_COORD],
		...
		Tech_slider_filename[gr_screen.res], &tech_scroll_list_up, &tech_scroll_list_down, &tech_ship_scroll_capture);
