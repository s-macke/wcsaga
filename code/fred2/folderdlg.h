...
public:
    ...
    AFX_INLINE BROWSEINFO
    &
    GetBI( VOID );
    AFX_INLINE const BROWSEINFO
    &
    GetBI( VOID )
    const;
...
AFX_INLINE LPCTSTR
CFolderDialog::GetSelectedFolder( VOID )
const
{
return
m_szSelPath;
...
AFX_INLINE LPCTSTR
CFolderDialog::GetFolderPath( VOID )
const
{
return
m_szFolPath;
...
AFX_INLINE LPCTSTR
CFolderDialog::GetFolderName( VOID )
const
{
return m_bi.
pszDisplayName;
...
AFX_INLINE INT
CFolderDialog::GetFolderImage( VOID )
const
{
return m_bi.
iImage;
