...
INT CALLBACK
CFolderDialog::BrowseCallbackProc( IN
HWND hWnd,
        IN
UINT uMsg,
        IN
...
{
CFolderDialog *pThis = (CFolderDialog * )
lpData;
ASSERT( pThis
!= NULL );
...
VOID CFolderDialog::SetExpanded(IN
LPCTSTR pszPath
)
{
USES_CONVERSION;
...
VOID CFolderDialog::SetOKText(IN
LPCTSTR pszText
)
{
USES_CONVERSION;
...
VOID CFolderDialog::EnableOK(IN
BOOL bEnable /*TRUE*/ )
{
ASSERT( m_hWnd
!= NULL );
...
::SendMessage(
        m_hWnd, BFFM_ENABLEOK, (WPARAM)
bEnable, 0L
);
}

VOID CFolderDialog::SetSelection(IN
...
VOID CFolderDialog::SetStatusText(IN
LPCTSTR pszText
)
{
ASSERT( m_hWnd
