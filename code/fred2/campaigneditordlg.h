...
public:
    ...
    CString m_desc;
    CString m_intro_cutscene;
    CString m_end_cutscene;
    CString m_loop_desc;
...
public:
    virtual BOOL
    Create(LPCTSTR lpszClassName, LPCTSTR lpszWindowName, DWORD dwStyle, const RECT &rect, CWnd *pParentWnd, UINT nID,
...
public:
    afx_msg void OnChangeFictionCutscene();

    afx_msg void OnChangeCmdBriefCutscene();

    afx_msg void OnChangePregameCutscene();

    afx_msg void OnChangeDebriefingCutscene();

    afx_msg void OnEnChangeCampaignIntroCutscene();

    afx_msg void OnEnChangeCampaignEndCutscene();

    afx_msg void OnBnClickedResetRank();
};
