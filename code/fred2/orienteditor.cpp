...
BOOL orient_editor::OnInitDialog() {
    ...
    m_spin1.SetRange(SHRT_MAX, SHRT_MIN);
    m_spin1.SetPos((int) convert(m_position_x));
    m_spin2.SetRange(SHRT_MAX, SHRT_MIN);
    m_spin2.SetPos((int) convert(m_position_y));
    m_spin3.SetRange(SHRT_MAX, SHRT_MIN);
    m_spin3.SetPos((int) convert(m_position_z));
    m_spin4.SetRange(SHRT_MAX, SHRT_MIN);
    m_spin5.SetRange(SHRT_MAX, SHRT_MIN);
    m_spin6.SetRange(SHRT_MAX, SHRT_MIN);
    UpdateData(FALSE);
    return TRUE;
}
