...
int cf_create_default_path_string_for_root(int root_n, char *path, uint path_max, int pathtype, char *filename = NULL,
                                           bool localize = false);

int
cf_create_default_path_string(char *path, uint path_max, int pathtype, char *filename = NULL, bool localize = false);
